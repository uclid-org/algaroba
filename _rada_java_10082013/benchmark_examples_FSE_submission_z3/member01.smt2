...
;;
;; Suppose we want to check if 1.0 is a member of tree t1:
;;
...
; the result is SAT: there exists 1.0 in t1.
(assert (= (PAC_member t1 cleaf_member_const cpr_member_const rec_const 1.0) true))
(check-sat)
(exit)