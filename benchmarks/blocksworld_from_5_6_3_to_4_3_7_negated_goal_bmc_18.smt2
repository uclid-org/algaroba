...
(assert
 ...
 (let (($x274 (= ?x247 ?x76)))
 (let ((?x79 (right s_)))
 (let (($x232 ((_ is stack ) ?x79)))
 (let (($x241 (= c_ right-to-left)))
 (let (($x254 (and $x241 $x232)))
 (let ((?x81 (center s_)))
 (let (($x255 ((_ is stack ) ?x81)))
 (let (($x256 (= c_ center-to-right)))
 (let (($x242 (and $x256 $x255)))
 (let (($x243 (= c_ center-to-left)))
 (let (($x244 (and $x243 $x255)))
 (let (($x283 (ite $x244 (= ?x247 (stack (top ?x81) ?x76)) (ite $x242 $x274 (ite $x254 (= ?x247 (stack (top ?x79) ?x76)) $x274)))))
 (let (($x261 (= ?x247 (rest ?x76))))
 (let (($x251 ((_ is stack ) ?x76)))
 (let (($x252 (= c_ left-to-right)))
 (let (($x253 (and $x252 $x251)))
 (let (($x257 (= c_ left-to-center)))
 (let (($x258 (and $x257 $x251)))
 (ite $x258 $x261 (ite $x253 $x261 $x283)))))))))))))))))))))))
(assert
 (let ((?x79 (right s_)))
 (let ((?x249 (right s__)))
 (let (($x270 (= ?x249 ?x79)))
 (let (($x267 (= ?x249 (rest ?x79))))
 (let (($x232 ((_ is stack ) ?x79)))
 ...
 (let (($x256 (= c_ center-to-right)))
 (let (($x242 (and $x256 $x255)))
 (let (($x280 (ite $x242 (= ?x249 (stack (top ?x81) ?x79)) (ite $x254 $x267 (ite $x240 $x267 $x270)))))
 (let (($x243 (= c_ center-to-left)))
 (let (($x244 (and $x243 $x255)))
 (let ((?x76 (left s_)))
 (let (($x251 ((_ is stack ) ?x76)))
 ...
 (let (($x257 (= c_ left-to-center)))
 (let (($x258 (and $x257 $x251)))
 (ite $x258 (= ?x249 (stack (top ?x76) ?x79)) (ite $x253 $x270 (ite $x244 $x270 $x280))))))))))))))))))))))))))
(assert
 (let ((?x81 (center s_)))
 (let ((?x228 (center s__)))
 (let (($x272 (= ?x228 ?x81)))
 ...
 (let (($x256 (= c_ center-to-right)))
 (let (($x242 (and $x256 $x255)))
 (let (($x279 (ite $x242 $x264 (ite $x254 $x272 (ite $x240 (= ?x228 (stack (top ?x79) ?x81)) $x272)))))
 (let (($x243 (= c_ center-to-left)))
 (let (($x244 (and $x243 $x255)))
 (let ((?x76 (left s_)))
 (let (($x251 ((_ is stack ) ?x76)))
 ...
 (let (($x257 (= c_ left-to-center)))
 (let (($x258 (and $x257 $x251)))
 (ite $x258 $x272 (ite $x253 (= ?x228 (stack (top ?x76) ?x81)) (ite $x244 $x264 $x279))))))))))))))))))))))))))
(assert
 (= c___ c!2))
(assert
 (let ((?x247 (left s__)))
 ...
 (let ((?x249 (right s__)))
 (let ((?x370 (top ?x249)))
 (let ((?x371 (stack ?x370 ?x247)))
 (let (($x397 (= ?x146 ?x371)))
 (let (($x373 ((_ is stack ) ?x249)))
...
(assert
 (let ((?x51 (stack J (stack H (stack F (stack D (stack B (stack A empty))))))))
 (let ((?x52 (stack K ?x51)))
 (let ((?x2385 (right s___________________)))
 (let (($x2627 (= ?x2385 ?x52)))
 (let ((?x46 (stack G (stack I (stack C empty)))))
 (let ((?x2571 (center s___________________)))
 (let (($x2658 (= ?x2571 ?x46)))
 (let ((?x43 (stack N (stack E (stack L (stack M empty))))))
 (let ((?x2351 (left s___________________)))
 (let (($x2659 (= ?x2351 ?x43)))
 (let (($x2661 (not (and $x2659 $x2658 $x2627))))
 (not $x2661)))))))))))))
(check-sat)
