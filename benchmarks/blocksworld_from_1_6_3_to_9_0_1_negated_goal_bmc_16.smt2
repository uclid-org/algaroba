...
(assert
 (let ((?x1499 (left s_____________)))
 (let ((?x1637 (left s______________)))
 (let (($x1897 (= ?x1637 ?x1499)))
 (let ((?x1533 (right s_____________)))
 (let ((?x1864 (top ?x1533)))
 (let ((?x1865 (stack ?x1864 ?x1499)))
 (let (($x1891 (= ?x1637 ?x1865)))
 (let (($x1867 ((_ is stack ) ?x1533)))
 (let (($x1870 (= c_____________ right-to-left)))
 (let (($x1871 (and $x1870 $x1867)))
 (let ((?x1719 (center s_____________)))
 (let (($x1872 ((_ is stack ) ?x1719)))
 (let (($x1873 (= c_____________ center-to-right)))
 (let (($x1874 (and $x1873 $x1872)))
 (let ((?x1860 (top ?x1719)))
 (let ((?x1861 (stack ?x1860 ?x1499)))
 (let (($x1888 (= ?x1637 ?x1861)))
 (let (($x1875 (= c_____________ center-to-left)))
 (let (($x1876 (and $x1875 $x1872)))
 (let ((?x1670 (rest ?x1499)))
 (let (($x1884 (= ?x1637 ?x1670)))
 (let (($x1877 ((_ is stack ) ?x1499)))
 (let (($x1878 (= c_____________ left-to-right)))
 (let (($x1879 (and $x1878 $x1877)))
 (let (($x1880 (= c_____________ left-to-center)))
 (let (($x1881 (and $x1880 $x1877)))
 (ite $x1881 $x1884 (ite $x1879 $x1884 (ite $x1876 $x1888 (ite $x1874 $x1897 (ite $x1871 $x1891 $x1897))))))))))))))))))))))))))))))))
(assert
 (let ((?x1533 (right s_____________)))
 (let ((?x1671 (right s______________)))
 (let (($x1893 (= ?x1671 ?x1533)))
 (let ((?x1863 (rest ?x1533)))
 (let (($x1890 (= ?x1671 ?x1863)))
 (let (($x1867 ((_ is stack ) ?x1533)))
 (let (($x1868 (= c_____________ right-to-center)))
 (let (($x1869 (and $x1868 $x1867)))
 (let (($x1870 (= c_____________ right-to-left)))
 (let (($x1871 (and $x1870 $x1867)))
 (let ((?x1719 (center s_____________)))
 (let ((?x1860 (top ?x1719)))
 (let ((?x1862 (stack ?x1860 ?x1533)))
 (let (($x1889 (= ?x1671 ?x1862)))
 (let (($x1872 ((_ is stack ) ?x1719)))
 (let (($x1873 (= c_____________ center-to-right)))
 (let (($x1874 (and $x1873 $x1872)))
 (let (($x1875 (= c_____________ center-to-left)))
 ...
 (let (($x1878 (= c_____________ left-to-right)))
 (let (($x1879 (and $x1878 $x1877)))
 (let (($x1910 (ite $x1879 $x1893 (ite $x1876 $x1893 (ite $x1874 $x1889 (ite $x1871 $x1890 (ite $x1869 $x1890 $x1893)))))))
 (let ((?x1717 (top ?x1499)))
 (let ((?x1856 (stack ?x1717 ?x1533)))
 (let (($x1885 (= ?x1671 ?x1856)))
 (let (($x1880 (= c_____________ left-to-center)))
 (let (($x1881 (and $x1880 $x1877)))
 (ite $x1881 $x1885 $x1910)))))))))))))))))))))))))))))))
(assert
 (let ((?x1719 (center s_____________)))
 (let ((?x1857 (center s______________)))
 (let (($x1895 (= ?x1857 ?x1719)))
 (let ((?x1533 (right s_____________)))
 (let ((?x1864 (top ?x1533)))
 (let ((?x1866 (stack ?x1864 ?x1719)))
 (let (($x1892 (= ?x1857 ?x1866)))
 (let (($x1867 ((_ is stack ) ?x1533)))
 (let (($x1868 (= c_____________ right-to-center)))
 (let (($x1869 (and $x1868 $x1867)))
 (let (($x1870 (= c_____________ right-to-left)))
 (let (($x1871 (and $x1870 $x1867)))
 (let ((?x1859 (rest ?x1719)))
 (let (($x1887 (= ?x1857 ?x1859)))
 (let (($x1872 ((_ is stack ) ?x1719)))
 (let (($x1873 (= c_____________ center-to-right)))
 (let (($x1874 (and $x1873 $x1872)))
 (let (($x1875 (= c_____________ center-to-left)))
 ...
 (let ((?x1499 (left s_____________)))
 (let ((?x1717 (top ?x1499)))
 (let ((?x1858 (stack ?x1717 ?x1719)))
 (let (($x1886 (= ?x1857 ?x1858)))
 (let (($x1877 ((_ is stack ) ?x1499)))
 (let (($x1878 (= c_____________ left-to-right)))
 (let (($x1879 (and $x1878 $x1877)))
 (let (($x1909 (ite $x1879 $x1886 (ite $x1876 $x1887 (ite $x1874 $x1887 (ite $x1871 $x1895 (ite $x1869 $x1892 $x1895)))))))
 (let (($x1880 (= c_____________ left-to-center)))
 (let (($x1881 (and $x1880 $x1877)))
 (ite $x1881 $x1895 $x1909)))))))))))))))))))))))))))))))
(assert
 (= c_______________ c!14))
(assert
 (let ((?x1637 (left s______________)))
 (let ((?x1775 (left s_______________)))
 (let (($x2035 (= ?x1775 ?x1637)))
 (let ((?x1671 (right s______________)))
 (let ((?x2002 (top ?x1671)))
 (let ((?x2003 (stack ?x2002 ?x1637)))
 (let (($x2029 (= ?x1775 ?x2003)))
 (let (($x2005 ((_ is stack ) ?x1671)))
 (let (($x2008 (= c______________ right-to-left)))
 (let (($x2009 (and $x2008 $x2005)))
 (let ((?x1857 (center s______________)))
 (let (($x2010 ((_ is stack ) ?x1857)))
 (let (($x2011 (= c______________ center-to-right)))
 (let (($x2012 (and $x2011 $x2010)))
 (let ((?x1998 (top ?x1857)))
 (let ((?x1999 (stack ?x1998 ?x1637)))
 (let (($x2026 (= ?x1775 ?x1999)))
 (let (($x2013 (= c______________ center-to-left)))
 (let (($x2014 (and $x2013 $x2010)))
 (let ((?x1808 (rest ?x1637)))
 (let (($x2022 (= ?x1775 ?x1808)))
 (let (($x2015 ((_ is stack ) ?x1637)))
 (let (($x2016 (= c______________ left-to-right)))
 (let (($x2017 (and $x2016 $x2015)))
 (let (($x2018 (= c______________ left-to-center)))
 (let (($x2019 (and $x2018 $x2015)))
 (ite $x2019 $x2022 (ite $x2017 $x2022 (ite $x2014 $x2026 (ite $x2012 $x2035 (ite $x2009 $x2029 $x2035))))))))))))))))))))))))))))))))
(assert
 (let ((?x1671 (right s______________)))
 (let ((?x1809 (right s_______________)))
 (let (($x2031 (= ?x1809 ?x1671)))
 (let ((?x2001 (rest ?x1671)))
 (let (($x2028 (= ?x1809 ?x2001)))
 (let (($x2005 ((_ is stack ) ?x1671)))
 (let (($x2006 (= c______________ right-to-center)))
 (let (($x2007 (and $x2006 $x2005)))
 (let (($x2008 (= c______________ right-to-left)))
 (let (($x2009 (and $x2008 $x2005)))
 (let ((?x1857 (center s______________)))
 (let ((?x1998 (top ?x1857)))
 (let ((?x2000 (stack ?x1998 ?x1671)))
 (let (($x2027 (= ?x1809 ?x2000)))
 (let (($x2010 ((_ is stack ) ?x1857)))
 (let (($x2011 (= c______________ center-to-right)))
 (let (($x2012 (and $x2011 $x2010)))
 (let (($x2013 (= c______________ center-to-left)))
 ...
 (let (($x2016 (= c______________ left-to-right)))
 (let (($x2017 (and $x2016 $x2015)))
 (let (($x2048 (ite $x2017 $x2031 (ite $x2014 $x2031 (ite $x2012 $x2027 (ite $x2009 $x2028 (ite $x2007 $x2028 $x2031)))))))
 (let ((?x1855 (top ?x1637)))
 (let ((?x1994 (stack ?x1855 ?x1671)))
 (let (($x2023 (= ?x1809 ?x1994)))
 (let (($x2018 (= c______________ left-to-center)))
 (let (($x2019 (and $x2018 $x2015)))
 (ite $x2019 $x2023 $x2048)))))))))))))))))))))))))))))))
(assert
 (let ((?x1857 (center s______________)))
 (let ((?x1995 (center s_______________)))
 (let (($x2033 (= ?x1995 ?x1857)))
 (let ((?x1671 (right s______________)))
 (let ((?x2002 (top ?x1671)))
 (let ((?x2004 (stack ?x2002 ?x1857)))
 (let (($x2030 (= ?x1995 ?x2004)))
 (let (($x2005 ((_ is stack ) ?x1671)))
 (let (($x2006 (= c______________ right-to-center)))
 (let (($x2007 (and $x2006 $x2005)))
 (let (($x2008 (= c______________ right-to-left)))
 (let (($x2009 (and $x2008 $x2005)))
 (let ((?x1997 (rest ?x1857)))
 (let (($x2025 (= ?x1995 ?x1997)))
 (let (($x2010 ((_ is stack ) ?x1857)))
 (let (($x2011 (= c______________ center-to-right)))
 (let (($x2012 (and $x2011 $x2010)))
 (let (($x2013 (= c______________ center-to-left)))
 ...
 (let ((?x1637 (left s______________)))
 (let ((?x1855 (top ?x1637)))
 (let ((?x1996 (stack ?x1855 ?x1857)))
 (let (($x2024 (= ?x1995 ?x1996)))
 (let (($x2015 ((_ is stack ) ?x1637)))
 (let (($x2016 (= c______________ left-to-right)))
 (let (($x2017 (and $x2016 $x2015)))
 (let (($x2047 (ite $x2017 $x2024 (ite $x2014 $x2025 (ite $x2012 $x2025 (ite $x2009 $x2033 (ite $x2007 $x2030 $x2033)))))))
 (let (($x2018 (= c______________ left-to-center)))
 (let (($x2019 (and $x2018 $x2015)))
 (ite $x2019 $x2033 $x2047)))))))))))))))))))))))))))))))
(assert
 (= c________________ c!15))
(assert
 (let ((?x1775 (left s_______________)))
 (let ((?x1913 (left s________________)))
 (let (($x2173 (= ?x1913 ?x1775)))
 (let ((?x1809 (right s_______________)))
 (let ((?x2140 (top ?x1809)))
 (let ((?x2141 (stack ?x2140 ?x1775)))
 (let (($x2167 (= ?x1913 ?x2141)))
 (let (($x2143 ((_ is stack ) ?x1809)))
 (let (($x2146 (= c_______________ right-to-left)))
 (let (($x2147 (and $x2146 $x2143)))
 (let ((?x1995 (center s_______________)))
 (let (($x2148 ((_ is stack ) ?x1995)))
 (let (($x2149 (= c_______________ center-to-right)))
 (let (($x2150 (and $x2149 $x2148)))
 (let ((?x2136 (top ?x1995)))
 (let ((?x2137 (stack ?x2136 ?x1775)))
 (let (($x2164 (= ?x1913 ?x2137)))
 (let (($x2151 (= c_______________ center-to-left)))
 (let (($x2152 (and $x2151 $x2148)))
 (let ((?x1946 (rest ?x1775)))
 (let (($x2160 (= ?x1913 ?x1946)))
 (let (($x2153 ((_ is stack ) ?x1775)))
 (let (($x2154 (= c_______________ left-to-right)))
 (let (($x2155 (and $x2154 $x2153)))
 (let (($x2156 (= c_______________ left-to-center)))
 (let (($x2157 (and $x2156 $x2153)))
 (ite $x2157 $x2160 (ite $x2155 $x2160 (ite $x2152 $x2164 (ite $x2150 $x2173 (ite $x2147 $x2167 $x2173))))))))))))))))))))))))))))))))
(assert
 (let ((?x1809 (right s_______________)))
 (let ((?x1947 (right s________________)))
 (let (($x2169 (= ?x1947 ?x1809)))
 (let ((?x2139 (rest ?x1809)))
 (let (($x2166 (= ?x1947 ?x2139)))
 (let (($x2143 ((_ is stack ) ?x1809)))
 (let (($x2144 (= c_______________ right-to-center)))
 (let (($x2145 (and $x2144 $x2143)))
 (let (($x2146 (= c_______________ right-to-left)))
 (let (($x2147 (and $x2146 $x2143)))
 (let ((?x1995 (center s_______________)))
 (let ((?x2136 (top ?x1995)))
 (let ((?x2138 (stack ?x2136 ?x1809)))
 (let (($x2165 (= ?x1947 ?x2138)))
 (let (($x2148 ((_ is stack ) ?x1995)))
 (let (($x2149 (= c_______________ center-to-right)))
 (let (($x2150 (and $x2149 $x2148)))
 (let (($x2151 (= c_______________ center-to-left)))
 ...
 (let (($x2154 (= c_______________ left-to-right)))
 (let (($x2155 (and $x2154 $x2153)))
 (let (($x2186 (ite $x2155 $x2169 (ite $x2152 $x2169 (ite $x2150 $x2165 (ite $x2147 $x2166 (ite $x2145 $x2166 $x2169)))))))
 (let ((?x1993 (top ?x1775)))
 (let ((?x2132 (stack ?x1993 ?x1809)))
 (let (($x2161 (= ?x1947 ?x2132)))
 (let (($x2156 (= c_______________ left-to-center)))
 (let (($x2157 (and $x2156 $x2153)))
 (ite $x2157 $x2161 $x2186)))))))))))))))))))))))))))))))
(assert
 (let ((?x1995 (center s_______________)))
 (let ((?x2133 (center s________________)))
 (let (($x2171 (= ?x2133 ?x1995)))
 (let ((?x1809 (right s_______________)))
 (let ((?x2140 (top ?x1809)))
 (let ((?x2142 (stack ?x2140 ?x1995)))
 (let (($x2168 (= ?x2133 ?x2142)))
 (let (($x2143 ((_ is stack ) ?x1809)))
 (let (($x2144 (= c_______________ right-to-center)))
 (let (($x2145 (and $x2144 $x2143)))
 (let (($x2146 (= c_______________ right-to-left)))
 (let (($x2147 (and $x2146 $x2143)))
 (let ((?x2135 (rest ?x1995)))
 (let (($x2163 (= ?x2133 ?x2135)))
 (let (($x2148 ((_ is stack ) ?x1995)))
 (let (($x2149 (= c_______________ center-to-right)))
 (let (($x2150 (and $x2149 $x2148)))
 (let (($x2151 (= c_______________ center-to-left)))
 ...
 (let ((?x1775 (left s_______________)))
 (let ((?x1993 (top ?x1775)))
 (let ((?x2134 (stack ?x1993 ?x1995)))
 (let (($x2162 (= ?x2133 ?x2134)))
 (let (($x2153 ((_ is stack ) ?x1775)))
 (let (($x2154 (= c_______________ left-to-right)))
 (let (($x2155 (and $x2154 $x2153)))
 (let (($x2185 (ite $x2155 $x2162 (ite $x2152 $x2163 (ite $x2150 $x2163 (ite $x2147 $x2171 (ite $x2145 $x2168 $x2171)))))))
 (let (($x2156 (= c_______________ left-to-center)))
 (let (($x2157 (and $x2156 $x2153)))
 (ite $x2157 $x2171 $x2185)))))))))))))))))))))))))))))))
(assert
 (= c_________________ c!16))
(assert
 (let ((?x1913 (left s________________)))
 (let ((?x2051 (left s_________________)))
 (let (($x2311 (= ?x2051 ?x1913)))
 (let ((?x1947 (right s________________)))
 (let ((?x2278 (top ?x1947)))
 (let ((?x2279 (stack ?x2278 ?x1913)))
 (let (($x2305 (= ?x2051 ?x2279)))
 (let (($x2281 ((_ is stack ) ?x1947)))
 (let (($x2284 (= c________________ right-to-left)))
 (let (($x2285 (and $x2284 $x2281)))
 (let ((?x2133 (center s________________)))
 (let (($x2286 ((_ is stack ) ?x2133)))
 (let (($x2287 (= c________________ center-to-right)))
 (let (($x2288 (and $x2287 $x2286)))
 (let ((?x2274 (top ?x2133)))
 (let ((?x2275 (stack ?x2274 ?x1913)))
 (let (($x2302 (= ?x2051 ?x2275)))
 (let (($x2289 (= c________________ center-to-left)))
 (let (($x2290 (and $x2289 $x2286)))
 (let ((?x2084 (rest ?x1913)))
 (let (($x2298 (= ?x2051 ?x2084)))
 (let (($x2291 ((_ is stack ) ?x1913)))
 (let (($x2292 (= c________________ left-to-right)))
 (let (($x2293 (and $x2292 $x2291)))
 (let (($x2294 (= c________________ left-to-center)))
 (let (($x2295 (and $x2294 $x2291)))
 (ite $x2295 $x2298 (ite $x2293 $x2298 (ite $x2290 $x2302 (ite $x2288 $x2311 (ite $x2285 $x2305 $x2311))))))))))))))))))))))))))))))))
(assert
 (let ((?x1947 (right s________________)))
 (let ((?x2085 (right s_________________)))
 (let (($x2307 (= ?x2085 ?x1947)))
 (let ((?x2277 (rest ?x1947)))
 (let (($x2304 (= ?x2085 ?x2277)))
 (let (($x2281 ((_ is stack ) ?x1947)))
 (let (($x2282 (= c________________ right-to-center)))
 (let (($x2283 (and $x2282 $x2281)))
 (let (($x2284 (= c________________ right-to-left)))
 (let (($x2285 (and $x2284 $x2281)))
 (let ((?x2133 (center s________________)))
 (let ((?x2274 (top ?x2133)))
 (let ((?x2276 (stack ?x2274 ?x1947)))
 (let (($x2303 (= ?x2085 ?x2276)))
 (let (($x2286 ((_ is stack ) ?x2133)))
 (let (($x2287 (= c________________ center-to-right)))
 (let (($x2288 (and $x2287 $x2286)))
 (let (($x2289 (= c________________ center-to-left)))
 ...
 (let (($x2292 (= c________________ left-to-right)))
 (let (($x2293 (and $x2292 $x2291)))
 (let (($x2324 (ite $x2293 $x2307 (ite $x2290 $x2307 (ite $x2288 $x2303 (ite $x2285 $x2304 (ite $x2283 $x2304 $x2307)))))))
 (let ((?x2131 (top ?x1913)))
 (let ((?x2270 (stack ?x2131 ?x1947)))
 (let (($x2299 (= ?x2085 ?x2270)))
 (let (($x2294 (= c________________ left-to-center)))
 (let (($x2295 (and $x2294 $x2291)))
 (ite $x2295 $x2299 $x2324)))))))))))))))))))))))))))))))
(assert
 (let ((?x2133 (center s________________)))
 (let ((?x2271 (center s_________________)))
 (let (($x2309 (= ?x2271 ?x2133)))
 (let ((?x1947 (right s________________)))
 (let ((?x2278 (top ?x1947)))
 (let ((?x2280 (stack ?x2278 ?x2133)))
 (let (($x2306 (= ?x2271 ?x2280)))
 (let (($x2281 ((_ is stack ) ?x1947)))
 (let (($x2282 (= c________________ right-to-center)))
 (let (($x2283 (and $x2282 $x2281)))
 (let (($x2284 (= c________________ right-to-left)))
 (let (($x2285 (and $x2284 $x2281)))
 (let ((?x2273 (rest ?x2133)))
 (let (($x2301 (= ?x2271 ?x2273)))
 (let (($x2286 ((_ is stack ) ?x2133)))
 (let (($x2287 (= c________________ center-to-right)))
 (let (($x2288 (and $x2287 $x2286)))
 (let (($x2289 (= c________________ center-to-left)))
 ...
 (let ((?x1913 (left s________________)))
 (let ((?x2131 (top ?x1913)))
 (let ((?x2272 (stack ?x2131 ?x2133)))
 (let (($x2300 (= ?x2271 ?x2272)))
 (let (($x2291 ((_ is stack ) ?x1913)))
 (let (($x2292 (= c________________ left-to-right)))
 (let (($x2293 (and $x2292 $x2291)))
 (let (($x2323 (ite $x2293 $x2300 (ite $x2290 $x2301 (ite $x2288 $x2301 (ite $x2285 $x2309 (ite $x2283 $x2306 $x2309)))))))
 (let (($x2294 (= c________________ left-to-center)))
 (let (($x2295 (and $x2294 $x2291)))
 (ite $x2295 $x2309 $x2323)))))))))))))))))))))))))))))))
(assert
 (let ((?x40 (stack H empty)))
 (let ((?x2085 (right s_________________)))
 (let (($x2327 (= ?x2085 ?x40)))
 (let ((?x2271 (center s_________________)))
 (let (($x2358 (= ?x2271 empty)))
 (let ((?x36 (stack G (stack C (stack E (stack F (stack I (stack A empty))))))))
 (let ((?x39 (stack D (stack B (stack J ?x36)))))
 (let ((?x2051 (left s_________________)))
 (let (($x2359 (= ?x2051 ?x39)))
 (let (($x2361 (not (and $x2359 $x2358 $x2327))))
 (not $x2361))))))))))))
(check-sat)
