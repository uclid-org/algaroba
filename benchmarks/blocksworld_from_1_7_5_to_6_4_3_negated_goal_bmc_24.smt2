...
(assert
 ...
 (let ((?x330 (right s____)))
 (let ((?x641 (top ?x330)))
 (let ((?x642 (stack ?x641 ?x285)))
 (let (($x668 (= ?x414 ?x642)))
 (let (($x644 ((_ is stack ) ?x330)))
...
(assert
 ...
 (let ((?x3174 (left s_________________________)))
 (let (($x3482 (= ?x3174 ?x43)))
 (let (($x3484 (not (and $x3482 $x3481 $x3450))))
 (not $x3484))))))))))))
(check-sat)
