...
(assert
 (let ((?x3316 (left s__________________________)))
 (let ((?x3454 (left s___________________________)))
 (let (($x3714 (= ?x3454 ?x3316)))
 (let ((?x3350 (right s__________________________)))
 (let ((?x3681 (top ?x3350)))
 (let ((?x3682 (stack ?x3681 ?x3316)))
 (let (($x3708 (= ?x3454 ?x3682)))
 (let (($x3684 ((_ is stack ) ?x3350)))
 (let (($x3687 (= c__________________________ right-to-left)))
 (let (($x3688 (and $x3687 $x3684)))
 (let ((?x3536 (center s__________________________)))
 (let (($x3689 ((_ is stack ) ?x3536)))
 (let (($x3690 (= c__________________________ center-to-right)))
 (let (($x3691 (and $x3690 $x3689)))
 (let ((?x3677 (top ?x3536)))
 (let ((?x3678 (stack ?x3677 ?x3316)))
 (let (($x3705 (= ?x3454 ?x3678)))
 (let (($x3692 (= c__________________________ center-to-left)))
 (let (($x3693 (and $x3692 $x3689)))
 (let ((?x3487 (rest ?x3316)))
 (let (($x3701 (= ?x3454 ?x3487)))
 (let (($x3694 ((_ is stack ) ?x3316)))
 (let (($x3695 (= c__________________________ left-to-right)))
 (let (($x3696 (and $x3695 $x3694)))
 (let (($x3697 (= c__________________________ left-to-center)))
 (let (($x3698 (and $x3697 $x3694)))
 (ite $x3698 $x3701 (ite $x3696 $x3701 (ite $x3693 $x3705 (ite $x3691 $x3714 (ite $x3688 $x3708 $x3714))))))))))))))))))))))))))))))))
(assert
 (let ((?x3350 (right s__________________________)))
 (let ((?x3488 (right s___________________________)))
 (let (($x3710 (= ?x3488 ?x3350)))
 (let ((?x3680 (rest ?x3350)))
 (let (($x3707 (= ?x3488 ?x3680)))
 (let (($x3684 ((_ is stack ) ?x3350)))
 (let (($x3685 (= c__________________________ right-to-center)))
 (let (($x3686 (and $x3685 $x3684)))
 (let (($x3687 (= c__________________________ right-to-left)))
 (let (($x3688 (and $x3687 $x3684)))
 (let ((?x3536 (center s__________________________)))
 (let ((?x3677 (top ?x3536)))
 (let ((?x3679 (stack ?x3677 ?x3350)))
 (let (($x3706 (= ?x3488 ?x3679)))
 (let (($x3689 ((_ is stack ) ?x3536)))
 (let (($x3690 (= c__________________________ center-to-right)))
 (let (($x3691 (and $x3690 $x3689)))
 (let (($x3692 (= c__________________________ center-to-left)))
 ...
 (let (($x3695 (= c__________________________ left-to-right)))
 (let (($x3696 (and $x3695 $x3694)))
 (let (($x3727 (ite $x3696 $x3710 (ite $x3693 $x3710 (ite $x3691 $x3706 (ite $x3688 $x3707 (ite $x3686 $x3707 $x3710)))))))
 (let ((?x3534 (top ?x3316)))
 (let ((?x3673 (stack ?x3534 ?x3350)))
 (let (($x3702 (= ?x3488 ?x3673)))
 (let (($x3697 (= c__________________________ left-to-center)))
 (let (($x3698 (and $x3697 $x3694)))
 (ite $x3698 $x3702 $x3727)))))))))))))))))))))))))))))))
(assert
 (let ((?x3536 (center s__________________________)))
 (let ((?x3674 (center s___________________________)))
 (let (($x3712 (= ?x3674 ?x3536)))
 (let ((?x3350 (right s__________________________)))
 (let ((?x3681 (top ?x3350)))
 (let ((?x3683 (stack ?x3681 ?x3536)))
 (let (($x3709 (= ?x3674 ?x3683)))
 (let (($x3684 ((_ is stack ) ?x3350)))
 (let (($x3685 (= c__________________________ right-to-center)))
 (let (($x3686 (and $x3685 $x3684)))
 (let (($x3687 (= c__________________________ right-to-left)))
 (let (($x3688 (and $x3687 $x3684)))
 (let ((?x3676 (rest ?x3536)))
 (let (($x3704 (= ?x3674 ?x3676)))
 (let (($x3689 ((_ is stack ) ?x3536)))
 (let (($x3690 (= c__________________________ center-to-right)))
 (let (($x3691 (and $x3690 $x3689)))
 (let (($x3692 (= c__________________________ center-to-left)))
 ...
 (let ((?x3316 (left s__________________________)))
 (let ((?x3534 (top ?x3316)))
 (let ((?x3675 (stack ?x3534 ?x3536)))
 (let (($x3703 (= ?x3674 ?x3675)))
 (let (($x3694 ((_ is stack ) ?x3316)))
 (let (($x3695 (= c__________________________ left-to-right)))
 (let (($x3696 (and $x3695 $x3694)))
 (let (($x3726 (ite $x3696 $x3703 (ite $x3693 $x3704 (ite $x3691 $x3704 (ite $x3688 $x3712 (ite $x3686 $x3709 $x3712)))))))
 (let (($x3697 (= c__________________________ left-to-center)))
 (let (($x3698 (and $x3697 $x3694)))
 (ite $x3698 $x3712 $x3726)))))))))))))))))))))))))))))))
(assert
 (= c____________________________ c!27))
(assert
 (let ((?x3454 (left s___________________________)))
 (let ((?x3592 (left s____________________________)))
 (let (($x3852 (= ?x3592 ?x3454)))
 (let ((?x3488 (right s___________________________)))
 (let ((?x3819 (top ?x3488)))
 (let ((?x3820 (stack ?x3819 ?x3454)))
 (let (($x3846 (= ?x3592 ?x3820)))
 (let (($x3822 ((_ is stack ) ?x3488)))
 (let (($x3825 (= c___________________________ right-to-left)))
 (let (($x3826 (and $x3825 $x3822)))
 (let ((?x3674 (center s___________________________)))
 (let (($x3827 ((_ is stack ) ?x3674)))
 (let (($x3828 (= c___________________________ center-to-right)))
 (let (($x3829 (and $x3828 $x3827)))
 (let ((?x3815 (top ?x3674)))
 (let ((?x3816 (stack ?x3815 ?x3454)))
 (let (($x3843 (= ?x3592 ?x3816)))
 (let (($x3830 (= c___________________________ center-to-left)))
 (let (($x3831 (and $x3830 $x3827)))
 (let ((?x3625 (rest ?x3454)))
 (let (($x3839 (= ?x3592 ?x3625)))
 (let (($x3832 ((_ is stack ) ?x3454)))
 (let (($x3833 (= c___________________________ left-to-right)))
 (let (($x3834 (and $x3833 $x3832)))
 (let (($x3835 (= c___________________________ left-to-center)))
 (let (($x3836 (and $x3835 $x3832)))
 (ite $x3836 $x3839 (ite $x3834 $x3839 (ite $x3831 $x3843 (ite $x3829 $x3852 (ite $x3826 $x3846 $x3852))))))))))))))))))))))))))))))))
(assert
 (let ((?x3488 (right s___________________________)))
 (let ((?x3626 (right s____________________________)))
 (let (($x3848 (= ?x3626 ?x3488)))
 (let ((?x3818 (rest ?x3488)))
 (let (($x3845 (= ?x3626 ?x3818)))
 (let (($x3822 ((_ is stack ) ?x3488)))
 (let (($x3823 (= c___________________________ right-to-center)))
 (let (($x3824 (and $x3823 $x3822)))
 (let (($x3825 (= c___________________________ right-to-left)))
 (let (($x3826 (and $x3825 $x3822)))
 (let ((?x3674 (center s___________________________)))
 (let ((?x3815 (top ?x3674)))
 (let ((?x3817 (stack ?x3815 ?x3488)))
 (let (($x3844 (= ?x3626 ?x3817)))
 (let (($x3827 ((_ is stack ) ?x3674)))
 (let (($x3828 (= c___________________________ center-to-right)))
 (let (($x3829 (and $x3828 $x3827)))
 (let (($x3830 (= c___________________________ center-to-left)))
 ...
 (let (($x3833 (= c___________________________ left-to-right)))
 (let (($x3834 (and $x3833 $x3832)))
 (let (($x3865 (ite $x3834 $x3848 (ite $x3831 $x3848 (ite $x3829 $x3844 (ite $x3826 $x3845 (ite $x3824 $x3845 $x3848)))))))
 (let ((?x3672 (top ?x3454)))
 (let ((?x3811 (stack ?x3672 ?x3488)))
 (let (($x3840 (= ?x3626 ?x3811)))
 (let (($x3835 (= c___________________________ left-to-center)))
 (let (($x3836 (and $x3835 $x3832)))
 (ite $x3836 $x3840 $x3865)))))))))))))))))))))))))))))))
(assert
 (let ((?x3674 (center s___________________________)))
 (let ((?x3812 (center s____________________________)))
 (let (($x3850 (= ?x3812 ?x3674)))
 (let ((?x3488 (right s___________________________)))
 (let ((?x3819 (top ?x3488)))
 (let ((?x3821 (stack ?x3819 ?x3674)))
 (let (($x3847 (= ?x3812 ?x3821)))
 (let (($x3822 ((_ is stack ) ?x3488)))
 (let (($x3823 (= c___________________________ right-to-center)))
 (let (($x3824 (and $x3823 $x3822)))
 (let (($x3825 (= c___________________________ right-to-left)))
 (let (($x3826 (and $x3825 $x3822)))
 (let ((?x3814 (rest ?x3674)))
 (let (($x3842 (= ?x3812 ?x3814)))
 (let (($x3827 ((_ is stack ) ?x3674)))
 (let (($x3828 (= c___________________________ center-to-right)))
 (let (($x3829 (and $x3828 $x3827)))
 (let (($x3830 (= c___________________________ center-to-left)))
 ...
 (let ((?x3454 (left s___________________________)))
 (let ((?x3672 (top ?x3454)))
 (let ((?x3813 (stack ?x3672 ?x3674)))
 (let (($x3841 (= ?x3812 ?x3813)))
 (let (($x3832 ((_ is stack ) ?x3454)))
 (let (($x3833 (= c___________________________ left-to-right)))
 (let (($x3834 (and $x3833 $x3832)))
 (let (($x3864 (ite $x3834 $x3841 (ite $x3831 $x3842 (ite $x3829 $x3842 (ite $x3826 $x3850 (ite $x3824 $x3847 $x3850)))))))
 (let (($x3835 (= c___________________________ left-to-center)))
 (let (($x3836 (and $x3835 $x3832)))
 (ite $x3836 $x3850 $x3864)))))))))))))))))))))))))))))))
(assert
 (= c_____________________________ c!28))
(assert
 (let ((?x3592 (left s____________________________)))
 (let ((?x3730 (left s_____________________________)))
 (let (($x3990 (= ?x3730 ?x3592)))
 (let ((?x3626 (right s____________________________)))
 (let ((?x3957 (top ?x3626)))
 (let ((?x3958 (stack ?x3957 ?x3592)))
 (let (($x3984 (= ?x3730 ?x3958)))
 (let (($x3960 ((_ is stack ) ?x3626)))
 (let (($x3963 (= c____________________________ right-to-left)))
 (let (($x3964 (and $x3963 $x3960)))
 (let ((?x3812 (center s____________________________)))
 (let (($x3965 ((_ is stack ) ?x3812)))
 (let (($x3966 (= c____________________________ center-to-right)))
 (let (($x3967 (and $x3966 $x3965)))
 (let ((?x3953 (top ?x3812)))
 (let ((?x3954 (stack ?x3953 ?x3592)))
 (let (($x3981 (= ?x3730 ?x3954)))
 (let (($x3968 (= c____________________________ center-to-left)))
 (let (($x3969 (and $x3968 $x3965)))
 (let ((?x3763 (rest ?x3592)))
 (let (($x3977 (= ?x3730 ?x3763)))
 (let (($x3970 ((_ is stack ) ?x3592)))
 (let (($x3971 (= c____________________________ left-to-right)))
 (let (($x3972 (and $x3971 $x3970)))
 (let (($x3973 (= c____________________________ left-to-center)))
 (let (($x3974 (and $x3973 $x3970)))
 (ite $x3974 $x3977 (ite $x3972 $x3977 (ite $x3969 $x3981 (ite $x3967 $x3990 (ite $x3964 $x3984 $x3990))))))))))))))))))))))))))))))))
(assert
 (let ((?x3626 (right s____________________________)))
 (let ((?x3764 (right s_____________________________)))
 (let (($x3986 (= ?x3764 ?x3626)))
 (let ((?x3956 (rest ?x3626)))
 (let (($x3983 (= ?x3764 ?x3956)))
 (let (($x3960 ((_ is stack ) ?x3626)))
 (let (($x3961 (= c____________________________ right-to-center)))
 (let (($x3962 (and $x3961 $x3960)))
 (let (($x3963 (= c____________________________ right-to-left)))
 (let (($x3964 (and $x3963 $x3960)))
 (let ((?x3812 (center s____________________________)))
 (let ((?x3953 (top ?x3812)))
 (let ((?x3955 (stack ?x3953 ?x3626)))
 (let (($x3982 (= ?x3764 ?x3955)))
 (let (($x3965 ((_ is stack ) ?x3812)))
 (let (($x3966 (= c____________________________ center-to-right)))
 (let (($x3967 (and $x3966 $x3965)))
 (let (($x3968 (= c____________________________ center-to-left)))
 ...
 (let (($x3971 (= c____________________________ left-to-right)))
 (let (($x3972 (and $x3971 $x3970)))
 (let (($x4003 (ite $x3972 $x3986 (ite $x3969 $x3986 (ite $x3967 $x3982 (ite $x3964 $x3983 (ite $x3962 $x3983 $x3986)))))))
 (let ((?x3810 (top ?x3592)))
 (let ((?x3949 (stack ?x3810 ?x3626)))
 (let (($x3978 (= ?x3764 ?x3949)))
 (let (($x3973 (= c____________________________ left-to-center)))
 (let (($x3974 (and $x3973 $x3970)))
 (ite $x3974 $x3978 $x4003)))))))))))))))))))))))))))))))
(assert
 (let ((?x3812 (center s____________________________)))
 (let ((?x3950 (center s_____________________________)))
 (let (($x3988 (= ?x3950 ?x3812)))
 (let ((?x3626 (right s____________________________)))
 (let ((?x3957 (top ?x3626)))
 (let ((?x3959 (stack ?x3957 ?x3812)))
 (let (($x3985 (= ?x3950 ?x3959)))
 (let (($x3960 ((_ is stack ) ?x3626)))
 (let (($x3961 (= c____________________________ right-to-center)))
 (let (($x3962 (and $x3961 $x3960)))
 (let (($x3963 (= c____________________________ right-to-left)))
 (let (($x3964 (and $x3963 $x3960)))
 (let ((?x3952 (rest ?x3812)))
 (let (($x3980 (= ?x3950 ?x3952)))
 (let (($x3965 ((_ is stack ) ?x3812)))
 (let (($x3966 (= c____________________________ center-to-right)))
 (let (($x3967 (and $x3966 $x3965)))
 (let (($x3968 (= c____________________________ center-to-left)))
 ...
 (let ((?x3592 (left s____________________________)))
 (let ((?x3810 (top ?x3592)))
 (let ((?x3951 (stack ?x3810 ?x3812)))
 (let (($x3979 (= ?x3950 ?x3951)))
 (let (($x3970 ((_ is stack ) ?x3592)))
 (let (($x3971 (= c____________________________ left-to-right)))
 (let (($x3972 (and $x3971 $x3970)))
 (let (($x4002 (ite $x3972 $x3979 (ite $x3969 $x3980 (ite $x3967 $x3980 (ite $x3964 $x3988 (ite $x3962 $x3985 $x3988)))))))
 (let (($x3973 (= c____________________________ left-to-center)))
 (let (($x3974 (and $x3973 $x3970)))
 (ite $x3974 $x3988 $x4002)))))))))))))))))))))))))))))))
(assert
 (= c______________________________ c!29))
(assert
 (let ((?x3730 (left s_____________________________)))
 (let ((?x3868 (left s______________________________)))
 (let (($x4128 (= ?x3868 ?x3730)))
 (let ((?x3764 (right s_____________________________)))
 (let ((?x4095 (top ?x3764)))
 (let ((?x4096 (stack ?x4095 ?x3730)))
 (let (($x4122 (= ?x3868 ?x4096)))
 (let (($x4098 ((_ is stack ) ?x3764)))
 (let (($x4101 (= c_____________________________ right-to-left)))
 (let (($x4102 (and $x4101 $x4098)))
 (let ((?x3950 (center s_____________________________)))
 (let (($x4103 ((_ is stack ) ?x3950)))
 (let (($x4104 (= c_____________________________ center-to-right)))
 (let (($x4105 (and $x4104 $x4103)))
 (let ((?x4091 (top ?x3950)))
 (let ((?x4092 (stack ?x4091 ?x3730)))
 (let (($x4119 (= ?x3868 ?x4092)))
 (let (($x4106 (= c_____________________________ center-to-left)))
 (let (($x4107 (and $x4106 $x4103)))
 (let ((?x3901 (rest ?x3730)))
 (let (($x4115 (= ?x3868 ?x3901)))
 (let (($x4108 ((_ is stack ) ?x3730)))
 (let (($x4109 (= c_____________________________ left-to-right)))
 (let (($x4110 (and $x4109 $x4108)))
 (let (($x4111 (= c_____________________________ left-to-center)))
 (let (($x4112 (and $x4111 $x4108)))
 (ite $x4112 $x4115 (ite $x4110 $x4115 (ite $x4107 $x4119 (ite $x4105 $x4128 (ite $x4102 $x4122 $x4128))))))))))))))))))))))))))))))))
(assert
 (let ((?x3764 (right s_____________________________)))
 (let ((?x3902 (right s______________________________)))
 (let (($x4124 (= ?x3902 ?x3764)))
 (let ((?x4094 (rest ?x3764)))
 (let (($x4121 (= ?x3902 ?x4094)))
 (let (($x4098 ((_ is stack ) ?x3764)))
 (let (($x4099 (= c_____________________________ right-to-center)))
 (let (($x4100 (and $x4099 $x4098)))
 (let (($x4101 (= c_____________________________ right-to-left)))
 (let (($x4102 (and $x4101 $x4098)))
 (let ((?x3950 (center s_____________________________)))
 (let ((?x4091 (top ?x3950)))
 (let ((?x4093 (stack ?x4091 ?x3764)))
 (let (($x4120 (= ?x3902 ?x4093)))
 (let (($x4103 ((_ is stack ) ?x3950)))
 (let (($x4104 (= c_____________________________ center-to-right)))
 (let (($x4105 (and $x4104 $x4103)))
 (let (($x4106 (= c_____________________________ center-to-left)))
 ...
 (let (($x4109 (= c_____________________________ left-to-right)))
 (let (($x4110 (and $x4109 $x4108)))
 (let (($x4141 (ite $x4110 $x4124 (ite $x4107 $x4124 (ite $x4105 $x4120 (ite $x4102 $x4121 (ite $x4100 $x4121 $x4124)))))))
 (let ((?x3948 (top ?x3730)))
 (let ((?x4087 (stack ?x3948 ?x3764)))
 (let (($x4116 (= ?x3902 ?x4087)))
 (let (($x4111 (= c_____________________________ left-to-center)))
 (let (($x4112 (and $x4111 $x4108)))
 (ite $x4112 $x4116 $x4141)))))))))))))))))))))))))))))))
(assert
 (let ((?x3950 (center s_____________________________)))
 (let ((?x4088 (center s______________________________)))
 (let (($x4126 (= ?x4088 ?x3950)))
 (let ((?x3764 (right s_____________________________)))
 (let ((?x4095 (top ?x3764)))
 (let ((?x4097 (stack ?x4095 ?x3950)))
 (let (($x4123 (= ?x4088 ?x4097)))
 (let (($x4098 ((_ is stack ) ?x3764)))
 (let (($x4099 (= c_____________________________ right-to-center)))
 (let (($x4100 (and $x4099 $x4098)))
 (let (($x4101 (= c_____________________________ right-to-left)))
 (let (($x4102 (and $x4101 $x4098)))
 (let ((?x4090 (rest ?x3950)))
 (let (($x4118 (= ?x4088 ?x4090)))
 (let (($x4103 ((_ is stack ) ?x3950)))
 (let (($x4104 (= c_____________________________ center-to-right)))
 (let (($x4105 (and $x4104 $x4103)))
 (let (($x4106 (= c_____________________________ center-to-left)))
 ...
 (let ((?x3730 (left s_____________________________)))
 (let ((?x3948 (top ?x3730)))
 (let ((?x4089 (stack ?x3948 ?x3950)))
 (let (($x4117 (= ?x4088 ?x4089)))
 (let (($x4108 ((_ is stack ) ?x3730)))
 (let (($x4109 (= c_____________________________ left-to-right)))
 (let (($x4110 (and $x4109 $x4108)))
 (let (($x4140 (ite $x4110 $x4117 (ite $x4107 $x4118 (ite $x4105 $x4118 (ite $x4102 $x4126 (ite $x4100 $x4123 $x4126)))))))
 (let (($x4111 (= c_____________________________ left-to-center)))
 (let (($x4112 (and $x4111 $x4108)))
 (ite $x4112 $x4126 $x4140)))))))))))))))))))))))))))))))
(assert
 (= c_______________________________ c!30))
(assert
 (let ((?x3868 (left s______________________________)))
 (let ((?x4006 (left s_______________________________)))
 (let (($x4266 (= ?x4006 ?x3868)))
 (let ((?x3902 (right s______________________________)))
 (let ((?x4233 (top ?x3902)))
 (let ((?x4234 (stack ?x4233 ?x3868)))
 (let (($x4260 (= ?x4006 ?x4234)))
 (let (($x4236 ((_ is stack ) ?x3902)))
 (let (($x4239 (= c______________________________ right-to-left)))
 (let (($x4240 (and $x4239 $x4236)))
 (let ((?x4088 (center s______________________________)))
 (let (($x4241 ((_ is stack ) ?x4088)))
 (let (($x4242 (= c______________________________ center-to-right)))
 (let (($x4243 (and $x4242 $x4241)))
 (let ((?x4229 (top ?x4088)))
 (let ((?x4230 (stack ?x4229 ?x3868)))
 (let (($x4257 (= ?x4006 ?x4230)))
 (let (($x4244 (= c______________________________ center-to-left)))
 (let (($x4245 (and $x4244 $x4241)))
 (let ((?x4039 (rest ?x3868)))
 (let (($x4253 (= ?x4006 ?x4039)))
 (let (($x4246 ((_ is stack ) ?x3868)))
 (let (($x4247 (= c______________________________ left-to-right)))
 (let (($x4248 (and $x4247 $x4246)))
 (let (($x4249 (= c______________________________ left-to-center)))
 (let (($x4250 (and $x4249 $x4246)))
 (ite $x4250 $x4253 (ite $x4248 $x4253 (ite $x4245 $x4257 (ite $x4243 $x4266 (ite $x4240 $x4260 $x4266))))))))))))))))))))))))))))))))
(assert
 (let ((?x3902 (right s______________________________)))
 (let ((?x4040 (right s_______________________________)))
 (let (($x4262 (= ?x4040 ?x3902)))
 (let ((?x4232 (rest ?x3902)))
 (let (($x4259 (= ?x4040 ?x4232)))
 (let (($x4236 ((_ is stack ) ?x3902)))
 (let (($x4237 (= c______________________________ right-to-center)))
 (let (($x4238 (and $x4237 $x4236)))
 (let (($x4239 (= c______________________________ right-to-left)))
 (let (($x4240 (and $x4239 $x4236)))
 (let ((?x4088 (center s______________________________)))
 (let ((?x4229 (top ?x4088)))
 (let ((?x4231 (stack ?x4229 ?x3902)))
 (let (($x4258 (= ?x4040 ?x4231)))
 (let (($x4241 ((_ is stack ) ?x4088)))
 (let (($x4242 (= c______________________________ center-to-right)))
 (let (($x4243 (and $x4242 $x4241)))
 (let (($x4244 (= c______________________________ center-to-left)))
 ...
 (let (($x4247 (= c______________________________ left-to-right)))
 (let (($x4248 (and $x4247 $x4246)))
 (let (($x4279 (ite $x4248 $x4262 (ite $x4245 $x4262 (ite $x4243 $x4258 (ite $x4240 $x4259 (ite $x4238 $x4259 $x4262)))))))
 (let ((?x4086 (top ?x3868)))
 (let ((?x4225 (stack ?x4086 ?x3902)))
 (let (($x4254 (= ?x4040 ?x4225)))
 (let (($x4249 (= c______________________________ left-to-center)))
 (let (($x4250 (and $x4249 $x4246)))
 (ite $x4250 $x4254 $x4279)))))))))))))))))))))))))))))))
(assert
 (let ((?x4088 (center s______________________________)))
 (let ((?x4226 (center s_______________________________)))
 (let (($x4264 (= ?x4226 ?x4088)))
 (let ((?x3902 (right s______________________________)))
 (let ((?x4233 (top ?x3902)))
 (let ((?x4235 (stack ?x4233 ?x4088)))
 (let (($x4261 (= ?x4226 ?x4235)))
 (let (($x4236 ((_ is stack ) ?x3902)))
 (let (($x4237 (= c______________________________ right-to-center)))
 (let (($x4238 (and $x4237 $x4236)))
 (let (($x4239 (= c______________________________ right-to-left)))
 (let (($x4240 (and $x4239 $x4236)))
 (let ((?x4228 (rest ?x4088)))
 (let (($x4256 (= ?x4226 ?x4228)))
 (let (($x4241 ((_ is stack ) ?x4088)))
 (let (($x4242 (= c______________________________ center-to-right)))
 (let (($x4243 (and $x4242 $x4241)))
 (let (($x4244 (= c______________________________ center-to-left)))
 ...
 (let ((?x3868 (left s______________________________)))
 (let ((?x4086 (top ?x3868)))
 (let ((?x4227 (stack ?x4086 ?x4088)))
 (let (($x4255 (= ?x4226 ?x4227)))
 (let (($x4246 ((_ is stack ) ?x3868)))
 (let (($x4247 (= c______________________________ left-to-right)))
 (let (($x4248 (and $x4247 $x4246)))
 (let (($x4278 (ite $x4248 $x4255 (ite $x4245 $x4256 (ite $x4243 $x4256 (ite $x4240 $x4264 (ite $x4238 $x4261 $x4264)))))))
 (let (($x4249 (= c______________________________ left-to-center)))
 (let (($x4250 (and $x4249 $x4246)))
 (ite $x4250 $x4264 $x4278)))))))))))))))))))))))))))))))
(assert
 (= c________________________________ c!31))
(assert
 (let ((?x4006 (left s_______________________________)))
 (let ((?x4144 (left s________________________________)))
 (let (($x4404 (= ?x4144 ?x4006)))
 (let ((?x4040 (right s_______________________________)))
 (let ((?x4371 (top ?x4040)))
 (let ((?x4372 (stack ?x4371 ?x4006)))
 (let (($x4398 (= ?x4144 ?x4372)))
 (let (($x4374 ((_ is stack ) ?x4040)))
 (let (($x4377 (= c_______________________________ right-to-left)))
 (let (($x4378 (and $x4377 $x4374)))
 (let ((?x4226 (center s_______________________________)))
 (let (($x4379 ((_ is stack ) ?x4226)))
 (let (($x4380 (= c_______________________________ center-to-right)))
 (let (($x4381 (and $x4380 $x4379)))
 (let ((?x4367 (top ?x4226)))
 (let ((?x4368 (stack ?x4367 ?x4006)))
 (let (($x4395 (= ?x4144 ?x4368)))
 (let (($x4382 (= c_______________________________ center-to-left)))
 (let (($x4383 (and $x4382 $x4379)))
 (let ((?x4177 (rest ?x4006)))
 (let (($x4391 (= ?x4144 ?x4177)))
 (let (($x4384 ((_ is stack ) ?x4006)))
 (let (($x4385 (= c_______________________________ left-to-right)))
 (let (($x4386 (and $x4385 $x4384)))
 (let (($x4387 (= c_______________________________ left-to-center)))
 (let (($x4388 (and $x4387 $x4384)))
 (ite $x4388 $x4391 (ite $x4386 $x4391 (ite $x4383 $x4395 (ite $x4381 $x4404 (ite $x4378 $x4398 $x4404))))))))))))))))))))))))))))))))
(assert
 (let ((?x4040 (right s_______________________________)))
 (let ((?x4178 (right s________________________________)))
 (let (($x4400 (= ?x4178 ?x4040)))
 (let ((?x4370 (rest ?x4040)))
 (let (($x4397 (= ?x4178 ?x4370)))
 (let (($x4374 ((_ is stack ) ?x4040)))
 (let (($x4375 (= c_______________________________ right-to-center)))
 (let (($x4376 (and $x4375 $x4374)))
 (let (($x4377 (= c_______________________________ right-to-left)))
 (let (($x4378 (and $x4377 $x4374)))
 (let ((?x4226 (center s_______________________________)))
 (let ((?x4367 (top ?x4226)))
 (let ((?x4369 (stack ?x4367 ?x4040)))
 (let (($x4396 (= ?x4178 ?x4369)))
 (let (($x4379 ((_ is stack ) ?x4226)))
 (let (($x4380 (= c_______________________________ center-to-right)))
 (let (($x4381 (and $x4380 $x4379)))
 (let (($x4382 (= c_______________________________ center-to-left)))
 ...
 (let (($x4385 (= c_______________________________ left-to-right)))
 (let (($x4386 (and $x4385 $x4384)))
 (let (($x4417 (ite $x4386 $x4400 (ite $x4383 $x4400 (ite $x4381 $x4396 (ite $x4378 $x4397 (ite $x4376 $x4397 $x4400)))))))
 (let ((?x4224 (top ?x4006)))
 (let ((?x4363 (stack ?x4224 ?x4040)))
 (let (($x4392 (= ?x4178 ?x4363)))
 (let (($x4387 (= c_______________________________ left-to-center)))
 (let (($x4388 (and $x4387 $x4384)))
 (ite $x4388 $x4392 $x4417)))))))))))))))))))))))))))))))
(assert
 (let ((?x4226 (center s_______________________________)))
 (let ((?x4364 (center s________________________________)))
 (let (($x4402 (= ?x4364 ?x4226)))
 (let ((?x4040 (right s_______________________________)))
 (let ((?x4371 (top ?x4040)))
 (let ((?x4373 (stack ?x4371 ?x4226)))
 (let (($x4399 (= ?x4364 ?x4373)))
 (let (($x4374 ((_ is stack ) ?x4040)))
 (let (($x4375 (= c_______________________________ right-to-center)))
 (let (($x4376 (and $x4375 $x4374)))
 (let (($x4377 (= c_______________________________ right-to-left)))
 (let (($x4378 (and $x4377 $x4374)))
 (let ((?x4366 (rest ?x4226)))
 (let (($x4394 (= ?x4364 ?x4366)))
 (let (($x4379 ((_ is stack ) ?x4226)))
 (let (($x4380 (= c_______________________________ center-to-right)))
 (let (($x4381 (and $x4380 $x4379)))
 (let (($x4382 (= c_______________________________ center-to-left)))
 ...
 (let ((?x4006 (left s_______________________________)))
 (let ((?x4224 (top ?x4006)))
 (let ((?x4365 (stack ?x4224 ?x4226)))
 (let (($x4393 (= ?x4364 ?x4365)))
 (let (($x4384 ((_ is stack ) ?x4006)))
 (let (($x4385 (= c_______________________________ left-to-right)))
 (let (($x4386 (and $x4385 $x4384)))
 (let (($x4416 (ite $x4386 $x4393 (ite $x4383 $x4394 (ite $x4381 $x4394 (ite $x4378 $x4402 (ite $x4376 $x4399 $x4402)))))))
 (let (($x4387 (= c_______________________________ left-to-center)))
 (let (($x4388 (and $x4387 $x4384)))
 (ite $x4388 $x4402 $x4416)))))))))))))))))))))))))))))))
(assert
 (= c_________________________________ c!32))
(assert
 (let ((?x4144 (left s________________________________)))
 (let ((?x4282 (left s_________________________________)))
 (let (($x4542 (= ?x4282 ?x4144)))
 (let ((?x4178 (right s________________________________)))
 (let ((?x4509 (top ?x4178)))
 (let ((?x4510 (stack ?x4509 ?x4144)))
 (let (($x4536 (= ?x4282 ?x4510)))
 (let (($x4512 ((_ is stack ) ?x4178)))
 (let (($x4515 (= c________________________________ right-to-left)))
 (let (($x4516 (and $x4515 $x4512)))
 (let ((?x4364 (center s________________________________)))
 (let (($x4517 ((_ is stack ) ?x4364)))
 (let (($x4518 (= c________________________________ center-to-right)))
 (let (($x4519 (and $x4518 $x4517)))
 (let ((?x4505 (top ?x4364)))
 (let ((?x4506 (stack ?x4505 ?x4144)))
 (let (($x4533 (= ?x4282 ?x4506)))
 (let (($x4520 (= c________________________________ center-to-left)))
 (let (($x4521 (and $x4520 $x4517)))
 (let ((?x4315 (rest ?x4144)))
 (let (($x4529 (= ?x4282 ?x4315)))
 (let (($x4522 ((_ is stack ) ?x4144)))
 (let (($x4523 (= c________________________________ left-to-right)))
 (let (($x4524 (and $x4523 $x4522)))
 (let (($x4525 (= c________________________________ left-to-center)))
 (let (($x4526 (and $x4525 $x4522)))
 (ite $x4526 $x4529 (ite $x4524 $x4529 (ite $x4521 $x4533 (ite $x4519 $x4542 (ite $x4516 $x4536 $x4542))))))))))))))))))))))))))))))))
(assert
 (let ((?x4178 (right s________________________________)))
 (let ((?x4316 (right s_________________________________)))
 (let (($x4538 (= ?x4316 ?x4178)))
 (let ((?x4508 (rest ?x4178)))
 (let (($x4535 (= ?x4316 ?x4508)))
 (let (($x4512 ((_ is stack ) ?x4178)))
 (let (($x4513 (= c________________________________ right-to-center)))
 (let (($x4514 (and $x4513 $x4512)))
 (let (($x4515 (= c________________________________ right-to-left)))
 (let (($x4516 (and $x4515 $x4512)))
 (let ((?x4364 (center s________________________________)))
 (let ((?x4505 (top ?x4364)))
 (let ((?x4507 (stack ?x4505 ?x4178)))
 (let (($x4534 (= ?x4316 ?x4507)))
 (let (($x4517 ((_ is stack ) ?x4364)))
 (let (($x4518 (= c________________________________ center-to-right)))
 (let (($x4519 (and $x4518 $x4517)))
 (let (($x4520 (= c________________________________ center-to-left)))
 ...
 (let (($x4523 (= c________________________________ left-to-right)))
 (let (($x4524 (and $x4523 $x4522)))
 (let (($x4555 (ite $x4524 $x4538 (ite $x4521 $x4538 (ite $x4519 $x4534 (ite $x4516 $x4535 (ite $x4514 $x4535 $x4538)))))))
 (let ((?x4362 (top ?x4144)))
 (let ((?x4501 (stack ?x4362 ?x4178)))
 (let (($x4530 (= ?x4316 ?x4501)))
 (let (($x4525 (= c________________________________ left-to-center)))
 (let (($x4526 (and $x4525 $x4522)))
 (ite $x4526 $x4530 $x4555)))))))))))))))))))))))))))))))
(assert
 (let ((?x4364 (center s________________________________)))
 (let ((?x4502 (center s_________________________________)))
 (let (($x4540 (= ?x4502 ?x4364)))
 (let ((?x4178 (right s________________________________)))
 (let ((?x4509 (top ?x4178)))
 (let ((?x4511 (stack ?x4509 ?x4364)))
 (let (($x4537 (= ?x4502 ?x4511)))
 (let (($x4512 ((_ is stack ) ?x4178)))
 (let (($x4513 (= c________________________________ right-to-center)))
 (let (($x4514 (and $x4513 $x4512)))
 (let (($x4515 (= c________________________________ right-to-left)))
 (let (($x4516 (and $x4515 $x4512)))
 (let ((?x4504 (rest ?x4364)))
 (let (($x4532 (= ?x4502 ?x4504)))
 (let (($x4517 ((_ is stack ) ?x4364)))
 (let (($x4518 (= c________________________________ center-to-right)))
 (let (($x4519 (and $x4518 $x4517)))
 (let (($x4520 (= c________________________________ center-to-left)))
 ...
 (let ((?x4144 (left s________________________________)))
 (let ((?x4362 (top ?x4144)))
 (let ((?x4503 (stack ?x4362 ?x4364)))
 (let (($x4531 (= ?x4502 ?x4503)))
 (let (($x4522 ((_ is stack ) ?x4144)))
 (let (($x4523 (= c________________________________ left-to-right)))
 (let (($x4524 (and $x4523 $x4522)))
 (let (($x4554 (ite $x4524 $x4531 (ite $x4521 $x4532 (ite $x4519 $x4532 (ite $x4516 $x4540 (ite $x4514 $x4537 $x4540)))))))
 (let (($x4525 (= c________________________________ left-to-center)))
 (let (($x4526 (and $x4525 $x4522)))
 (ite $x4526 $x4540 $x4554)))))))))))))))))))))))))))))))
(assert
 (= c__________________________________ c!33))
(assert
 (let ((?x4282 (left s_________________________________)))
 (let ((?x4420 (left s__________________________________)))
 (let (($x4680 (= ?x4420 ?x4282)))
 (let ((?x4316 (right s_________________________________)))
 (let ((?x4647 (top ?x4316)))
 (let ((?x4648 (stack ?x4647 ?x4282)))
 (let (($x4674 (= ?x4420 ?x4648)))
 (let (($x4650 ((_ is stack ) ?x4316)))
 (let (($x4653 (= c_________________________________ right-to-left)))
 (let (($x4654 (and $x4653 $x4650)))
 (let ((?x4502 (center s_________________________________)))
 (let (($x4655 ((_ is stack ) ?x4502)))
 (let (($x4656 (= c_________________________________ center-to-right)))
 (let (($x4657 (and $x4656 $x4655)))
 (let ((?x4643 (top ?x4502)))
 (let ((?x4644 (stack ?x4643 ?x4282)))
 (let (($x4671 (= ?x4420 ?x4644)))
 (let (($x4658 (= c_________________________________ center-to-left)))
 (let (($x4659 (and $x4658 $x4655)))
 (let ((?x4453 (rest ?x4282)))
 (let (($x4667 (= ?x4420 ?x4453)))
 (let (($x4660 ((_ is stack ) ?x4282)))
 (let (($x4661 (= c_________________________________ left-to-right)))
 (let (($x4662 (and $x4661 $x4660)))
 (let (($x4663 (= c_________________________________ left-to-center)))
 (let (($x4664 (and $x4663 $x4660)))
 (ite $x4664 $x4667 (ite $x4662 $x4667 (ite $x4659 $x4671 (ite $x4657 $x4680 (ite $x4654 $x4674 $x4680))))))))))))))))))))))))))))))))
(assert
 (let ((?x4316 (right s_________________________________)))
 (let ((?x4454 (right s__________________________________)))
 (let (($x4676 (= ?x4454 ?x4316)))
 (let ((?x4646 (rest ?x4316)))
 (let (($x4673 (= ?x4454 ?x4646)))
 (let (($x4650 ((_ is stack ) ?x4316)))
 (let (($x4651 (= c_________________________________ right-to-center)))
 (let (($x4652 (and $x4651 $x4650)))
 (let (($x4653 (= c_________________________________ right-to-left)))
 (let (($x4654 (and $x4653 $x4650)))
 (let ((?x4502 (center s_________________________________)))
 (let ((?x4643 (top ?x4502)))
 (let ((?x4645 (stack ?x4643 ?x4316)))
 (let (($x4672 (= ?x4454 ?x4645)))
 (let (($x4655 ((_ is stack ) ?x4502)))
 (let (($x4656 (= c_________________________________ center-to-right)))
 (let (($x4657 (and $x4656 $x4655)))
 (let (($x4658 (= c_________________________________ center-to-left)))
 ...
 (let (($x4661 (= c_________________________________ left-to-right)))
 (let (($x4662 (and $x4661 $x4660)))
 (let (($x4693 (ite $x4662 $x4676 (ite $x4659 $x4676 (ite $x4657 $x4672 (ite $x4654 $x4673 (ite $x4652 $x4673 $x4676)))))))
 (let ((?x4500 (top ?x4282)))
 (let ((?x4639 (stack ?x4500 ?x4316)))
 (let (($x4668 (= ?x4454 ?x4639)))
 (let (($x4663 (= c_________________________________ left-to-center)))
 (let (($x4664 (and $x4663 $x4660)))
 (ite $x4664 $x4668 $x4693)))))))))))))))))))))))))))))))
(assert
 (let ((?x4502 (center s_________________________________)))
 (let ((?x4640 (center s__________________________________)))
 (let (($x4678 (= ?x4640 ?x4502)))
 (let ((?x4316 (right s_________________________________)))
 (let ((?x4647 (top ?x4316)))
 (let ((?x4649 (stack ?x4647 ?x4502)))
 (let (($x4675 (= ?x4640 ?x4649)))
 (let (($x4650 ((_ is stack ) ?x4316)))
 (let (($x4651 (= c_________________________________ right-to-center)))
 (let (($x4652 (and $x4651 $x4650)))
 (let (($x4653 (= c_________________________________ right-to-left)))
 (let (($x4654 (and $x4653 $x4650)))
 (let ((?x4642 (rest ?x4502)))
 (let (($x4670 (= ?x4640 ?x4642)))
 (let (($x4655 ((_ is stack ) ?x4502)))
 (let (($x4656 (= c_________________________________ center-to-right)))
 (let (($x4657 (and $x4656 $x4655)))
 (let (($x4658 (= c_________________________________ center-to-left)))
 ...
 (let ((?x4282 (left s_________________________________)))
 (let ((?x4500 (top ?x4282)))
 (let ((?x4641 (stack ?x4500 ?x4502)))
 (let (($x4669 (= ?x4640 ?x4641)))
 (let (($x4660 ((_ is stack ) ?x4282)))
 (let (($x4661 (= c_________________________________ left-to-right)))
 (let (($x4662 (and $x4661 $x4660)))
 (let (($x4692 (ite $x4662 $x4669 (ite $x4659 $x4670 (ite $x4657 $x4670 (ite $x4654 $x4678 (ite $x4652 $x4675 $x4678)))))))
 (let (($x4663 (= c_________________________________ left-to-center)))
 (let (($x4664 (and $x4663 $x4660)))
 (ite $x4664 $x4678 $x4692)))))))))))))))))))))))))))))))
(assert
 (= c___________________________________ c!34))
(assert
 (let ((?x4420 (left s__________________________________)))
 (let ((?x4558 (left s___________________________________)))
 (let (($x4818 (= ?x4558 ?x4420)))
 (let ((?x4454 (right s__________________________________)))
 (let ((?x4785 (top ?x4454)))
 (let ((?x4786 (stack ?x4785 ?x4420)))
 (let (($x4812 (= ?x4558 ?x4786)))
 (let (($x4788 ((_ is stack ) ?x4454)))
 (let (($x4791 (= c__________________________________ right-to-left)))
 (let (($x4792 (and $x4791 $x4788)))
 (let ((?x4640 (center s__________________________________)))
 (let (($x4793 ((_ is stack ) ?x4640)))
 (let (($x4794 (= c__________________________________ center-to-right)))
 (let (($x4795 (and $x4794 $x4793)))
 (let ((?x4781 (top ?x4640)))
 (let ((?x4782 (stack ?x4781 ?x4420)))
 (let (($x4809 (= ?x4558 ?x4782)))
 (let (($x4796 (= c__________________________________ center-to-left)))
 (let (($x4797 (and $x4796 $x4793)))
 (let ((?x4591 (rest ?x4420)))
 (let (($x4805 (= ?x4558 ?x4591)))
 (let (($x4798 ((_ is stack ) ?x4420)))
 (let (($x4799 (= c__________________________________ left-to-right)))
 (let (($x4800 (and $x4799 $x4798)))
 (let (($x4801 (= c__________________________________ left-to-center)))
 (let (($x4802 (and $x4801 $x4798)))
 (ite $x4802 $x4805 (ite $x4800 $x4805 (ite $x4797 $x4809 (ite $x4795 $x4818 (ite $x4792 $x4812 $x4818))))))))))))))))))))))))))))))))
(assert
 (let ((?x4454 (right s__________________________________)))
 (let ((?x4592 (right s___________________________________)))
 (let (($x4814 (= ?x4592 ?x4454)))
 (let ((?x4784 (rest ?x4454)))
 (let (($x4811 (= ?x4592 ?x4784)))
 (let (($x4788 ((_ is stack ) ?x4454)))
 (let (($x4789 (= c__________________________________ right-to-center)))
 (let (($x4790 (and $x4789 $x4788)))
 (let (($x4791 (= c__________________________________ right-to-left)))
 (let (($x4792 (and $x4791 $x4788)))
 (let ((?x4640 (center s__________________________________)))
 (let ((?x4781 (top ?x4640)))
 (let ((?x4783 (stack ?x4781 ?x4454)))
 (let (($x4810 (= ?x4592 ?x4783)))
 (let (($x4793 ((_ is stack ) ?x4640)))
 (let (($x4794 (= c__________________________________ center-to-right)))
 (let (($x4795 (and $x4794 $x4793)))
 (let (($x4796 (= c__________________________________ center-to-left)))
 ...
 (let (($x4799 (= c__________________________________ left-to-right)))
 (let (($x4800 (and $x4799 $x4798)))
 (let (($x4831 (ite $x4800 $x4814 (ite $x4797 $x4814 (ite $x4795 $x4810 (ite $x4792 $x4811 (ite $x4790 $x4811 $x4814)))))))
 (let ((?x4638 (top ?x4420)))
 (let ((?x4777 (stack ?x4638 ?x4454)))
 (let (($x4806 (= ?x4592 ?x4777)))
 (let (($x4801 (= c__________________________________ left-to-center)))
 (let (($x4802 (and $x4801 $x4798)))
 (ite $x4802 $x4806 $x4831)))))))))))))))))))))))))))))))
(assert
 (let ((?x4640 (center s__________________________________)))
 (let ((?x4778 (center s___________________________________)))
 (let (($x4816 (= ?x4778 ?x4640)))
 (let ((?x4454 (right s__________________________________)))
 (let ((?x4785 (top ?x4454)))
 (let ((?x4787 (stack ?x4785 ?x4640)))
 (let (($x4813 (= ?x4778 ?x4787)))
 (let (($x4788 ((_ is stack ) ?x4454)))
 (let (($x4789 (= c__________________________________ right-to-center)))
 (let (($x4790 (and $x4789 $x4788)))
 (let (($x4791 (= c__________________________________ right-to-left)))
 (let (($x4792 (and $x4791 $x4788)))
 (let ((?x4780 (rest ?x4640)))
 (let (($x4808 (= ?x4778 ?x4780)))
 (let (($x4793 ((_ is stack ) ?x4640)))
 (let (($x4794 (= c__________________________________ center-to-right)))
 (let (($x4795 (and $x4794 $x4793)))
 (let (($x4796 (= c__________________________________ center-to-left)))
 ...
 (let ((?x4420 (left s__________________________________)))
 (let ((?x4638 (top ?x4420)))
 (let ((?x4779 (stack ?x4638 ?x4640)))
 (let (($x4807 (= ?x4778 ?x4779)))
 (let (($x4798 ((_ is stack ) ?x4420)))
 (let (($x4799 (= c__________________________________ left-to-right)))
 (let (($x4800 (and $x4799 $x4798)))
 (let (($x4830 (ite $x4800 $x4807 (ite $x4797 $x4808 (ite $x4795 $x4808 (ite $x4792 $x4816 (ite $x4790 $x4813 $x4816)))))))
 (let (($x4801 (= c__________________________________ left-to-center)))
 (let (($x4802 (and $x4801 $x4798)))
 (ite $x4802 $x4816 $x4830)))))))))))))))))))))))))))))))
(assert
 ...
 (let ((?x4558 (left s___________________________________)))
 (let (($x4866 (= ?x4558 ?x68)))
 (let (($x4868 (not (and $x4866 $x4865 $x4834))))
 (not $x4868))))))))))))))
(check-sat)
