...
(assert
 (let ((?x2334 (left s___________________)))
 (let ((?x2472 (left s____________________)))
 (let (($x2732 (= ?x2472 ?x2334)))
 (let ((?x2368 (right s___________________)))
 (let ((?x2699 (top ?x2368)))
 (let ((?x2700 (stack ?x2699 ?x2334)))
 (let (($x2726 (= ?x2472 ?x2700)))
 (let (($x2702 ((_ is stack ) ?x2368)))
 (let (($x2705 (= c___________________ right-to-left)))
 (let (($x2706 (and $x2705 $x2702)))
 (let ((?x2554 (center s___________________)))
 (let (($x2707 ((_ is stack ) ?x2554)))
 (let (($x2708 (= c___________________ center-to-right)))
 (let (($x2709 (and $x2708 $x2707)))
 (let ((?x2695 (top ?x2554)))
 (let ((?x2696 (stack ?x2695 ?x2334)))
 (let (($x2723 (= ?x2472 ?x2696)))
 (let (($x2710 (= c___________________ center-to-left)))
 (let (($x2711 (and $x2710 $x2707)))
 (let ((?x2505 (rest ?x2334)))
 (let (($x2719 (= ?x2472 ?x2505)))
 (let (($x2712 ((_ is stack ) ?x2334)))
 (let (($x2713 (= c___________________ left-to-right)))
 (let (($x2714 (and $x2713 $x2712)))
 (let (($x2715 (= c___________________ left-to-center)))
 (let (($x2716 (and $x2715 $x2712)))
 (ite $x2716 $x2719 (ite $x2714 $x2719 (ite $x2711 $x2723 (ite $x2709 $x2732 (ite $x2706 $x2726 $x2732))))))))))))))))))))))))))))))))
(assert
 (let ((?x2368 (right s___________________)))
 (let ((?x2506 (right s____________________)))
 (let (($x2728 (= ?x2506 ?x2368)))
 (let ((?x2698 (rest ?x2368)))
 (let (($x2725 (= ?x2506 ?x2698)))
 (let (($x2702 ((_ is stack ) ?x2368)))
 (let (($x2703 (= c___________________ right-to-center)))
 (let (($x2704 (and $x2703 $x2702)))
 (let (($x2705 (= c___________________ right-to-left)))
 (let (($x2706 (and $x2705 $x2702)))
 (let ((?x2554 (center s___________________)))
 (let ((?x2695 (top ?x2554)))
 (let ((?x2697 (stack ?x2695 ?x2368)))
 (let (($x2724 (= ?x2506 ?x2697)))
 (let (($x2707 ((_ is stack ) ?x2554)))
 (let (($x2708 (= c___________________ center-to-right)))
 (let (($x2709 (and $x2708 $x2707)))
 (let (($x2710 (= c___________________ center-to-left)))
 ...
 (let (($x2713 (= c___________________ left-to-right)))
 (let (($x2714 (and $x2713 $x2712)))
 (let (($x2745 (ite $x2714 $x2728 (ite $x2711 $x2728 (ite $x2709 $x2724 (ite $x2706 $x2725 (ite $x2704 $x2725 $x2728)))))))
 (let ((?x2552 (top ?x2334)))
 (let ((?x2691 (stack ?x2552 ?x2368)))
 (let (($x2720 (= ?x2506 ?x2691)))
 (let (($x2715 (= c___________________ left-to-center)))
 (let (($x2716 (and $x2715 $x2712)))
 (ite $x2716 $x2720 $x2745)))))))))))))))))))))))))))))))
(assert
 (let ((?x2554 (center s___________________)))
 (let ((?x2692 (center s____________________)))
 (let (($x2730 (= ?x2692 ?x2554)))
 (let ((?x2368 (right s___________________)))
 (let ((?x2699 (top ?x2368)))
 (let ((?x2701 (stack ?x2699 ?x2554)))
 (let (($x2727 (= ?x2692 ?x2701)))
 (let (($x2702 ((_ is stack ) ?x2368)))
 (let (($x2703 (= c___________________ right-to-center)))
 (let (($x2704 (and $x2703 $x2702)))
 (let (($x2705 (= c___________________ right-to-left)))
 (let (($x2706 (and $x2705 $x2702)))
 (let ((?x2694 (rest ?x2554)))
 (let (($x2722 (= ?x2692 ?x2694)))
 (let (($x2707 ((_ is stack ) ?x2554)))
 (let (($x2708 (= c___________________ center-to-right)))
 (let (($x2709 (and $x2708 $x2707)))
 (let (($x2710 (= c___________________ center-to-left)))
 ...
 (let ((?x2334 (left s___________________)))
 (let ((?x2552 (top ?x2334)))
 (let ((?x2693 (stack ?x2552 ?x2554)))
 (let (($x2721 (= ?x2692 ?x2693)))
 (let (($x2712 ((_ is stack ) ?x2334)))
 (let (($x2713 (= c___________________ left-to-right)))
 (let (($x2714 (and $x2713 $x2712)))
 (let (($x2744 (ite $x2714 $x2721 (ite $x2711 $x2722 (ite $x2709 $x2722 (ite $x2706 $x2730 (ite $x2704 $x2727 $x2730)))))))
 (let (($x2715 (= c___________________ left-to-center)))
 (let (($x2716 (and $x2715 $x2712)))
 (ite $x2716 $x2730 $x2744)))))))))))))))))))))))))))))))
(assert
 (= c_____________________ c!20))
(assert
 (let ((?x2472 (left s____________________)))
 (let ((?x2610 (left s_____________________)))
 (let (($x2870 (= ?x2610 ?x2472)))
 (let ((?x2506 (right s____________________)))
 (let ((?x2837 (top ?x2506)))
 (let ((?x2838 (stack ?x2837 ?x2472)))
 (let (($x2864 (= ?x2610 ?x2838)))
 (let (($x2840 ((_ is stack ) ?x2506)))
 (let (($x2843 (= c____________________ right-to-left)))
 (let (($x2844 (and $x2843 $x2840)))
 (let ((?x2692 (center s____________________)))
 (let (($x2845 ((_ is stack ) ?x2692)))
 (let (($x2846 (= c____________________ center-to-right)))
 (let (($x2847 (and $x2846 $x2845)))
 (let ((?x2833 (top ?x2692)))
 (let ((?x2834 (stack ?x2833 ?x2472)))
 (let (($x2861 (= ?x2610 ?x2834)))
 (let (($x2848 (= c____________________ center-to-left)))
 (let (($x2849 (and $x2848 $x2845)))
 (let ((?x2643 (rest ?x2472)))
 (let (($x2857 (= ?x2610 ?x2643)))
 (let (($x2850 ((_ is stack ) ?x2472)))
 (let (($x2851 (= c____________________ left-to-right)))
 (let (($x2852 (and $x2851 $x2850)))
 (let (($x2853 (= c____________________ left-to-center)))
 (let (($x2854 (and $x2853 $x2850)))
 (ite $x2854 $x2857 (ite $x2852 $x2857 (ite $x2849 $x2861 (ite $x2847 $x2870 (ite $x2844 $x2864 $x2870))))))))))))))))))))))))))))))))
(assert
 (let ((?x2506 (right s____________________)))
 (let ((?x2644 (right s_____________________)))
 (let (($x2866 (= ?x2644 ?x2506)))
 (let ((?x2836 (rest ?x2506)))
 (let (($x2863 (= ?x2644 ?x2836)))
 (let (($x2840 ((_ is stack ) ?x2506)))
 (let (($x2841 (= c____________________ right-to-center)))
 (let (($x2842 (and $x2841 $x2840)))
 (let (($x2843 (= c____________________ right-to-left)))
 (let (($x2844 (and $x2843 $x2840)))
 (let ((?x2692 (center s____________________)))
 (let ((?x2833 (top ?x2692)))
 (let ((?x2835 (stack ?x2833 ?x2506)))
 (let (($x2862 (= ?x2644 ?x2835)))
 (let (($x2845 ((_ is stack ) ?x2692)))
 (let (($x2846 (= c____________________ center-to-right)))
 (let (($x2847 (and $x2846 $x2845)))
 (let (($x2848 (= c____________________ center-to-left)))
 ...
 (let (($x2851 (= c____________________ left-to-right)))
 (let (($x2852 (and $x2851 $x2850)))
 (let (($x2883 (ite $x2852 $x2866 (ite $x2849 $x2866 (ite $x2847 $x2862 (ite $x2844 $x2863 (ite $x2842 $x2863 $x2866)))))))
 (let ((?x2690 (top ?x2472)))
 (let ((?x2829 (stack ?x2690 ?x2506)))
 (let (($x2858 (= ?x2644 ?x2829)))
 (let (($x2853 (= c____________________ left-to-center)))
 (let (($x2854 (and $x2853 $x2850)))
 (ite $x2854 $x2858 $x2883)))))))))))))))))))))))))))))))
(assert
 (let ((?x2692 (center s____________________)))
 (let ((?x2830 (center s_____________________)))
 (let (($x2868 (= ?x2830 ?x2692)))
 (let ((?x2506 (right s____________________)))
 (let ((?x2837 (top ?x2506)))
 (let ((?x2839 (stack ?x2837 ?x2692)))
 (let (($x2865 (= ?x2830 ?x2839)))
 (let (($x2840 ((_ is stack ) ?x2506)))
 (let (($x2841 (= c____________________ right-to-center)))
 (let (($x2842 (and $x2841 $x2840)))
 (let (($x2843 (= c____________________ right-to-left)))
 (let (($x2844 (and $x2843 $x2840)))
 (let ((?x2832 (rest ?x2692)))
 (let (($x2860 (= ?x2830 ?x2832)))
 (let (($x2845 ((_ is stack ) ?x2692)))
 (let (($x2846 (= c____________________ center-to-right)))
 (let (($x2847 (and $x2846 $x2845)))
 (let (($x2848 (= c____________________ center-to-left)))
 ...
 (let ((?x2472 (left s____________________)))
 (let ((?x2690 (top ?x2472)))
 (let ((?x2831 (stack ?x2690 ?x2692)))
 (let (($x2859 (= ?x2830 ?x2831)))
 (let (($x2850 ((_ is stack ) ?x2472)))
 (let (($x2851 (= c____________________ left-to-right)))
 (let (($x2852 (and $x2851 $x2850)))
 (let (($x2882 (ite $x2852 $x2859 (ite $x2849 $x2860 (ite $x2847 $x2860 (ite $x2844 $x2868 (ite $x2842 $x2865 $x2868)))))))
 (let (($x2853 (= c____________________ left-to-center)))
 (let (($x2854 (and $x2853 $x2850)))
 (ite $x2854 $x2868 $x2882)))))))))))))))))))))))))))))))
(assert
 ...
 (let ((?x2610 (left s_____________________)))
 (let (($x2918 (= ?x2610 ?x34)))
 (let (($x2920 (not (and $x2918 $x2917 $x2886))))
 (not $x2920)))))))))))))
(check-sat)
