...
(assert
 ...
 (let (($x329 (= ?x311 ?x104)))
 (let ((?x107 (right s_)))
 (let (($x293 ((_ is stack ) ?x107)))
 (let (($x314 (= c_ right-to-left)))
 (let (($x318 (and $x314 $x293)))
 (let ((?x109 (center s_)))
 (let (($x319 ((_ is stack ) ?x109)))
 (let (($x320 (= c_ center-to-right)))
 (let (($x297 (and $x320 $x319)))
 (let (($x298 (= c_ center-to-left)))
 (let (($x299 (and $x298 $x319)))
 (let (($x338 (ite $x299 (= ?x311 (stack (top ?x109) ?x104)) (ite $x297 $x329 (ite $x318 (= ?x311 (stack (top ?x107) ?x104)) $x329)))))
 (let (($x322 (= ?x311 (rest ?x104))))
 (let (($x282 ((_ is stack ) ?x104)))
 (let (($x283 (= c_ left-to-right)))
 (let (($x284 (and $x283 $x282)))
 (let (($x315 (= c_ left-to-center)))
 (let (($x316 (and $x315 $x282)))
 (ite $x316 $x322 (ite $x284 $x322 $x338)))))))))))))))))))))))
(assert
 (let ((?x107 (right s_)))
 (let ((?x295 (right s__)))
 (let (($x289 (= ?x295 ?x107)))
 (let (($x325 (= ?x295 (rest ?x107))))
 (let (($x293 ((_ is stack ) ?x107)))
 (let (($x312 (= c_ right-to-center)))
 (let (($x313 (and $x312 $x293)))
 (let (($x314 (= c_ right-to-left)))
 (let (($x318 (and $x314 $x293)))
 (let ((?x109 (center s_)))
 (let (($x319 ((_ is stack ) ?x109)))
 (let (($x320 (= c_ center-to-right)))
 (let (($x297 (and $x320 $x319)))
 (let (($x335 (ite $x297 (= ?x295 (stack (top ?x109) ?x107)) (ite $x318 $x325 (ite $x313 $x325 $x289)))))
 (let (($x298 (= c_ center-to-left)))
 (let (($x299 (and $x298 $x319)))
 (let ((?x104 (left s_)))
 (let (($x282 ((_ is stack ) ?x104)))
 ...
 (let (($x315 (= c_ left-to-center)))
 (let (($x316 (and $x315 $x282)))
 (ite $x316 (= ?x295 (stack (top ?x104) ?x107)) (ite $x284 $x289 (ite $x299 $x289 $x335))))))))))))))))))))))))))
(assert
 (let ((?x109 (center s_)))
 (let ((?x286 (center s__)))
 (let (($x327 (= ?x286 ?x109)))
 ...
 (let (($x314 (= c_ right-to-left)))
 (let (($x318 (and $x314 $x293)))
 (let (($x304 (= ?x286 (rest ?x109))))
 (let (($x319 ((_ is stack ) ?x109)))
 (let (($x320 (= c_ center-to-right)))
 (let (($x297 (and $x320 $x319)))
 (let (($x334 (ite $x297 $x304 (ite $x318 $x327 (ite $x313 (= ?x286 (stack (top ?x107) ?x109)) $x327)))))
 (let (($x298 (= c_ center-to-left)))
 (let (($x299 (and $x298 $x319)))
 (let ((?x104 (left s_)))
 (let (($x282 ((_ is stack ) ?x104)))
 ...
 (let (($x315 (= c_ left-to-center)))
 (let (($x316 (and $x315 $x282)))
 (ite $x316 $x327 (ite $x284 (= ?x286 (stack (top ?x104) ?x109)) (ite $x299 $x304 $x334))))))))))))))))))))))))))
(assert
 (= c___ c!2))
(assert
 (let ((?x311 (left s__)))
 ...
 (let ((?x295 (right s__)))
 (let ((?x425 (top ?x295)))
 (let ((?x426 (stack ?x425 ?x311)))
 (let (($x452 (= ?x174 ?x426)))
 (let (($x428 ((_ is stack ) ?x295)))
...
(assert
 (let ((?x76 (stack N (stack J (stack H (stack G (stack E (stack B empty))))))))
 (let ((?x80 (stack V (stack U (stack Q (stack O ?x76))))))
 (let ((?x3544 (right s___________________________)))
 (let (($x3786 (= ?x3544 ?x80)))
 (let ((?x68 (stack S (stack K (stack D (stack C (stack I (stack A empty))))))))
 (let ((?x70 (stack F (stack R ?x68))))
 (let ((?x3730 (center s___________________________)))
 (let (($x3817 (= ?x3730 ?x70)))
 (let ((?x62 (stack L (stack T (stack W (stack P (stack M empty)))))))
 (let ((?x3510 (left s___________________________)))
 (let (($x3818 (= ?x3510 ?x62)))
 (let (($x3820 (not (and $x3818 $x3817 $x3786))))
 (not $x3820))))))))))))))
(check-sat)
