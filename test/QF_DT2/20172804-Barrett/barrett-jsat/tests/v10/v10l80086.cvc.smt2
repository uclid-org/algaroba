...
(assert (and (and (and (and (and (and (and (not (is-leaf x23)) (not (= x14 x11))) (= (children x23) x17)) (not (= x8 x10))) (not ((_ is cons) x15))) (not ((_ is node) (car (cdr (cdr (cdr x19))))))) (= (children x24) x19)) (not (is-leaf x27))))
(check-sat)
(exit)
