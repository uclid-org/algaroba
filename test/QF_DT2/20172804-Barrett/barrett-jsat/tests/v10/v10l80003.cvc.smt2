...
(assert (and (and (and (and (and (and (and (not (= null (cdr x15))) (not (= x6 x3))) (= (leaf x2) x24)) ((_ is node) x29)) ((_ is null) x15)) (not (= x2 x4))) ((_ is null) x15)) ((_ is zero) (data (car (children x27))))))
(check-sat)
(exit)
