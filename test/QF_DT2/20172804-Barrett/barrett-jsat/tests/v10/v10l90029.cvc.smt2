...
(assert (and (and (and (and (and (and (and (and ((_ is succ) (pred x2)) (not (= x16 x20))) ((_ is zero) x3)) (not (= (leaf x9) x27))) (= x1 x1)) (not (= x27 x29))) (not (= (node x20) x24))) (not ((_ is zero) x9))) ((_ is zero) x9)))
(check-sat)
(exit)
