...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x4)) ((_ is cons) x17)) (= x1 x4)) (not ((_ is node) (leaf (pred (succ (data x21))))))) (not (= x19 x13))) (not (= x19 x15))) ((_ is cons) x15)) ((_ is zero) x1)))
(check-sat)
(exit)
