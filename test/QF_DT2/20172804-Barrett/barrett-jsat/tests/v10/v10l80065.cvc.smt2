...
(assert (and (and (and (and (and (and (and (not (= x2 x1)) (= x27 (node x11))) (not (= x4 x7))) (not ((_ is null) (children x22)))) ((_ is null) (cdr x11))) (not ((_ is cons) x11))) (not (= (succ x3) x9))) (not (= x19 x18))))
(check-sat)
(exit)
