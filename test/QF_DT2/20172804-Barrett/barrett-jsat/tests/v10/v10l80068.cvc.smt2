...
(assert (and (and (and (and (and (and (and (not (= x9 zero)) (not ((_ is zero) x2))) (= x11 x20)) (= x28 x26)) (not ((_ is succ) (data x29)))) (= (cons x29 x17) x15)) (not ((_ is succ) (pred x5)))) (not ((_ is succ) x3))))
(check-sat)
(exit)
