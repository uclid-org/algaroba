...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x21)) (not (= x10 x4))) (= x7 zero)) (= x12 (children x28))) (= x21 x25)) (= x14 null)) (not (is-leaf (node x13)))) (not (= x15 x20))) ((_ is null) x20)))
(check-sat)
(exit)
