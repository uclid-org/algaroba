...
(assert (and (and (and (and (and (and (and (not ((_ is node) (car (cdr x14)))) (= x13 x17)) ((_ is node) x30)) (not ((_ is cons) x18))) (not (= (node (cdr x12)) x27))) (= (car null) x27)) (= x21 x28)) (= x22 x24)))
(check-sat)
(exit)
