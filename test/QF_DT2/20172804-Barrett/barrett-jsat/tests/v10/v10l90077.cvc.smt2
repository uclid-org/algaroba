...
(assert (and (and (and (and (and (and (and (and (= x9 x7) ((_ is null) x13)) (not (= x29 (car (children (node x16)))))) (is-leaf x26)) (= x26 x27)) (not ((_ is succ) x6))) ((_ is succ) (pred (pred zero)))) (= (succ (pred (pred (succ x6)))) x8)) ((_ is node) x22)))
(check-sat)
(exit)
