...
(assert (and (and (and (and (and (and (and (and (not ((_ is cons) null)) ((_ is succ) x8)) (not ((_ is node) x29))) (= x28 x23)) (not (is-leaf x29))) (not (is-leaf x26))) (= x30 x30)) (is-leaf x25)) (not (= x21 x22))))
(check-sat)
(exit)
