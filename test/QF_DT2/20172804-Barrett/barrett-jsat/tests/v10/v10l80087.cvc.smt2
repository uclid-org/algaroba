...
(assert (and (and (and (and (and (and (and (= (node x12) x29) (not (= x25 x27))) (is-leaf x25)) (not ((_ is node) x26))) (not ((_ is node) x25))) (is-leaf x28)) (not ((_ is zero) x7))) (not (= x21 (leaf (succ (data (car x15))))))))
(check-sat)
(exit)
