...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x26)) (not (= zero x3))) (= x6 x6)) (not ((_ is cons) x20))) (not (= (children x30) x18))) (= x26 (node x14))) (not ((_ is node) x24))) ((_ is node) x27)) ((_ is node) (car x17))))
(check-sat)
(exit)
