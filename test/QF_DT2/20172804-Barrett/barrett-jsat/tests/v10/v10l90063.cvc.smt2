...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x2) (is-leaf x24)) ((_ is node) x29)) ((_ is node) x30)) (not (is-leaf x22))) ((_ is succ) (succ x2))) (not (= (succ x1) x1))) (= x28 x29)) (not ((_ is null) x11))))
(check-sat)
(exit)
