...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x5)) (= x21 (car x15))) (not (= x3 x1))) ((_ is null) x14)) (not (= x26 x25))) ((_ is null) x15)) (= x17 (cons x26 x14))) (not (is-leaf x26))) (not (= x17 (cdr x11)))))
(check-sat)
(exit)
