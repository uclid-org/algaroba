...
(assert (and (and (and (and (and (and (and (is-leaf x22) ((_ is cons) (children x25))) (= x20 x14)) (= (cons (car null) null) (cdr x15))) ((_ is zero) x3)) (not ((_ is node) x30))) ((_ is succ) (pred zero))) (not (= x20 (cons x29 x20)))))
(check-sat)
(exit)
