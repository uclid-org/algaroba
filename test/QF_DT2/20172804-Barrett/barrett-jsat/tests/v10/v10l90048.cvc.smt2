...
(assert (and (and (and (and (and (and (and (and (= x8 (pred x7)) (= x28 x26)) (= x10 x7)) (not (= x22 x21))) (not (is-leaf (node x12)))) ((_ is cons) x11)) (not ((_ is node) x25))) (not (= x19 x15))) ((_ is node) x26)))
(check-sat)
(exit)
