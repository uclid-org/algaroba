...
(assert (and (and (and (and (and (and (= (pred (succ (succ x6))) x7) (not (is-leaf x24))) (not (is-leaf (leaf x4)))) (not ((_ is cons) (children x21)))) (= zero x3)) ((_ is succ) x2)) (not (= x16 (cons x22 x16)))))
(check-sat)
(exit)
