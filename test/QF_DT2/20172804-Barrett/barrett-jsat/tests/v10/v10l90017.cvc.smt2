...
(assert (and (and (and (and (and (and (and (and (not (= x22 x26)) (= x1 x4)) (not (= (car x19) x23))) (not (= (cdr x20) x13))) ((_ is node) (leaf (data x23)))) (not ((_ is cons) null))) (is-leaf x24)) (not (= x28 x23))) (= (leaf x2) x30)))
(check-sat)
(exit)
