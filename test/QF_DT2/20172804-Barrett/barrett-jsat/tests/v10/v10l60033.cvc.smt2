...
(assert (and (and (and (and (and (not (= x30 (leaf x10))) (not ((_ is zero) x8))) ((_ is cons) (cons (car x14) (children x26)))) (= x27 (node (cons x22 (cdr x12))))) ((_ is cons) (cdr null))) (= null x20)))
(check-sat)
(exit)
