...
(assert (and (and (and (and (and (and (not ((_ is node) (car (children x24)))) ((_ is zero) x8)) (not ((_ is zero) x4))) ((_ is null) x17)) (= (succ (pred x10)) x6)) (not ((_ is node) x21))) (= x2 (data x24))))
(check-sat)
(exit)
