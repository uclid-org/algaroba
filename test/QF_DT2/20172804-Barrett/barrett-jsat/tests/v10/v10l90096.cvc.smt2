...
(assert (and (and (and (and (and (and (and (and (not (= (cons x23 null) (children x24))) (not (= (cons x27 (cons x29 (children (car x12)))) x11))) (not (= x11 x17))) (not (= zero x2))) ((_ is cons) x16)) (= x16 x12)) ((_ is zero) (succ x4))) (= (cons (leaf x5) x16) x13)) (not (= x25 x29))))
(check-sat)
(exit)
