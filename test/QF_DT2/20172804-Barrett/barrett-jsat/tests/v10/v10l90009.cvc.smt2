...
(assert (and (and (and (and (and (and (and (and (not (= x11 x16)) ((_ is node) (leaf x2))) (= x7 (pred zero))) (not ((_ is null) x12))) (not (is-leaf x30))) (not ((_ is succ) x10))) (not ((_ is succ) (pred x10)))) (not (= x22 x27))) (not (= x19 null))))
(check-sat)
(exit)
