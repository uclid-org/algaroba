...
(assert (and (and (and (and (and (and (and (and (= (succ x8) (data x23)) (is-leaf (car x11))) ((_ is succ) x1)) (= x1 x10)) (not (is-leaf x22))) (= x14 x18)) ((_ is succ) x7)) (not ((_ is succ) x8))) (= x1 (data x22))))
(check-sat)
(exit)
