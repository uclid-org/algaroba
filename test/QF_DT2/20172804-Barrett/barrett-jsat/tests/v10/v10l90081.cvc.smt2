...
(assert (and (and (and (and (and (and (and (and (not (= x23 x24)) (not ((_ is null) x14))) (not ((_ is cons) (children (leaf x1))))) ((_ is cons) x20)) (is-leaf x26)) (not ((_ is succ) x7))) (not (= x17 x12))) (not ((_ is succ) x4))) ((_ is node) (car (cons x27 x19)))))
(check-sat)
(exit)
