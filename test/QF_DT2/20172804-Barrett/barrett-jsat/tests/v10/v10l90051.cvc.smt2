...
(assert (and (and (and (and (and (and (and (and (= x22 x22) (= x16 x12)) ((_ is succ) x7)) (not (= (data x29) x10))) (not (is-leaf (leaf x1)))) (not ((_ is cons) (cdr x16)))) ((_ is null) x16)) ((_ is succ) x5)) (not (= x13 (cons (car x18) x11)))))
(check-sat)
(exit)
