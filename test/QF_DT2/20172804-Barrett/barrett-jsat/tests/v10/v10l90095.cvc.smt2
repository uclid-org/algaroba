...
(assert (and (and (and (and (and (and (and (and (not (= x6 x5)) (not (= x21 (node x19)))) (not ((_ is node) x21))) (not (= x5 x4))) ((_ is zero) x8)) ((_ is cons) (cons x28 x17))) (not (= x20 x12))) (not (= x29 x25))) (not ((_ is succ) x3))))
(check-sat)
(exit)
