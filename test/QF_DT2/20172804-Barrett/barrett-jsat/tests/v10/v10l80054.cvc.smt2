...
(assert (and (and (and (and (and (and (and ((_ is node) (leaf x8)) ((_ is cons) x16)) (not ((_ is succ) x5))) (not (= (car (cdr x12)) x24))) ((_ is succ) x6)) ((_ is null) x15)) (= x25 x26)) (not ((_ is null) (children x25)))))
(check-sat)
(exit)
