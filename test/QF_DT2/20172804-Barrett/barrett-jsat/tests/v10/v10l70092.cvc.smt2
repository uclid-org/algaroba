...
(assert (and (and (and (and (and (and (not ((_ is cons) (cdr x13))) (not (= x9 (succ x1)))) (not (= x18 x18))) (not ((_ is cons) x20))) (is-leaf (node x15))) (not (= x29 (leaf x6)))) ((_ is null) (children (leaf x5)))))
(check-sat)
(exit)
