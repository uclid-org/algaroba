...
(assert (and (and (and (and (and (and (and (and (is-leaf (node x18)) (not ((_ is zero) (pred x4)))) (is-leaf x29)) (not (= zero x7))) (not (= x11 x13))) (= (leaf zero) (leaf (data x30)))) (= x3 x3)) (not ((_ is cons) (children x27)))) (not ((_ is node) (leaf x10)))))
(check-sat)
(exit)
