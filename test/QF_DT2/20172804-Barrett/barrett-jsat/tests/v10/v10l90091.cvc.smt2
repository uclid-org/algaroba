...
(assert (and (and (and (and (and (and (and (and ((_ is node) x29) (not ((_ is null) x15))) (not (= (succ x8) zero))) ((_ is null) x20)) (not (= (data x28) x2))) ((_ is succ) x8)) ((_ is succ) x7)) (not ((_ is cons) x14))) (not ((_ is cons) x11))))
(check-sat)
(exit)
