...
(assert (and (and (and (and (and (and (and (and (not (= (car x19) x25)) ((_ is null) x15)) (not ((_ is node) x28))) (= x14 x12)) (not (= x28 x30))) ((_ is node) x22)) ((_ is null) x11)) (not ((_ is cons) x12))) (= (succ (data x26)) x7)))
(check-sat)
(exit)
