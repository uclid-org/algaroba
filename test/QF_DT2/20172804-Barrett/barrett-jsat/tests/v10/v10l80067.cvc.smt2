...
(assert (and (and (and (and (and (and (and (not ((_ is succ) x1)) ((_ is node) x21)) (not ((_ is zero) (data x22)))) (not ((_ is zero) x5))) (not ((_ is succ) (pred (data x27))))) ((_ is zero) (succ x3))) (= x27 x25)) (not ((_ is zero) x5))))
(check-sat)
(exit)
