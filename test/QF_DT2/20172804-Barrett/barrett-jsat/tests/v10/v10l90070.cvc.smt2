...
(assert (and (and (and (and (and (and (and (and (not (= (car (cons x23 x11)) x22)) ((_ is null) x19)) (= x16 x19)) (= x11 x17)) (not ((_ is node) x30))) (= (car x17) x30)) (not (is-leaf x28))) (not (= x19 x14))) (not ((_ is null) x12))))
(check-sat)
(exit)
