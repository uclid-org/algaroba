...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x26)) (= x24 x22)) (= (pred zero) x3)) (not (= x7 x8))) (not (= x30 x24))) ((_ is null) x18)) ((_ is succ) (succ x4))) (not (= x8 x2))) (= (car x13) x24)))
(check-sat)
(exit)
