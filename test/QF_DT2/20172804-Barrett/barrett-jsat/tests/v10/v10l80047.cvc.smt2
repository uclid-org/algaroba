...
(assert (and (and (and (and (and (and (and (not (= x27 x23)) ((_ is zero) (succ (data x30)))) ((_ is null) x15)) (not ((_ is succ) x3))) (= x16 x11)) (= x22 x28)) (not ((_ is succ) x3))) (not ((_ is node) x25))))
(check-sat)
(exit)
