...
(assert (and (and (and (and (and (and (and (and (not ((_ is cons) x12)) ((_ is cons) x14)) (= null x13)) (not (= (car x19) (car x11)))) (is-leaf x21)) (not (= x21 x29))) (not (= x18 x20))) (not ((_ is null) (cdr x13)))) ((_ is succ) x3)))
(check-sat)
(exit)
