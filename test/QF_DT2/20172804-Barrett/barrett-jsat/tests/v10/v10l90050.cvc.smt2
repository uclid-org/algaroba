...
(assert (and (and (and (and (and (and (and (and ((_ is node) x29) (not (= x16 x14))) (not ((_ is zero) x3))) ((_ is cons) x17)) ((_ is null) (children x21))) ((_ is succ) x5)) (not (= x6 x2))) (not ((_ is succ) x2))) (not ((_ is node) x30))))
(check-sat)
(exit)
