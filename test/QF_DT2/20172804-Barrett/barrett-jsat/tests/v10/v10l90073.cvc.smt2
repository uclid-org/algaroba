...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x8)) (not ((_ is node) x25))) (= x25 x25)) (= x25 x29)) (= x6 x2)) ((_ is cons) x14)) (not (= x18 x12))) (not ((_ is cons) (cdr x11)))) ((_ is zero) (succ x10))))
(check-sat)
(exit)
