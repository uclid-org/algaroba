...
(assert (and (and (and (and (and (and (not (= (leaf x9) x22)) (is-leaf x24)) ((_ is succ) x6)) ((_ is null) (cons x22 x16))) ((_ is node) x24)) (not ((_ is cons) (children (car x15))))) (not ((_ is null) (cons x29 x14)))))
(check-sat)
(exit)
