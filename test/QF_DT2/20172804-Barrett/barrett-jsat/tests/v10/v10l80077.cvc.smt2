...
(assert (and (and (and (and (and (and (and (is-leaf (node x19)) (not (= x30 x22))) (not (is-leaf x26))) (= x8 x1)) (not ((_ is zero) x7))) (not ((_ is zero) (succ (data x30))))) (= x11 null)) (not (= x17 (cdr x19)))))
(check-sat)
(exit)
