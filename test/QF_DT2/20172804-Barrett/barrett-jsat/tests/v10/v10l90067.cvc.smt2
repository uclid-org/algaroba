...
(assert (and (and (and (and (and (and (and (and (not (= x26 x27)) (is-leaf x26)) (not ((_ is null) x12))) (not (= x14 null))) (not ((_ is succ) x9))) (not ((_ is node) x22))) (= x16 (children x26))) (not (= x6 zero))) ((_ is zero) x8)))
(check-sat)
(exit)
