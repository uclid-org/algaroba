...
(assert (and (and (and (and (and (and (and (and ((_ is null) x13) (not (= x2 zero))) (not ((_ is cons) x12))) ((_ is null) x11)) (not (= x23 x22))) ((_ is cons) x20)) (is-leaf x30)) (not (= x2 (data x30)))) (not (= x16 x19))))
(check-sat)
(exit)
