...
(assert (and (and (and (and (and (and (and (and (not (= x19 x12)) ((_ is null) x16)) (not (= (leaf x1) (car (cons (node x12) (children x23)))))) (not (= (cons x26 x16) x13))) ((_ is null) x16)) (= x16 x15)) (not ((_ is node) x21))) (not (= (leaf x5) x29))) (= x21 x29)))
(check-sat)
(exit)
