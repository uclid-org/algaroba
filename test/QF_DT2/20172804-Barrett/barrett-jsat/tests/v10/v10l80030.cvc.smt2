...
(assert (and (and (and (and (and (and (and (not (= null x19)) (= x14 x16)) (not ((_ is null) x18))) (not ((_ is cons) x14))) (is-leaf x23)) (= (cdr x17) null)) (not (= (cons (car x13) x12) (cdr x16)))) (not (= (data x25) zero))))
(check-sat)
(exit)
