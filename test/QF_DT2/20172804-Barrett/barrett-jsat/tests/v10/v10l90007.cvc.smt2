...
(assert (and (and (and (and (and (and (and (and (= x13 x18) (not (is-leaf (car x17)))) ((_ is succ) x9)) (= x3 x3)) (not (= x2 x3))) (not (= zero x4))) (not ((_ is zero) (data x24)))) (not (is-leaf (leaf x10)))) ((_ is zero) x8)))
(check-sat)
(exit)
