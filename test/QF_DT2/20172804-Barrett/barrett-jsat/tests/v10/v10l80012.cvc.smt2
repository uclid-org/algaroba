...
(assert (and (and (and (and (and (and (and (= x29 (node (cdr x18))) (not ((_ is null) x12))) (not ((_ is zero) x1))) (= x16 x20)) (= x10 x9)) ((_ is null) (children x25))) (not ((_ is null) (children x24)))) (not (= x11 x15))))
(check-sat)
(exit)
