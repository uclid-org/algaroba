...
(assert (and (and (and (and (and (and (and (and (not (= (cdr x18) x20)) (not (= x11 x20))) (not ((_ is succ) x1))) ((_ is zero) x1)) (= x13 x16)) (not (= zero x9))) ((_ is succ) x1)) (not ((_ is succ) (succ x3)))) (= x2 (succ x7))))
(check-sat)
(exit)
