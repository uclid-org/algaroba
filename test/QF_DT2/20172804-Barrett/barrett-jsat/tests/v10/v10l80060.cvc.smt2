...
(assert (and (and (and (and (and (and (and (not ((_ is succ) x5)) (= x16 x15)) (not ((_ is null) (cdr x18)))) (is-leaf x27)) (not ((_ is succ) x3))) (not (= x6 x6))) (not ((_ is cons) (children x24)))) (not ((_ is cons) (children (node x17))))))
(check-sat)
(exit)
