...
(assert (and (and (and (and (and (and (and (and ((_ is node) (node null)) (= x12 x20)) (= zero x4)) (not (= x20 null))) (not ((_ is zero) (succ x10)))) (not (= x10 x9))) ((_ is cons) x14)) ((_ is null) x17)) (not (is-leaf (leaf x6)))))
(check-sat)
(exit)
