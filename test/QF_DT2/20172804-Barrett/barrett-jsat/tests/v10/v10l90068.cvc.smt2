...
(assert (and (and (and (and (and (and (and (and (= null (cons (node (children (leaf (succ x6)))) x18)) ((_ is node) x30)) (not (= x4 x5))) (not (is-leaf x28))) (not (= zero x1))) (not ((_ is zero) x8))) (not ((_ is node) (car null)))) (not ((_ is zero) x8))) ((_ is succ) (data x25))))
(check-sat)
(exit)
