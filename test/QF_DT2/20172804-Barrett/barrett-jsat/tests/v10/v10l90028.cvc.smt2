...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x3) (not ((_ is null) x16))) (not (= x20 x15))) (= x8 (data (car x20)))) (not (= (node null) x21))) ((_ is zero) x2)) (= x24 x26)) (not (= x2 zero))) (not (= x5 x10))))
(check-sat)
(exit)
