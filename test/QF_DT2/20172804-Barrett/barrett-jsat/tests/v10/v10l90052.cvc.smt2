...
(assert (and (and (and (and (and (and (and (and (not ((_ is null) x12)) (= x15 x13)) ((_ is succ) x7)) ((_ is null) x13)) ((_ is succ) x1)) (not (= x14 x18))) (not ((_ is succ) x3))) ((_ is cons) x16)) (not (= x13 x16))))
(check-sat)
(exit)
