...
(assert (and (and (and (and (and (and (and (is-leaf (car x19)) (not (= x16 x19))) (not (= (children x22) null))) (not (= (cons x30 x15) x14))) (not (= x30 x23))) (= (leaf x10) x23)) (not (= x14 x17))) ((_ is null) (children (node x12)))))
(check-sat)
(exit)
