...
(assert (and (and (and (and (and (and (and (and (not (= x12 (cons (car x14) (children x21)))) (not (= x16 x14))) (= (pred (pred x9)) x5)) ((_ is zero) x5)) (not (= x25 x30))) (not (= x22 x24))) (not ((_ is null) (cdr (cons x28 x17))))) (not (= (children x29) (cdr x17)))) ((_ is zero) x9)))
(check-sat)
(exit)
