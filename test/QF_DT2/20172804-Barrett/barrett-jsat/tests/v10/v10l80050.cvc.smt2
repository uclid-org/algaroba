...
(assert (and (and (and (and (and (and (and (not (= (node x20) (node null))) (not (= x14 x15))) (not (= x8 x10))) (not ((_ is cons) x15))) (= x14 (cons x26 (cons x27 x20)))) (not ((_ is node) x29))) (= x5 x8)) (not (= x18 x11))))
(check-sat)
(exit)
