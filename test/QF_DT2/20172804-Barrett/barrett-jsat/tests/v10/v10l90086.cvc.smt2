...
(assert (and (and (and (and (and (and (and (and (= (succ (succ (data x24))) x3) (not ((_ is node) (node x14)))) ((_ is node) (node x20))) (not (= x2 (succ x2)))) (= x13 x11)) ((_ is cons) x11)) (not (= x7 x1))) (not (= (succ x1) (succ x8)))) (= x27 x27)))
(check-sat)
(exit)
