...
(assert (and (and (and (and (and (and (and (and (not (= x14 x17)) (not (= (leaf x4) x21))) ((_ is null) x16)) (not (is-leaf x28))) (not (= x24 x28))) (not ((_ is zero) x1))) (not (= (children x21) x20))) (not ((_ is succ) x3))) ((_ is null) (children (leaf x9)))))
(check-sat)
(exit)
