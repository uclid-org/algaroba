...
(assert (and (and (and (and (and (and (and (and (not ((_ is cons) x16)) (not (= x9 x3))) (not ((_ is node) x21))) (= (succ x9) x7)) (not (is-leaf (node x16)))) ((_ is zero) x10)) (not ((_ is zero) zero))) ((_ is node) (leaf x2))) (= x7 x5)))
(check-sat)
(exit)
