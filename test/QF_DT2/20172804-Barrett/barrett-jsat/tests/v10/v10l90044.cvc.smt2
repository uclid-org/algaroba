...
(assert (and (and (and (and (and (and (and (and ((_ is null) x17) (= (cons (node x20) (children x27)) x15)) (= x4 (succ (pred x4)))) ((_ is null) null)) (= x17 null)) (= x27 x29)) (is-leaf x28)) (not (= x26 x29))) (not (= x3 zero))))
(check-sat)
(exit)
