...
(assert (and (and (and (and (and (and (and ((_ is zero) x8) (= x27 x22)) (= (leaf x10) (node x17))) (= x17 x18)) (not (is-leaf (car x17)))) (= (leaf x5) x29)) ((_ is null) (children x23))) (not ((_ is succ) (data x21)))))
(check-sat)
(exit)
