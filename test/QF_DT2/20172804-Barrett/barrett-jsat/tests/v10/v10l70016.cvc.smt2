...
(assert (and (and (and (and (and (and (not (= x28 (leaf (data (node x18))))) (not (is-leaf x27))) (not (= x12 x16))) (not (= x11 (children x30)))) (not ((_ is succ) (data x25)))) ((_ is zero) x8)) ((_ is zero) (pred x2))))
(check-sat)
(exit)
