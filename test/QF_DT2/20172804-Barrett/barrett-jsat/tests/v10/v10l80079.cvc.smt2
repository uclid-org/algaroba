...
(assert (and (and (and (and (and (and (and (not (is-leaf x30)) (not ((_ is null) x17))) (not (= (car x12) (node x13)))) (= x24 (leaf (pred x9)))) ((_ is zero) x4)) (not ((_ is node) x22))) (not (= (node x12) x21))) (not (= x10 x2))))
(check-sat)
(exit)
