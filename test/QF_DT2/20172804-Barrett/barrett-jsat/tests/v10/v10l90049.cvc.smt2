...
(assert (and (and (and (and (and (and (and (and (not ((_ is cons) x12)) (not ((_ is null) x16))) (= x27 x27)) ((_ is succ) x9)) (not (= x19 (cons x28 x12)))) ((_ is node) x27)) (= (node x19) x28)) (not (= x19 x16))) (is-leaf x25)))
(check-sat)
(exit)
