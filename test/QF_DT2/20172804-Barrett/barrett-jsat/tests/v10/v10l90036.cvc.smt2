...
(assert (and (and (and (and (and (and (and (and (not (= x6 x7)) (is-leaf x21)) ((_ is cons) null)) (not (= x30 x21))) (is-leaf x21)) (= x24 x21)) ((_ is null) x13)) (not (= x4 x3))) (= x20 (cdr (cons x27 x16)))))
(check-sat)
(exit)
