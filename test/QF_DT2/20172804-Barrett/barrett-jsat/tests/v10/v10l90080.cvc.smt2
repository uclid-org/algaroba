...
(assert (and (and (and (and (and (and (and (and (= x18 x11) (not (= x20 (cdr x13)))) (is-leaf x29)) ((_ is node) x27)) ((_ is zero) (data x28))) ((_ is succ) x6)) ((_ is succ) x2)) (= (pred x2) x3)) (= (cdr (cons x23 x15)) x14)))
(check-sat)
(exit)
