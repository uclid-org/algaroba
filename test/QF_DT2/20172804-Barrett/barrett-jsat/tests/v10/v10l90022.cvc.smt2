...
(assert (and (and (and (and (and (and (and (and (not (is-leaf x28)) (not (= (cons (car x13) x20) (cons (leaf zero) x20)))) (= (cdr x17) x16)) (not ((_ is null) (cdr (cons x26 x20))))) (not ((_ is zero) x4))) (= x19 (children (leaf x5)))) (= (succ (data x29)) x8)) (not (= (cdr x20) x20))) (not ((_ is zero) x9))))
(check-sat)
(exit)
