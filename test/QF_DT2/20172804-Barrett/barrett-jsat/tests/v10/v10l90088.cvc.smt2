...
(assert (and (and (and (and (and (and (and (and (not (= (node null) x25)) (= (car x15) x22)) (not ((_ is node) x27))) (not ((_ is node) x27))) (= x2 zero)) ((_ is cons) x11)) (= x21 x21)) (not ((_ is node) x21))) (= x3 x8)))
(check-sat)
(exit)
