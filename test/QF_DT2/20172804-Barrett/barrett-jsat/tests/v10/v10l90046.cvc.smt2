...
(assert (and (and (and (and (and (and (and (and (not (is-leaf (node x13))) (not (= x10 x10))) (not (= (node x15) x28))) (= x8 x7)) ((_ is null) x12)) ((_ is null) (cons x21 x19))) (= x12 x11)) (not (= (cons (node null) x14) x16))) (= null x16)))
(check-sat)
(exit)
