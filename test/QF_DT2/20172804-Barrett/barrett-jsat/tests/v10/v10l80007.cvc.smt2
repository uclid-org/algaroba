...
(assert (and (and (and (and (and (and (and (not (= x10 x3)) ((_ is cons) null)) (not (= x11 (cdr x18)))) ((_ is succ) x9)) ((_ is succ) x3)) (not ((_ is node) x23))) ((_ is node) (node x20))) (not ((_ is node) x28))))
(check-sat)
(exit)
