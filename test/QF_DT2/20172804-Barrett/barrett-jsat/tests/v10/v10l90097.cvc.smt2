...
(assert (and (and (and (and (and (and (and (and (= x14 null) ((_ is node) x23)) (= x3 x10)) (not ((_ is zero) (data (leaf x3))))) (not ((_ is cons) x13))) (= x29 x24)) (= zero x10)) (not ((_ is zero) x1))) ((_ is null) x14)))
(check-sat)
(exit)
