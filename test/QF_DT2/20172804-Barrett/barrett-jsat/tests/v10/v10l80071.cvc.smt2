...
(assert (and (and (and (and (and (and (and (not ((_ is node) x30)) (not (= x14 x18))) ((_ is node) x23)) (not (is-leaf (leaf x1)))) (not (= (leaf (succ x6)) x25))) (not (is-leaf x29))) ((_ is node) x25)) (= (children x21) x13)))
(check-sat)
(exit)
