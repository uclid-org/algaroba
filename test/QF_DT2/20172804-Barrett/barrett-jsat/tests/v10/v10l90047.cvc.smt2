...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x2) (= x6 x7)) (= x18 (cdr (cons x28 null)))) (= x17 x18)) ((_ is null) x20)) (= (pred (pred x3)) x10)) (not (= x29 x25))) ((_ is node) x22)) (= x3 x5)))
(check-sat)
(exit)
