...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x6)) ((_ is zero) (pred x7))) ((_ is null) x13)) (not (= (cons x28 x13) x17))) (= x10 x8)) (not (= (children x25) x15))) (not ((_ is node) (car x20)))) ((_ is cons) x12)) (not (is-leaf x28))))
(check-sat)
(exit)
