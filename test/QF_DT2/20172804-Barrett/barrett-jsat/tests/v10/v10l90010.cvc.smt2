...
(assert (and (and (and (and (and (and (and (and (is-leaf x29) (= x2 x6)) (not (= null (cdr (cons (car x15) x20))))) ((_ is zero) x7)) (not ((_ is zero) x4))) (not ((_ is null) (children x24)))) (not (is-leaf (leaf zero)))) (not (= x12 x15))) (not (= x10 (data (leaf x4))))))
(check-sat)
(exit)
