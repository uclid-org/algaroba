...
(assert (and (and (and (and (and (and (and (= x21 (leaf x6)) (not ((_ is cons) x16))) ((_ is cons) x18)) (is-leaf x23)) (not (is-leaf x23))) (is-leaf x29)) (= x29 (node x20))) (not ((_ is node) (node x13)))))
(check-sat)
(exit)
