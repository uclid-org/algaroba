...
(assert (and (and (and (and (and (and (and (and (not (= x9 zero)) (not (= (succ x10) (data x28)))) (not ((_ is zero) x5))) ((_ is succ) x8)) (= x27 (leaf (succ x4)))) (= x4 x10)) ((_ is node) x25)) ((_ is cons) x18)) ((_ is cons) x18)))
(check-sat)
(exit)
