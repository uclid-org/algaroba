...
(assert (and (and (and (and (and (and (and (and (not (= (pred x3) x10)) (not ((_ is succ) x9))) (not (= (cdr x18) x16))) (= x3 zero)) (not (= (node x13) (car x13)))) (= x29 (node x18))) (not ((_ is node) x25))) ((_ is zero) x3)) (not (= x29 x23))))
(check-sat)
(exit)
