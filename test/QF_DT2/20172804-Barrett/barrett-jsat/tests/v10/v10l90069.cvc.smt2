...
(assert (and (and (and (and (and (and (and (and (not (= x3 x8)) (not (= x18 x19))) (not ((_ is node) x24))) (not (= x14 x13))) (= x10 (succ x9))) (not (is-leaf x26))) (not ((_ is succ) (pred x3)))) (= x8 zero)) (= (succ x8) x5)))
(check-sat)
(exit)
