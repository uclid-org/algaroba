...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x3)) (= x15 x14)) ((_ is succ) x7)) (not (= (data x30) x9))) (not ((_ is cons) (children (car x14))))) (not ((_ is node) (car x13)))) ((_ is zero) x6)) ((_ is node) x29)) ((_ is zero) x1)))
(check-sat)
(exit)
