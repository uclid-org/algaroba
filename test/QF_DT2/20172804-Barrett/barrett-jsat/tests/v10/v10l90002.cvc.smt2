...
(assert (and (and (and (and (and (and (and (and (not (= x30 x27)) (not (= x28 x22))) ((_ is succ) x4)) (not (is-leaf (leaf x4)))) (= (car (children x27)) x30)) (= x21 x25)) ((_ is succ) x5)) (= (node x16) x27)) (not (= x29 x22))))
(check-sat)
(exit)
