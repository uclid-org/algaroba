...
(assert (and (and (and (and (and (and (and (and (= x3 (succ zero)) (= (pred x9) zero)) (is-leaf x29)) (not (is-leaf (node x15)))) (not ((_ is null) (children x27)))) (= x8 x8)) ((_ is cons) x13)) (= x6 x7)) ((_ is zero) x6)))
(check-sat)
(exit)
