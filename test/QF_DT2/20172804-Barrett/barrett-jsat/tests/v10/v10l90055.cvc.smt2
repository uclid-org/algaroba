...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x25)) (not (= x5 x3))) (not (= (car (cons x28 x15)) x30))) (is-leaf x25)) (not (= x5 x6))) (= x6 x3)) (not (= x19 (children x27)))) (= x25 x24)) (= (car x14) x29)))
(check-sat)
(exit)
