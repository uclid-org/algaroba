...
(assert (and (and (and (and (and (and (and (not (= x29 x21)) (not ((_ is node) x22))) (not (= x10 x6))) (not ((_ is succ) zero))) (= (cons x25 x14) x16)) ((_ is node) x25)) (not (= x20 (cons x26 x13)))) (= x12 x13)))
(check-sat)
(exit)
