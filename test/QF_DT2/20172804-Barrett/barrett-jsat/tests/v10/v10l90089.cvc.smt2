...
(assert (and (and (and (and (and (and (and (and (not (= x24 x26)) (= x24 (car x17))) (not ((_ is succ) x4))) (not (= (leaf x6) x25))) (not ((_ is succ) x5))) (= x4 x10)) (= (cdr (cons x28 x14)) x13)) ((_ is null) x12)) (= x16 x14)))
(check-sat)
(exit)
