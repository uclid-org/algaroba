...
(assert (and (and (and (and (and (and (and (and (= x5 x1) (= x14 x18)) (not (= (leaf x10) x27))) (is-leaf (car x12))) (not ((_ is zero) x1))) (not ((_ is null) x16))) (not (= (succ zero) x5))) (not ((_ is null) (children x24)))) (= (succ x5) x6)))
(check-sat)
(exit)
