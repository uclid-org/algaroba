...
(assert (and (and (and (and (and (and (and (and ((_ is cons) x18) ((_ is null) x20)) (= (cdr (children x22)) x16)) (not ((_ is cons) null))) (= x29 x27)) ((_ is cons) x18)) (not (is-leaf x24))) (not ((_ is cons) x11))) (not ((_ is zero) x4))))
(check-sat)
(exit)
