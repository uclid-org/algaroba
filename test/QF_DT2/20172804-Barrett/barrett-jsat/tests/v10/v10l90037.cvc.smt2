...
(assert (and (and (and (and (and (and (and (and (not (= x30 x25)) (not (is-leaf (leaf x1)))) (= (children x29) x18)) (is-leaf x26)) (= x18 x20)) ((_ is node) x23)) (not ((_ is cons) x13))) (not (= x17 x14))) ((_ is succ) x6)))
(check-sat)
(exit)
