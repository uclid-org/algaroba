...
(assert (and (and (and (and (and (and (and ((_ is zero) x6) ((_ is node) x25)) ((_ is null) x13)) (= (node x15) x23)) (not (= zero x3))) (not ((_ is cons) x13))) (not (is-leaf x29))) (= x18 (children x22))))
(check-sat)
(exit)
