...
(assert (and (and (and (and (and (and (not (= (data x24) x10)) (not ((_ is null) x11))) (not ((_ is zero) x5))) (= (leaf x8) x24)) (not ((_ is node) (leaf zero)))) (= (pred x3) x2)) (not ((_ is cons) (children x27)))))
(check-sat)
(exit)
