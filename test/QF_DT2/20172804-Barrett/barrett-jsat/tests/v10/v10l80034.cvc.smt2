...
(assert (and (and (and (and (and (and (and (not ((_ is null) (children (node x15)))) (not (= x26 x26))) ((_ is succ) x10)) (not (= (node (cons (car x11) x17)) x21))) (not ((_ is succ) x4))) (not (= x25 x21))) (= x3 x7)) ((_ is node) x23)))
(check-sat)
(exit)
