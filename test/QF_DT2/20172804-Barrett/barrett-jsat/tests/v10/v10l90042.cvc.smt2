...
(assert (and (and (and (and (and (and (and (and ((_ is null) x14) ((_ is succ) x3)) (not ((_ is null) x20))) ((_ is null) x16)) (not (= (children x22) x20))) (not ((_ is null) x19))) (is-leaf (car x20))) (not ((_ is null) x12))) (= x18 x16)))
(check-sat)
(exit)
