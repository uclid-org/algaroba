...
(assert (and (and (and (and (and (and (and (and ((_ is node) x29) (not (is-leaf (leaf x3)))) (not (= x7 x6))) ((_ is node) x24)) ((_ is zero) (pred x4))) (not ((_ is succ) zero))) (= x11 x17)) ((_ is zero) x1)) ((_ is null) x20)))
(check-sat)
(exit)
