...
(assert (and (and (and (and (and (and (and (= x5 (data x27)) (not ((_ is node) (node x12)))) (not ((_ is node) (node x20)))) (= (node x14) x22)) (not ((_ is cons) x13))) (= zero x7)) (not (= x5 x5))) (= x7 (data x30))))
(check-sat)
(exit)
