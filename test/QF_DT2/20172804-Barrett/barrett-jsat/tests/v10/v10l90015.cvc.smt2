...
(assert (and (and (and (and (and (and (and (and (not (= x24 x24)) (not (= x26 x27))) ((_ is null) x12)) (not (= (pred (pred (data (node x16)))) x9))) (not (= x9 (data x22)))) (not ((_ is null) x16))) (not ((_ is node) x27))) (= (pred x1) (succ x3))) (not ((_ is succ) x8))))
(check-sat)
(exit)
