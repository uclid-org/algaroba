...
(assert (and (and (and (and (and (and (and (and (not (= x13 x20)) (not (is-leaf x29))) (not ((_ is zero) x3))) (not ((_ is node) (car x15)))) (not ((_ is null) x17))) (= x26 x23)) (not (= (node x16) x21))) ((_ is succ) (pred (data x27)))) (not (= x17 x14))))
(check-sat)
(exit)
