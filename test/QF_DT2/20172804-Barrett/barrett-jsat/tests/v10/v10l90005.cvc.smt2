...
(assert (and (and (and (and (and (and (and (and (= (node x11) x23) ((_ is zero) x9)) (= x21 x21)) (not (= (succ (succ x9)) x10))) (not ((_ is zero) (pred x6)))) (not (= x19 x12))) ((_ is null) (cons x22 null))) (= x7 (succ x3))) ((_ is succ) x2)))
(check-sat)
(exit)
