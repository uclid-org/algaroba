...
(assert (and (and (and (and (and (and (and (= x29 (leaf x6)) (not ((_ is cons) x17))) ((_ is cons) (cdr x15))) (= (cons x22 x11) x20)) (not ((_ is null) x16))) (not ((_ is zero) (data x22)))) ((_ is node) x24)) (not (is-leaf (leaf x3)))))
(check-sat)
(exit)
