...
(assert (and (and (and (and (and (not (= x9 (pred x7))) (not (= (node (cons x24 x15)) x25))) (not ((_ is zero) zero))) (not ((_ is zero) (data (car (cons x27 (children x21))))))) (= x12 (cons x21 x12))) (not (= (pred (data x22)) (pred (pred x7))))))
(check-sat)
(exit)
