...
(assert (and (and (and (and (and (and (and (not ((_ is node) x22)) (not (is-leaf (car x17)))) (= (node x17) x29)) (= x13 x11)) (is-leaf x28)) (not ((_ is node) (node x20)))) (= (pred x4) (data (car x11)))) (not (= x21 (node (cdr x14))))))
(check-sat)
(exit)
