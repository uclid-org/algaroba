...
(assert (and (and (and (and (and (and (and (and (= (pred zero) zero) ((_ is cons) x17)) (= (children (node (children x28))) (cons x25 x16))) ((_ is zero) x4)) (is-leaf x26)) (not (= (pred x6) x2))) (is-leaf (node (children x27)))) (not (= x10 x2))) (= x30 x22)))
(check-sat)
(exit)
