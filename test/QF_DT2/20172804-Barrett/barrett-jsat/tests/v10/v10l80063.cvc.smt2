...
(assert (and (and (and (and (and (and (and (not ((_ is succ) zero)) (not ((_ is zero) x9))) (= x26 x26)) (not (= x13 x18))) (= (leaf x8) x23)) (= null (cdr (children x22)))) ((_ is zero) x9)) (not (is-leaf x24))))
(check-sat)
(exit)
