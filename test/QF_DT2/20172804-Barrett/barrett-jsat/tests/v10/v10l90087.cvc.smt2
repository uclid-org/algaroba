...
(assert (and (and (and (and (and (and (and (and (not (= x20 (children x24))) (= x7 zero)) (not (= x6 x5))) ((_ is cons) x19)) (= (children (leaf x3)) x17)) ((_ is null) x13)) (not (= (cons x30 x12) x14))) (not ((_ is cons) x14))) (not ((_ is succ) x1))))
(check-sat)
(exit)
