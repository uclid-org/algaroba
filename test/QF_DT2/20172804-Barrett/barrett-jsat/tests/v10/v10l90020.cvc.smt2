...
(assert (and (and (and (and (and (and (and (and (not (= (pred x3) x5)) (= (node x13) x28)) (= zero zero)) (not (= x23 x30))) (= (children x29) x20)) (= x30 (car x12))) ((_ is cons) null)) (= x13 (cons (leaf x8) (cons x22 x13)))) (= (cdr x18) x20)))
(check-sat)
(exit)
