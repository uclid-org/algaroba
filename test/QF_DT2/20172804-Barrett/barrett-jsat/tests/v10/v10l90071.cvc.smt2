...
(assert (and (and (and (and (and (and (and (and (= x10 (succ (data x28))) (not (= zero x1))) (= (cdr (cdr x14)) x17)) (= x12 x11)) ((_ is succ) (pred x5))) ((_ is zero) x8)) ((_ is node) x29)) (not (= (cons (node x15) x15) x17))) (not (= x2 (data x23)))))
(check-sat)
(exit)
