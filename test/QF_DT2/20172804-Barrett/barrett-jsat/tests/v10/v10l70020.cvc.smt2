...
(assert (and (and (and (and (and (and (= x16 x19) ((_ is zero) x2)) (not (= (cdr (children x25)) x11))) (not ((_ is cons) x18))) (not (= x14 x12))) (= (leaf (succ zero)) (car (children x23)))) (not (= x17 (cons x27 (children x27))))))
(check-sat)
(exit)
