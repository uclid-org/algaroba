...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x2) ((_ is zero) x6)) (not (= x11 x15))) ((_ is cons) null)) (not ((_ is succ) x8))) (not (= x11 null))) (not ((_ is null) (children (leaf x5))))) (not (= x1 x7))) (= x17 x15)))
(check-sat)
(exit)
