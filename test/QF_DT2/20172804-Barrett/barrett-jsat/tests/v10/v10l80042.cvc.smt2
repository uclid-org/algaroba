...
(assert (and (and (and (and (and (and (and (= x15 x20) ((_ is null) (cons x24 x19))) ((_ is null) x13)) (not ((_ is cons) x14))) (= (pred (pred x6)) zero)) ((_ is zero) x10)) (not (= x21 (node x13)))) (not ((_ is succ) x3))))
(check-sat)
(exit)
