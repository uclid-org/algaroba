...
(assert (and (and (and (and (and (and (and (not (is-leaf (node null))) ((_ is succ) x9)) (not ((_ is zero) x2))) ((_ is null) x20)) (not (= x12 null))) (= (cons (car x18) x19) x17)) (not ((_ is zero) x5))) (= x4 (succ x8))))
(check-sat)
(exit)
