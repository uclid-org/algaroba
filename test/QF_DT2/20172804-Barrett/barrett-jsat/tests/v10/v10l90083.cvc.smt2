...
(assert (and (and (and (and (and (and (and (and (not ((_ is cons) null)) (not (= (leaf x9) x29))) ((_ is cons) x15)) (is-leaf x23)) (not (is-leaf x25))) ((_ is cons) x15)) ((_ is node) x21)) (= x3 x7)) (not ((_ is succ) (pred x5)))))
(check-sat)
(exit)
