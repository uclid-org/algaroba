...
(assert (and (and (and (and (and (and (and (= null (children x28)) (not (is-leaf x28))) (not ((_ is node) (leaf (pred x2))))) ((_ is succ) x5)) (not (= x7 (pred x8)))) (= (pred x7) (data (leaf x3)))) (not (= x12 x18))) ((_ is null) x18)))
(check-sat)
(exit)
