...
(assert (and (and (and (and (and (and (and (and (= x21 x24) ((_ is cons) (children x27))) (= x26 x25)) (not (is-leaf x22))) (not (= x9 (succ x8)))) (= x3 (pred x6))) ((_ is null) x13)) (= x29 x28)) (not ((_ is null) x12))))
(check-sat)
(exit)
