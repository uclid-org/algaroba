...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x6) (= x27 x30)) (not (is-leaf x25))) (not (= (cons x29 x14) x12))) (not (= x26 x25))) ((_ is node) (node x11))) (not ((_ is succ) x7))) (not (= x6 x6))) (not ((_ is cons) x11))))
(check-sat)
(exit)
