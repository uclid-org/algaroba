...
(assert (and (and (and (and (and (and (and ((_ is node) x30) (= x14 (cons (node x12) x19))) (not ((_ is zero) x1))) ((_ is zero) x4)) ((_ is null) x11)) ((_ is succ) x3)) (not ((_ is node) x24))) ((_ is succ) x5)))
(check-sat)
(exit)
