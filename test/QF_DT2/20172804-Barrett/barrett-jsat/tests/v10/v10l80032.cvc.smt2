...
(assert (and (and (and (and (and (and (and (is-leaf x26) (not (= x10 x6))) (not (= x4 x9))) ((_ is cons) (cdr x13))) (not ((_ is node) (car x19)))) (not ((_ is node) x28))) (not ((_ is node) x29))) (not ((_ is succ) x3))))
(check-sat)
(exit)
