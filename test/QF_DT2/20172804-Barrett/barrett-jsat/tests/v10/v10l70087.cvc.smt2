...
(assert (and (and (and (and (and (and (not ((_ is cons) x18)) (not (= (cdr x18) x12))) (not ((_ is cons) null))) (not ((_ is succ) x9))) (not ((_ is succ) (data x30)))) ((_ is zero) x7)) (not ((_ is zero) x3))))
(check-sat)
(exit)
