...
(assert (and (and (and (and (and (and (and (and (= x11 x19) (is-leaf (car (cons x29 x18)))) (not ((_ is null) (children x28)))) (not ((_ is cons) (cons x27 (cdr x11))))) ((_ is zero) x5)) (not ((_ is node) (node x18)))) (not (= (children x29) (children x22)))) (not (= x30 x26))) (= x19 x20)))
(check-sat)
(exit)
