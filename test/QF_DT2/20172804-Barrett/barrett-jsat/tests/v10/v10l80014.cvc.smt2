...
(assert (and (and (and (and (and (and (and (not (= x10 (succ x5))) (= (cons (leaf x7) x15) x18)) (= x23 x29)) (not (= x16 (cons x27 x19)))) (not (= x4 (succ (pred x4))))) (not (= x28 x30))) (not (= x30 x26))) ((_ is succ) (pred x9))))
(check-sat)
(exit)
