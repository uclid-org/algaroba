...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x7) (= x8 (succ x7))) (= (succ x5) (succ x10))) (= x4 zero)) (= x3 (pred (data x25)))) (not ((_ is succ) x5))) ((_ is node) x22)) (= x28 (leaf (pred x2)))) (not (= x14 null))))
(check-sat)
(exit)
