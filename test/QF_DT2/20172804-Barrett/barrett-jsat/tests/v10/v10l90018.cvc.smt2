...
(assert (and (and (and (and (and (and (and (and (is-leaf (node x11)) (= (node x18) (leaf x3))) (not (is-leaf x22))) (= x13 x12)) (= (cons x25 x11) x17)) (not (= (data x30) x4))) ((_ is null) x17)) (= x1 x1)) (not (= x19 (cons x22 x12)))))
(check-sat)
(exit)
