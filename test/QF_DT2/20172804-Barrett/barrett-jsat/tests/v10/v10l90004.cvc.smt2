...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x25)) ((_ is null) x15)) (not ((_ is succ) x1))) (not ((_ is cons) x13))) (= x28 (node x15))) ((_ is cons) (children (car x12)))) (= x18 x20)) (not (= null null))) (not (= x5 x4))))
(check-sat)
(exit)
