...
(assert (and (and (and (and (and (and (and (not (= x9 x6)) (not ((_ is node) (leaf (pred zero))))) (not (= (leaf x9) (leaf x4)))) (not ((_ is succ) zero))) (not ((_ is null) x14))) (not ((_ is cons) x18))) (not (= x5 x8))) ((_ is null) (cdr x19))))
(check-sat)
(exit)
