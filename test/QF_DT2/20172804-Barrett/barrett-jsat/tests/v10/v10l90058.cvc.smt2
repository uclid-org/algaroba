...
(assert (and (and (and (and (and (and (and (and (not (= x21 (node (cons x26 null)))) (= x8 x7)) ((_ is cons) (cons x21 null))) (= x13 x15)) (not (= x27 (leaf x5)))) ((_ is cons) x16)) (= x14 x20)) (not ((_ is zero) x5))) (not (= x13 x15))))
(check-sat)
(exit)
