...
(assert (and (and (and (and (and (and (and (not (= x19 null)) (not (= (pred (pred (pred (pred x4)))) x6))) (not (= x27 x23))) (not (= x23 (node x17)))) (not ((_ is succ) x7))) (not (is-leaf x23))) (is-leaf x28)) (= x24 x23)))
(check-sat)
(exit)
