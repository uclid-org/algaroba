...
(assert (and (and (and (and (and (and (and (not (= x10 x9)) (not (is-leaf (leaf x9)))) ((_ is zero) (succ x3))) ((_ is succ) (pred x9))) (not ((_ is null) x11))) (not ((_ is null) x11))) ((_ is null) (cdr x19))) (= x30 x29)))
(check-sat)
(exit)
