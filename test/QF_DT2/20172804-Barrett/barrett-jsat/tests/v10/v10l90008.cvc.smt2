...
(assert (and (and (and (and (and (and (and (and ((_ is node) x29) (not (= x8 x7))) ((_ is zero) zero)) (= (car (children x21)) x27)) (not ((_ is zero) x10))) (= x7 zero)) (= x28 x29)) ((_ is cons) x14)) (not (= x30 x26))))
(check-sat)
(exit)
