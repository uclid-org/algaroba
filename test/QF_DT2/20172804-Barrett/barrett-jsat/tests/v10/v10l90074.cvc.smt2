...
(assert (and (and (and (and (and (and (and (and (= (cdr x19) x20) (not (= (car (cons x26 x20)) x30))) ((_ is zero) zero)) (not (is-leaf x24))) (not (= (children x27) x20))) (not (= x9 zero))) (= (leaf x2) x30)) (not (= x28 x30))) (= x13 x12)))
(check-sat)
(exit)
