...
(assert (and (and (and (and (and (and (and (and (= x19 x15) ((_ is cons) x14)) (= (children x30) x13)) (= (data x28) x9)) ((_ is succ) x3)) (not ((_ is cons) (cons x23 x11)))) (not ((_ is null) (cdr x14)))) (not ((_ is node) x26))) (not ((_ is null) x16))))
(check-sat)
(exit)
