...
(assert (and (and (and (and (and (and (and (and (not (= x13 (children x21))) (not ((_ is succ) (succ x10)))) (= x13 x19)) (not ((_ is cons) (children x29)))) (not (= x4 x6))) (= (cons x22 (cdr x17)) (cdr x13))) ((_ is node) x21)) (not (= (car (children x30)) x27))) ((_ is cons) x20)))
(check-sat)
(exit)
