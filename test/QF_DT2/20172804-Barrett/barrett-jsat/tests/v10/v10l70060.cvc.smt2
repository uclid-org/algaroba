...
(assert (and (and (and (and (and (and (= x15 x11) ((_ is succ) x10)) (not ((_ is succ) (pred x10)))) (not ((_ is cons) (children (leaf (succ x3)))))) ((_ is null) x16)) (not ((_ is null) x13))) (= (data x26) x9)))
(check-sat)
(exit)
