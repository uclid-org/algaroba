...
(assert (and (and (and (and (and (and (and (not (= (children x25) (children x24))) (not (is-leaf x25))) (= x21 (leaf x9))) (not (= x28 (node x13)))) (not (= x19 x14))) (not ((_ is cons) null))) (not ((_ is zero) zero))) (not (= x28 x25))))
(check-sat)
(exit)
