...
(assert (and (and (and (and (and (and (and ((_ is cons) x18) (not (= zero (succ x4)))) (not (= (cons (node (cdr x19)) (children x25)) (cons x21 null)))) (= x21 x29)) ((_ is null) x16)) (not ((_ is node) x21))) (not (= x12 x12))) ((_ is node) (leaf x3))))
(check-sat)
(exit)
