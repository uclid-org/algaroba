...
(assert (and (and (and (and (and (and (and (not ((_ is null) x19)) ((_ is zero) zero)) (not ((_ is zero) x8))) (not (= x19 x19))) (not ((_ is cons) (children (node x19))))) (not (= x13 x11))) (= (car x14) (node x16))) (not ((_ is null) x12))))
(check-sat)
(exit)
