...
(assert (and (and (and (and (and (and (and (and (not (= x1 (pred x3))) ((_ is null) x16)) (not (is-leaf x27))) ((_ is null) x20)) (not (= x29 x23))) (= x12 x18)) (not (is-leaf x29))) (not (= (leaf x3) x29))) (= (node x17) x23)))
(check-sat)
(exit)
