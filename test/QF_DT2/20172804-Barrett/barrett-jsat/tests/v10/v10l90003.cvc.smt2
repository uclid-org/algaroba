...
(assert (and (and (and (and (and (and (and (and ((_ is zero) (data x21)) ((_ is cons) (cdr x19))) (not ((_ is zero) x7))) (= (data x28) x4)) (not (= (children x23) (cdr x15)))) ((_ is cons) (cdr x14))) (not ((_ is succ) x5))) (not ((_ is cons) null))) ((_ is cons) x12)))
(check-sat)
(exit)
