...
(assert (and (and (and (and (and (and (and (and ((_ is cons) x18) ((_ is cons) (cons x27 x14))) (not ((_ is zero) x7))) (not ((_ is zero) x3))) (not (= x15 x20))) (= (data x25) x5)) (= x21 x30)) (= x4 x8)) (not ((_ is null) (cdr x19)))))
(check-sat)
(exit)
