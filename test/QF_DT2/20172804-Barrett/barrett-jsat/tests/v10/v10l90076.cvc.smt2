...
(assert (and (and (and (and (and (and (and (and (= (leaf x1) x24) (not ((_ is zero) zero))) (= x27 x23)) (not ((_ is cons) x20))) ((_ is cons) x18)) (= x28 x23)) (is-leaf (node x12))) (= x24 x26)) (= (pred x5) x9)))
(check-sat)
(exit)
