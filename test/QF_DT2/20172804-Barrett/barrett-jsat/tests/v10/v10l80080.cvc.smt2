...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x3)) ((_ is zero) (data (leaf zero)))) (= x25 x27)) ((_ is succ) zero)) (= (children x25) x11)) (= x22 (leaf (data x21)))) (not (= x2 (succ x10)))) (not (= x26 (node x19)))))
(check-sat)
(exit)
