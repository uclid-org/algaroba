...
(assert (and (and (and (and (and (and (and (not (= x24 x26)) ((_ is null) x16)) ((_ is cons) x16)) (= x13 x12)) (is-leaf (leaf x2))) ((_ is zero) (data x29))) (not ((_ is zero) x6))) (not (is-leaf (car x15)))))
(check-sat)
(exit)
