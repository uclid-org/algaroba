...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x8)) (not (= (car x20) (leaf (succ (succ x3)))))) ((_ is zero) x5)) ((_ is null) null)) (= x7 x3)) ((_ is cons) null)) (= (car x15) x27)) ((_ is succ) x8)))
(check-sat)
(exit)
