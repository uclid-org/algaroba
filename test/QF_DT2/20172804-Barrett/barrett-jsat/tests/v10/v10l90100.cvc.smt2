...
(assert (and (and (and (and (and (and (and (and (= x24 (node (cons x26 x15))) (not (= null x13))) (not (= (cons x25 x18) x12))) ((_ is succ) x4)) (not (= x7 x8))) (not (= x27 (node x19)))) ((_ is null) (cdr (cons x25 (cdr (cdr x12)))))) (not ((_ is node) x30))) (not (is-leaf (leaf x5)))))
(check-sat)
(exit)
