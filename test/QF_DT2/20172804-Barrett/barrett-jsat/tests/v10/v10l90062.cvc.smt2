...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x5)) (not ((_ is null) x18))) (= x11 x16)) (= x18 null)) (not (= (car x17) x30))) ((_ is succ) x1)) (not ((_ is cons) x16))) (not (= x25 x28))) (not (= x22 x24))))
(check-sat)
(exit)
