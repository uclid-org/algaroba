...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x4) (= x23 (node (cons x25 (cdr x17))))) (not ((_ is node) x22))) ((_ is zero) x1)) (not (= x30 x24))) ((_ is succ) x2)) (= x7 (pred x6))) (= (cdr (cdr x17)) (children x30))) (not (= x29 (car x11)))))
(check-sat)
(exit)
