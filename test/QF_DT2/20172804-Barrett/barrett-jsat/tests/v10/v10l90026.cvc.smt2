...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x2)) (not ((_ is succ) x5))) (not (= (car x16) x24))) ((_ is cons) x16)) (= x14 x17)) (not (= x19 x15))) ((_ is node) x29)) (= x25 x30)) (= (leaf x8) x25)))
(check-sat)
(exit)
