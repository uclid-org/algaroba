...
(assert (and (and (and (and (and (and (and (= (succ x4) x7) (not ((_ is cons) x18))) (not ((_ is cons) x19))) (not ((_ is succ) zero))) (= (cons x24 x18) x14)) (= x28 x24)) ((_ is null) (cdr x16))) (not (= x11 x18))))
(check-sat)
(exit)
