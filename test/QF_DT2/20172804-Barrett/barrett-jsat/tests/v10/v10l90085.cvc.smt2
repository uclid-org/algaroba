...
(assert (and (and (and (and (and (and (and (and (= (node (cdr x18)) x25) (= x27 x25)) (= x28 x25)) (not (= (pred x10) x7))) (= x23 x30)) (= (node (children (car x20))) x26)) (not ((_ is cons) x20))) (= x13 x20)) (not (= (cdr (cdr x15)) x14))))
(check-sat)
(exit)
