...
(assert (and (and (and (and (and (and (and (not (= x13 x12)) (not (= x16 null))) (= (car null) x29)) (not (= x28 x21))) ((_ is null) (cons x23 x13))) (not ((_ is succ) x2))) (is-leaf x23)) (not ((_ is node) (node x17)))))
(check-sat)
(exit)
