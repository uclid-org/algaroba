...
(assert (and (and (and (and (and (and (and (= x11 x16) ((_ is succ) x1)) (= (succ (data x28)) x1)) (not (= x20 null))) (not ((_ is node) (node null)))) (= x2 (pred x10))) ((_ is succ) x4)) (not (is-leaf x24))))
(check-sat)
(exit)
