...
(assert (and (and (and (and (and (and (and ((_ is node) x23) (not (= x13 (cdr (children x23))))) (not (is-leaf (node x16)))) (not (= x9 x8))) ((_ is node) x23)) (is-leaf x27)) (not ((_ is node) x30))) (= x13 x11)))
(check-sat)
(exit)
