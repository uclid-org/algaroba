...
(assert (and (and (and (and (and (and (and (and (not (= x29 x24)) ((_ is zero) x10)) (not (= x10 x9))) (not (= x2 x7))) (not ((_ is null) x16))) (not (= zero x8))) (not ((_ is cons) x11))) ((_ is cons) x15)) (not (= null x15))))
(check-sat)
(exit)
