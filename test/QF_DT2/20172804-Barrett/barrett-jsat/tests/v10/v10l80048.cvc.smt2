...
(assert (and (and (and (and (and (and (and (not ((_ is succ) x8)) (not ((_ is null) (children x29)))) (not ((_ is null) null))) ((_ is null) null)) (not (= (children (node x20)) x15))) (is-leaf x23)) (not ((_ is zero) zero))) (not ((_ is zero) x6))))
(check-sat)
(exit)
