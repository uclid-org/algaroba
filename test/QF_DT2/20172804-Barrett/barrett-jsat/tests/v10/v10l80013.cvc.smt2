...
(assert (and (and (and (and (and (and (and (not (= x3 zero)) (not (= x18 (children x26)))) (not (= x29 x30))) ((_ is succ) x5)) (not (is-leaf x27))) (= x28 (node x18))) (not ((_ is cons) null))) ((_ is succ) x9)))
(check-sat)
(exit)
