...
(assert (and (and (and (and (and (and (and (and (not (= x24 x24)) ((_ is node) (leaf (pred (pred x9))))) (not ((_ is succ) zero))) ((_ is succ) (pred x5))) ((_ is zero) x3)) ((_ is succ) x1)) (not (= (leaf zero) (car (children x30))))) ((_ is cons) x19)) (not (= x23 x26))))
(check-sat)
(exit)
