...
(assert (and (and (and (and (and (not ((_ is zero) x7)) (not (is-leaf x23))) ((_ is cons) x14)) (not ((_ is null) (cons x26 (cons (node (cons x29 (cdr x11))) x11))))) (not (= x22 x28))) ((_ is succ) x3)))
(check-sat)
(exit)
