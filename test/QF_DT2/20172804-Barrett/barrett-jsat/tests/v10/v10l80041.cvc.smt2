...
(assert (and (and (and (and (and (and (and (not (= (node x13) (car x18))) (not ((_ is succ) x3))) (not ((_ is node) x21))) ((_ is zero) (data x22))) (= x13 (children x28))) (not (= x19 x19))) (= x9 zero)) (not (= null x17))))
(check-sat)
(exit)
