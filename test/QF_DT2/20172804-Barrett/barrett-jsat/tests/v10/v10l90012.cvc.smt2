...
(assert (and (and (and (and (and (and (and (and (= x9 x7) (not ((_ is zero) x6))) (not ((_ is succ) (succ x1)))) ((_ is node) x21)) (= (children (node null)) x20)) (not (= x29 x24))) ((_ is node) (car x17))) (not (= x1 x9))) ((_ is null) (cdr x19))))
(check-sat)
(exit)
