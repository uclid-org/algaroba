...
(assert (and (and (and (and (and (and (and (is-leaf (node x15)) (= x25 x29)) ((_ is cons) x18)) (not ((_ is null) x15))) (not ((_ is succ) x1))) (not (= (node x11) x21))) (not (= x13 null))) (not (= x16 x18))))
(check-sat)
(exit)
