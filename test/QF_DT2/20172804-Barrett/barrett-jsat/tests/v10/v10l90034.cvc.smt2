...
(assert (and (and (and (and (and (and (and (and (not (= x30 (leaf x1))) (not (= x11 x14))) (not ((_ is null) null))) (not ((_ is cons) (cdr (cons x23 x18))))) (not (= x2 (succ x6)))) (= (children (node (children x25))) x12)) (= x23 (car (cdr x13)))) (is-leaf (leaf x6))) (= x18 x16)))
(check-sat)
(exit)
