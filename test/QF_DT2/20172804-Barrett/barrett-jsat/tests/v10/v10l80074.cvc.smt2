...
(assert (and (and (and (and (and (and (and (not ((_ is cons) x12)) (not (= x17 (children x26)))) (= x14 x14)) (not (= x29 x21))) (= x2 (succ x8))) (= (succ (data x25)) (data (node x17)))) (not (= x21 (leaf (data x26))))) ((_ is null) (children x30))))
(check-sat)
(exit)
