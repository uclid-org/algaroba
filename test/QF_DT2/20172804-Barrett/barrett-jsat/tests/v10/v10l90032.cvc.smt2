...
(assert (and (and (and (and (and (and (and (and (not (= x18 x18)) ((_ is zero) x9)) (not (= x4 x2))) (not ((_ is node) x26))) (not ((_ is cons) x14))) (= x15 null)) (not (= (cons x23 (children (node x17))) (cdr x14)))) (not ((_ is node) (node x15)))) (not (= x27 x26))))
(check-sat)
(exit)
