...
(assert (and (and (and (and (and (and (and (not ((_ is null) x11)) (= x4 (pred (pred (pred x9))))) (not ((_ is succ) x1))) (not ((_ is zero) x4))) (not (= (cons x25 x12) x11))) (not (is-leaf x29))) (not ((_ is null) x15))) (not ((_ is zero) (succ x5)))))
(check-sat)
(exit)
