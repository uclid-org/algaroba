...
(assert (and (and (and (and (and (and (and (and (not ((_ is null) x11)) (= x27 x24)) (= x6 x1)) (not ((_ is null) x13))) (not (is-leaf x24))) (= x13 (cons x21 x11))) ((_ is null) x14)) (not (is-leaf (car x14)))) ((_ is cons) x16)))
(check-sat)
(exit)
