...
(assert (and (and (and (and (and (and (= x13 x18) ((_ is node) x29)) (not ((_ is cons) x12))) (= (pred x4) (pred x4))) (not ((_ is node) x28))) (= (cdr (cdr (children x24))) x13)) ((_ is succ) (data (node x19)))))
(check-sat)
(exit)
