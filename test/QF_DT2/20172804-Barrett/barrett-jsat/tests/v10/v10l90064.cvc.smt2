...
(assert (and (and (and (and (and (and (and (and (not (= x2 x5)) (not (= (car x17) x29))) ((_ is zero) x7)) (= x11 x15)) (not ((_ is node) x22))) ((_ is cons) x16)) (not ((_ is null) x12))) (= x16 x20)) (= x21 x25)))
(check-sat)
(exit)
