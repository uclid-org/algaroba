...
(assert (and (and (and (and (and (and (and (= x9 (ite ((_ is succ) (ite (is-leaf x28) (data x28) zero)) (pred (ite (is-leaf x28) (data x28) zero)) zero)) (not (= (ite (is-cons x16) (cdr x16) null) x18))) (not (= x18 x11))) (not (is-cons x15))) (not (is-cons (cons x24 x14)))) (= x25 x23)) (not (is-leaf x23))) (not (= x12 x20))))
(check-sat)
(exit)
