...
(assert (and (and (and (not (= x29 x25)) (= (succ x8) (ite ((_ is succ) (ite ((_ is succ) x8) (pred x8) zero)) (pred (ite ((_ is succ) x8) (pred x8) zero)) zero))) (not (= x21 x27))) (not (is-cons x14))))
(check-sat)
(exit)
