...
(assert (and (and (and (and (and (and (and (and (= (leaf x2) x21) ((_ is succ) x8)) (not ((_ is node) x26))) (is-leaf x26)) (is-cons x13)) (not (= x2 x5))) (not ((_ is zero) x6))) (= x5 (ite (is-leaf x26) (data x26) zero))) (not (= x3 x2))))
(check-sat)
(exit)
