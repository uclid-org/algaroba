...
(assert (and (and (and (and (and (and (and (not (= x7 x4)) (not (= x11 x20))) (not (= (node (ite ((_ is node) x21) (children x21) null)) (ite (is-cons x20) (car x20) (leaf zero))))) (= x9 x4)) (= x1 x5)) (is-cons (ite ((_ is node) x24) (children x24) null))) (= x12 null)) (is-cons x13)))
(check-sat)
(exit)
