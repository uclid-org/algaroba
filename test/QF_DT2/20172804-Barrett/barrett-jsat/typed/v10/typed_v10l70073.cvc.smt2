...
(assert (and (and (and (and (and (and (not (= x20 x14)) (not (= x10 (ite (is-leaf x30) (data x30) zero)))) (not (= (ite (is-cons x15) (cdr x15) null) (ite ((_ is node) x26) (children x26) null)))) (not (= x7 zero))) (not (= x3 (ite (is-leaf x23) (data x23) zero)))) (= (ite ((_ is node) x30) (children x30) null) (ite (is-cons x17) (cdr x17) null))) (= x7 (succ x1))))
(check-sat)
(exit)
