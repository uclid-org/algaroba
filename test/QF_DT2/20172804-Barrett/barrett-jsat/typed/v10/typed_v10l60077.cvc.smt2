...
(assert (and (and (and (and (and (not (= x23 x21)) ((_ is null) (ite ((_ is node) (node x14)) (children (node x14)) null))) (not ((_ is zero) (ite (is-leaf x23) (data x23) zero)))) (= x19 null)) (not (= x23 x29))) (not (= x23 x30))))
(check-sat)
(exit)
