...
(assert (and (and (and (and (and (not ((_ is succ) (ite (is-leaf (leaf x6)) (data (leaf x6)) zero))) (not ((_ is succ) x10))) (not (= x30 x28))) (= x26 (leaf x1))) ((_ is succ) x9)) ((_ is node) (node x12))))
(check-sat)
(exit)
