...
(assert (and (and (and (and (and (and (and (is-leaf (node (ite (is-cons x18) (cdr x18) null))) (not (is-cons x20))) (not ((_ is null) x12))) ((_ is succ) x9)) ((_ is zero) (ite (is-leaf x26) (data x26) zero))) (not (= x14 (ite ((_ is node) x25) (children x25) null)))) (not (= (node (ite ((_ is node) x25) (children x25) null)) x27))) (= x15 x14)))
(check-sat)
(exit)
