...
(assert (and (and (and (and (and (and (and (and (= x26 x29) (not ((_ is succ) x7))) (not (is-leaf x25))) (not (= x11 x15))) (not (= x8 x1))) (not (= x5 x9))) (is-cons x15)) ((_ is null) (cons (ite (is-cons x16) (car x16) (leaf zero)) (ite (is-cons x18) (cdr x18) null)))) (not (is-leaf x26))))
(check-sat)
(exit)
