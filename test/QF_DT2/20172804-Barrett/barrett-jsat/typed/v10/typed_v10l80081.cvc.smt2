...
(assert (and (and (and (and (and (and (and (not (= x15 x12)) (not (= x30 (node x11)))) (not (= (node x19) x24))) (not (is-leaf (ite (is-cons x17) (car x17) (leaf zero))))) (= x26 x29)) ((_ is succ) x7)) (= x30 x21)) (not (= x29 (ite (is-cons x16) (car x16) (leaf zero))))))
(check-sat)
(exit)
