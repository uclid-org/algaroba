...
(assert (and (and (and (and (and (and (and (and (= x4 x9) (= x18 x14)) (is-leaf x30)) (not (is-cons (ite (is-cons (ite ((_ is node) x30) (children x30) null)) (cdr (ite ((_ is node) x30) (children x30) null)) null)))) (= x7 x6)) (not ((_ is null) (ite ((_ is node) x23) (children x23) null)))) (not ((_ is node) x25))) ((_ is succ) x10)) (not ((_ is null) x17))))
(check-sat)
(exit)
