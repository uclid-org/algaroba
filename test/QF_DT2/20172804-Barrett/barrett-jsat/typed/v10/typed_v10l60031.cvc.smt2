...
(assert (and (and (and (and (and (not (= (cons x21 (cons x27 (ite (is-cons (ite ((_ is node) x27) (children x27) null)) (cdr (ite ((_ is node) x27) (children x27) null)) null))) (cons x30 x18))) ((_ is zero) x8)) ((_ is null) x13)) (not (= x19 x12))) (not (= x26 x29))) (not ((_ is succ) (ite ((_ is succ) x5) (pred x5) zero)))))
(check-sat)
(exit)
