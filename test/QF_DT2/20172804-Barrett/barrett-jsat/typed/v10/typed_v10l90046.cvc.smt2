...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x4)) (not ((_ is null) x20))) (= (ite ((_ is succ) (succ x2)) (pred (succ x2)) zero) (succ x9))) (= x18 (ite (is-cons null) (cdr null) null))) (= x7 x7)) (not ((_ is zero) x2))) (not ((_ is zero) x3))) (not (is-cons (cons (node (cons (leaf x2) x13)) x20)))) (not (is-cons (cons x28 (ite (is-cons null) (cdr null) null))))))
(check-sat)
(exit)
