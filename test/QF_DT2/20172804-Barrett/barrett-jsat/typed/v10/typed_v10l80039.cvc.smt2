...
(assert (and (and (and (and (and (and (and (= x12 x11) (not (= (node x15) x21))) (not ((_ is zero) (succ x5)))) (= x17 x11)) (not (= (ite (is-leaf x24) (data x24) zero) (ite ((_ is succ) x3) (pred x3) zero)))) ((_ is succ) x1)) (not ((_ is node) (ite (is-cons x11) (car x11) (leaf zero))))) (not (= (ite ((_ is succ) x6) (pred x6) zero) x9))))
(check-sat)
(exit)
