...
(assert (and (and (and (and (and (and (and (and (not ((_ is null) (ite (is-cons x15) (cdr x15) null))) (not (is-cons (ite (is-cons null) (cdr null) null)))) ((_ is null) (ite ((_ is node) x24) (children x24) null))) (not (= x14 null))) (= (leaf x7) x24)) (not (= (ite (is-leaf (leaf x2)) (data (leaf x2)) zero) x1))) ((_ is node) x27)) (not (is-leaf (node x17)))) (not ((_ is succ) x6))))
(check-sat)
(exit)
