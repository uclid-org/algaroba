...
(assert (and (and (and (and (and ((_ is zero) zero) ((_ is null) x18)) (= (ite (is-cons x20) (car x20) (leaf zero)) (leaf x1))) (not (is-leaf x22))) (not (= x3 (ite ((_ is succ) x6) (pred x6) zero)))) (not (= (ite (is-cons x18) (car x18) (leaf zero)) x25))))
(check-sat)
(exit)
