...
(assert (and (and (and (and (and (and (and (and (= x26 (leaf x8)) (= x20 x16)) ((_ is zero) x5)) (= (leaf x6) (leaf x1))) ((_ is succ) x9)) (not (= (ite ((_ is node) x23) (children x23) null) x15))) (= x27 (leaf x2))) (not (= (node (ite (is-cons x14) (cdr x14) null)) (node x14)))) (is-cons x12)))
(check-sat)
(exit)
