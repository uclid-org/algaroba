...
(assert (and (and (and (and (and (and (and (not (= x28 x22)) (= x29 x25)) ((_ is zero) x1)) (not (= x1 (succ (ite (is-leaf x29) (data x29) zero))))) (not ((_ is node) x25))) (not (= x28 x26))) (not (is-leaf x27))) (not ((_ is null) x15))))
(check-sat)
(exit)
