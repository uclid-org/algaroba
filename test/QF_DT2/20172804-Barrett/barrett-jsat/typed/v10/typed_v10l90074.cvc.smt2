...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x26)) ((_ is null) (ite ((_ is node) x24) (children x24) null))) (not (is-leaf x28))) (not ((_ is succ) (ite ((_ is succ) x6) (pred x6) zero)))) (not (is-leaf x30))) (is-cons x17)) ((_ is node) x21)) (not ((_ is zero) x2))) (not (= x9 (ite (is-leaf x28) (data x28) zero)))))
(check-sat)
(exit)
