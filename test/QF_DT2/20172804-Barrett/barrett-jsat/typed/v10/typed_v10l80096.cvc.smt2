...
(assert (and (and (and (and (and (and (and (= (ite (is-cons null) (car null) (leaf zero)) x26) ((_ is null) x17)) ((_ is succ) x7)) (= x3 (ite ((_ is succ) zero) (pred zero) zero))) (not (= x9 (ite ((_ is succ) x5) (pred x5) zero)))) (= x24 x29)) (not (= x23 (ite (is-cons x20) (car x20) (leaf zero))))) (not (is-cons x14))))
(check-sat)
(exit)
