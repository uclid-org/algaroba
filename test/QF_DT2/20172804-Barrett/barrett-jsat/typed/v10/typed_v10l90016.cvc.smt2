...
(assert (and (and (and (and (and (and (and (and ((_ is null) x19) (not (= x22 x26))) (not (= (node x18) x22))) (not (= (leaf x3) x30))) (= x10 x7)) (= x30 x27)) (not ((_ is null) (ite (is-cons x18) (cdr x18) null)))) ((_ is null) (ite ((_ is node) x21) (children x21) null))) ((_ is null) x17)))
(check-sat)
(exit)
