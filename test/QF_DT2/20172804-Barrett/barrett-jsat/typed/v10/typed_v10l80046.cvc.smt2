...
(assert (and (and (and (and (and (and (and ((_ is zero) x8) (not (is-leaf x30))) (not (= (ite ((_ is succ) (succ (ite (is-leaf x24) (data x24) zero))) (pred (succ (ite (is-leaf x24) (data x24) zero))) zero) x5))) ((_ is null) (ite (is-cons x15) (cdr x15) null))) (= x15 x11)) (not (= x13 x17))) (not (= x22 x27))) ((_ is null) (ite ((_ is node) x24) (children x24) null))))
(check-sat)
(exit)
