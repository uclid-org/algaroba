...
(assert (and (and (and (and (and (and (and (not (= x14 x19)) (not ((_ is null) x19))) ((_ is node) x26)) (not ((_ is null) (ite ((_ is node) x24) (children x24) null)))) (not (= (leaf x8) (ite (is-cons (ite ((_ is node) x25) (children x25) null)) (car (ite ((_ is node) x25) (children x25) null)) (leaf zero))))) (not (= x3 (ite ((_ is succ) x2) (pred x2) zero)))) (not (= x9 x6))) (= x12 x18)))
(check-sat)
(exit)
