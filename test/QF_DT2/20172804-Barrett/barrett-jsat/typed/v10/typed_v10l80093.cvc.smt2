...
(assert (and (and (and (and (and (and (and (is-cons x20) (= (leaf x5) (node x16))) (not ((_ is zero) x8))) (not (= (ite (is-cons x14) (cdr x14) null) x14))) (= x24 x26)) (not ((_ is node) x28))) (not (= x21 x25))) ((_ is succ) (succ (ite (is-leaf x24) (data x24) zero)))))
(check-sat)
(exit)
