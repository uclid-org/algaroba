...
(assert (and (and (and (and (and (and (and (and (not (= x24 x26)) (not (= (cons x27 x11) x19))) (= x30 x21)) (not (= x4 x7))) (is-leaf (node (ite (is-cons x19) (cdr x19) null)))) (= x7 x8)) ((_ is node) x27)) (is-leaf (node x13))) (= x22 x27)))
(check-sat)
(exit)
