...
(assert (and (and (and (and (= x23 (ite (is-cons x15) (car x15) (leaf zero))) (not (is-leaf x25))) (not (= x18 x12))) ((_ is succ) (ite ((_ is succ) (succ zero)) (pred (succ zero)) zero))) (not ((_ is succ) x1))))
(check-sat)
(exit)
