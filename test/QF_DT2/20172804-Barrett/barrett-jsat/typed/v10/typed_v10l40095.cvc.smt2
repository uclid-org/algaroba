...
(assert (and (and (and (not ((_ is null) x15)) (not (= x23 (leaf (ite (is-leaf x22) (data x22) zero))))) (= (cons x29 (cons x27 (ite (is-cons x14) (cdr x14) null))) (ite (is-cons x14) (cdr x14) null))) ((_ is succ) x10)))
(check-sat)
(exit)
