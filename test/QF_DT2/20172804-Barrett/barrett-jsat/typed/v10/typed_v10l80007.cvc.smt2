...
(assert (and (and (and (and (and (and (and (= null (cons (leaf (ite (is-leaf x23) (data x23) zero)) x15)) (not ((_ is zero) (ite (is-leaf x25) (data x25) zero)))) ((_ is succ) x8)) (= x28 x29)) (not (= x24 (node x16)))) ((_ is null) x11)) (not (= (cons (ite (is-cons x18) (car x18) (leaf zero)) (cons x30 x19)) (ite ((_ is node) x29) (children x29) null)))) (= x17 (cons x28 x16))))
(check-sat)
(exit)
