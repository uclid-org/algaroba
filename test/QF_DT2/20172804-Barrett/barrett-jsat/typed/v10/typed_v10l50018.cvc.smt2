...
(assert (and (and (and (and ((_ is null) x13) (not ((_ is succ) (succ x4)))) (not ((_ is node) x24))) (not ((_ is null) (cons (ite (is-cons (cons x22 x15)) (car (cons x22 x15)) (leaf zero)) x19)))) (= x21 (leaf x9))))
(check-sat)
(exit)
