...
(assert (and (and (and (and (and (and (and (and (not (= x15 (ite (is-cons (ite ((_ is node) x25) (children x25) null)) (cdr (ite ((_ is node) x25) (children x25) null)) null))) ((_ is null) x14)) (not (= (cons (ite (is-cons x15) (car x15) (leaf zero)) x14) x14))) ((_ is zero) x7)) (not (= x27 x25))) ((_ is null) x11)) (not (= x21 (leaf x7)))) (is-leaf x27)) ((_ is node) (leaf x8))))
(check-sat)
(exit)
