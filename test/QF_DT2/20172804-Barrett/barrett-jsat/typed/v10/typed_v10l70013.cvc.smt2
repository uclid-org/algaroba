...
(assert (and (and (and (and (and (and (= x27 (node x17)) (is-leaf x26)) (= x15 x14)) ((_ is succ) (ite ((_ is succ) x10) (pred x10) zero))) ((_ is null) x19)) (is-cons (ite (is-cons x20) (cdr x20) null))) (not ((_ is node) x27))))
(check-sat)
(exit)
