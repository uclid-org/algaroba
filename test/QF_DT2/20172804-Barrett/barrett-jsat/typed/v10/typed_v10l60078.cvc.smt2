...
(assert (and (and (and (and (and (= (ite ((_ is node) x22) (children x22) null) x15) (not (= x12 x17))) ((_ is null) null)) (= (ite (is-cons x15) (cdr x15) null) null)) (not ((_ is null) x19))) (= x27 x26)))
(check-sat)
(exit)
