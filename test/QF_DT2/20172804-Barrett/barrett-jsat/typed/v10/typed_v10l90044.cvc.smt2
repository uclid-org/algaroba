...
(assert (and (and (and (and (and (and (and (and (not (is-cons x19)) ((_ is null) x11)) (not ((_ is succ) x9))) (not (is-leaf x25))) (not ((_ is node) (ite (is-cons x17) (car x17) (leaf zero))))) (= zero x8)) (= x9 (ite (is-leaf x21) (data x21) zero))) (not (= x24 x21))) ((_ is null) x14)))
(check-sat)
(exit)
