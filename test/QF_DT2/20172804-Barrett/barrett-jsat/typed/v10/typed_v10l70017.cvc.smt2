...
(assert (and (and (and (and (and (and ((_ is null) x12) (not ((_ is null) (cons x27 x11)))) (= x23 (ite (is-cons x13) (car x13) (leaf zero)))) (not (is-leaf x28))) (not (is-cons x12))) (= (ite (is-cons x20) (car x20) (leaf zero)) x22)) (not (= null (cons x22 x11)))))
(check-sat)
(exit)
