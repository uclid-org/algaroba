...
(assert (and (and (and (and (and (and (and (and (not ((_ is null) x16)) (not (= x28 x21))) (not (= x23 (ite (is-cons x11) (car x11) (leaf zero))))) ((_ is succ) x2)) (= (ite ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) x4) (pred x4) zero)) (pred (ite ((_ is succ) x4) (pred x4) zero)) zero)) (pred (ite ((_ is succ) (ite ((_ is succ) x4) (pred x4) zero)) (pred (ite ((_ is succ) x4) (pred x4) zero)) zero)) zero) zero)) (is-leaf x27)) (not (= x4 zero))) (= x29 x29)) (not (= x7 x2))))
(check-sat)
(exit)
