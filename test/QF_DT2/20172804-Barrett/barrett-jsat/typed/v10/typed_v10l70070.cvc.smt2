...
(assert (and (and (and (and (and (and (= (ite (is-cons x20) (cdr x20) null) (ite ((_ is node) x22) (children x22) null)) ((_ is null) x16)) (not (is-leaf x21))) ((_ is null) (ite (is-cons x15) (cdr x15) null))) (not (= x6 x3))) (not ((_ is node) (ite (is-cons x20) (car x20) (leaf zero))))) (= x3 (ite ((_ is succ) (ite (is-leaf x29) (data x29) zero)) (pred (ite (is-leaf x29) (data x29) zero)) zero))))
(check-sat)
(exit)
