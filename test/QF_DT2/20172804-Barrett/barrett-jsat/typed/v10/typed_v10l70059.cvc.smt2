...
(assert (and (and (and (and (and (and (not (= x21 (ite (is-cons x18) (car x18) (leaf zero)))) (not (= x15 (cons (node x17) (cons x29 x18))))) (= x11 x18)) (is-leaf (ite (is-cons (ite ((_ is node) x23) (children x23) null)) (car (ite ((_ is node) x23) (children x23) null)) (leaf zero)))) (= (ite ((_ is node) x26) (children x26) null) (ite ((_ is node) x23) (children x23) null))) ((_ is succ) (ite (is-leaf (node x20)) (data (node x20)) zero))) (not (is-cons x20))))
(check-sat)
(exit)
