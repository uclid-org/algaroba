...
(assert (and (and (and (and (and (and (and (not (= x24 x30)) (= x30 (node x15))) (= x14 x12)) (= x20 x14)) (= x3 zero)) (is-cons (cons (ite (is-cons x16) (car x16) (leaf zero)) x20))) (not (is-cons (cons x30 (ite (is-cons x13) (cdr x13) null))))) (is-leaf x29)))
(check-sat)
(exit)
