...
(assert (and (and (and (and (and (and (and (and ((_ is null) x15) (not ((_ is node) x23))) (not (= (ite (is-leaf x25) (data x25) zero) x8))) (not (= x27 x24))) (not ((_ is null) x15))) (not (= x23 x28))) ((_ is zero) x1)) ((_ is zero) x7)) (not ((_ is succ) x9))))
(check-sat)
(exit)
