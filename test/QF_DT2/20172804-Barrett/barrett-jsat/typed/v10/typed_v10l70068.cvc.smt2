...
(assert (and (and (and (and (and (and (not ((_ is succ) x2)) (is-cons x20)) (not ((_ is node) x27))) (not ((_ is node) (leaf x3)))) (= x3 x7)) (not (= (succ x9) (succ x4)))) (= x20 (ite ((_ is node) x27) (children x27) null))))
(check-sat)
(exit)
