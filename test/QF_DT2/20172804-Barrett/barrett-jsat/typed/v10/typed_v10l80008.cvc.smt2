...
(assert (and (and (and (and (and (and (and (not ((_ is null) (ite ((_ is node) x30) (children x30) null))) (not (= (ite (is-cons x16) (cdr x16) null) (cons x26 x15)))) (not ((_ is null) x13))) (not ((_ is zero) x3))) (not (= (ite (is-cons x20) (cdr x20) null) x19))) (not (= x7 x4))) (is-leaf x22)) (not (= x3 x6))))
(check-sat)
(exit)
