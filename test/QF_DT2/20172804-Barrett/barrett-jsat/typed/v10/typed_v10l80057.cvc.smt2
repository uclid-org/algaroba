...
(assert (and (and (and (and (and (and (and (not (= (ite ((_ is node) x29) (children x29) null) (cons x28 x18))) (not (= x4 x7))) (not (= x2 (ite ((_ is succ) x4) (pred x4) zero)))) (= x5 x4)) (= (ite (is-cons x18) (cdr x18) null) x16)) (= (succ x7) (ite (is-leaf x21) (data x21) zero))) (not (= (cons x21 (ite (is-cons x19) (cdr x19) null)) null))) (not ((_ is null) x15))))
(check-sat)
(exit)
