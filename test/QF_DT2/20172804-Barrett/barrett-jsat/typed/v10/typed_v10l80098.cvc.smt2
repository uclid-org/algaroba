...
(assert (and (and (and (and (and (and (and (not (= x22 x21)) (not (= x23 (node x15)))) (= x7 x6)) ((_ is succ) x1)) (= x1 zero)) ((_ is node) (ite (is-cons (cons x22 x11)) (car (cons x22 x11)) (leaf zero)))) (not ((_ is null) x19))) (not ((_ is null) (cons x23 x15)))))
(check-sat)
(exit)
