...
(assert (and (and (and (and (and (and (and (and (not (= x2 (succ x7))) (= x4 (succ x10))) (not (= x12 x13))) (= (node x11) x23)) (not ((_ is null) (ite ((_ is node) x27) (children x27) null)))) (= (node (cons x25 x17)) x26)) (= x1 (ite (is-leaf (ite (is-cons null) (car null) (leaf zero))) (data (ite (is-cons null) (car null) (leaf zero))) zero))) (not (= x29 x29))) (not ((_ is null) x20))))
(check-sat)
(exit)
