...
(assert (and (and (and (and (and (and (and (not ((_ is node) x30)) (= (node x19) x25)) (not ((_ is zero) x10))) ((_ is null) x18)) (not ((_ is node) (ite (is-cons null) (car null) (leaf zero))))) ((_ is succ) x9)) (not ((_ is node) x22))) (= x19 x11)))
(check-sat)
(exit)
