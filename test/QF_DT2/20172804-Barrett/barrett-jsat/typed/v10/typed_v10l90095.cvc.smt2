...
(assert (and (and (and (and (and (and (and (and (= (cons (ite (is-cons (ite (is-cons x14) (cdr x14) null)) (car (ite (is-cons x14) (cdr x14) null)) (leaf zero)) x14) x15) (= x24 (leaf x7))) (not (= x14 x14))) (not ((_ is zero) x1))) (= (ite (is-cons x20) (cdr x20) null) (ite ((_ is node) x26) (children x26) null))) (not (is-leaf (ite (is-cons x15) (car x15) (leaf zero))))) (not ((_ is null) x11))) ((_ is null) x15)) ((_ is null) x13)))
(check-sat)
(exit)
