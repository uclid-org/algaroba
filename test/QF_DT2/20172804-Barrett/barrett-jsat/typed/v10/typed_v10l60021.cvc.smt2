...
(assert (and (and (and (and (and (not (is-leaf (node (ite (is-cons x16) (cdr x16) null)))) (not ((_ is node) (node x15)))) (= x27 x26)) (not (= x30 (ite (is-cons null) (car null) (leaf zero))))) (not ((_ is node) x28))) (= (ite ((_ is node) x25) (children x25) null) null)))
(check-sat)
(exit)
