...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x7)) (not (is-leaf x28))) (is-cons x16)) (not ((_ is succ) x7))) (= x19 x15)) (not ((_ is zero) (ite ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) (pred (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) zero)))) (= x10 x10)) (is-cons x13)))
(check-sat)
(exit)
