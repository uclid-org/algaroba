...
(assert (and (and (and (and ((_ is node) (leaf x10)) (= (ite (is-cons null) (car null) (leaf zero)) x27)) (= x18 (cons x25 x15))) (= (ite (is-leaf (ite (is-cons x15) (car x15) (leaf zero))) (data (ite (is-cons x15) (car x15) (leaf zero))) zero) zero)) (= null x12)))
(check-sat)
(exit)
