...
(assert (and (and (and (and (is-leaf x29) (not (= null (ite (is-cons (ite ((_ is node) x27) (children x27) null)) (cdr (ite ((_ is node) x27) (children x27) null)) null)))) (= (cons (leaf x10) (cons x23 x16)) x14)) (not ((_ is zero) x3))) (not (= x21 x21))))
(check-sat)
(exit)
