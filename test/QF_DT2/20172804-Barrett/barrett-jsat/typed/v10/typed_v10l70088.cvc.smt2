...
(assert (and (and (and (and (and (and (not (= x17 x20)) ((_ is succ) x1)) (not ((_ is zero) (ite ((_ is succ) (ite (is-leaf x26) (data x26) zero)) (pred (ite (is-leaf x26) (data x26) zero)) zero)))) (= x18 x20)) (= (ite ((_ is node) x30) (children x30) null) x13)) (= x21 (leaf x9))) (not (= x11 x18))))
(check-sat)
(exit)
