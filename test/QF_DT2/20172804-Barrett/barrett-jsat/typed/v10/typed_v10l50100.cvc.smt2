...
(assert (and (and (and (and (is-leaf x21) (= (ite ((_ is node) x28) (children x28) null) x18)) ((_ is succ) x10)) (not ((_ is succ) (ite (is-leaf (ite (is-cons x16) (car x16) (leaf zero))) (data (ite (is-cons x16) (car x16) (leaf zero))) zero)))) (not (= x15 x20))))
(check-sat)
(exit)
