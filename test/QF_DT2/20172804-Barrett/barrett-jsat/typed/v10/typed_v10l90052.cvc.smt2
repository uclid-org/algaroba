...
(assert (and (and (and (and (and (and (and (and (is-cons x16) (= (ite (is-cons x16) (car x16) (leaf zero)) (node x15))) (is-leaf (node x14))) ((_ is zero) x9)) (not (= x1 (ite ((_ is succ) (succ zero)) (pred (succ zero)) zero)))) (not (= x16 x13))) (= x14 x16)) (= x2 (ite (is-leaf (leaf x5)) (data (leaf x5)) zero))) (not ((_ is succ) x3))))
(check-sat)
(exit)
