...
(assert (and (and (and (and (not (= null (cons (node x12) x14))) ((_ is null) x14)) (= (ite ((_ is node) (ite (is-cons x15) (car x15) (leaf zero))) (children (ite (is-cons x15) (car x15) (leaf zero))) null) x17)) (is-cons x17)) (not ((_ is node) x29))))
(check-sat)
(exit)
