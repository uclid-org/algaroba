...
(assert (and (and (and (and (and (not (= x30 x27)) (= x29 (node x17))) (= (ite (is-cons x14) (car x14) (leaf zero)) (node (cons (node x17) x14)))) (not (is-cons x20))) (not (is-cons x11))) (not (= x12 (ite ((_ is node) x25) (children x25) null)))))
(check-sat)
(exit)
