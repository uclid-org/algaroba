...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x7)) (not ((_ is null) x16))) (not (= x6 x8))) ((_ is zero) x8)) (= x24 x21)) (not ((_ is null) (ite ((_ is node) x28) (children x28) null)))) ((_ is node) x23)) (= (node x13) x26)) (is-cons null)))
(check-sat)
(exit)
