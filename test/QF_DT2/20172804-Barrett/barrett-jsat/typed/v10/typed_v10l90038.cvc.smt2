...
(assert (and (and (and (and (and (and (and (and (not (= x18 x11)) (not (= (ite (is-leaf x30) (data x30) zero) zero))) (not (= x23 x21))) (not ((_ is null) x11))) (not (is-cons x14))) (is-cons (ite (is-cons x13) (cdr x13) null))) (not (= x2 x4))) (not ((_ is zero) zero))) (= x14 x18)))
(check-sat)
(exit)
