...
(assert (and (and (and (and (= x24 x24) (not (= x15 x14))) (not (is-cons x15))) (not ((_ is zero) (ite ((_ is succ) (ite (is-leaf x28) (data x28) zero)) (pred (ite (is-leaf x28) (data x28) zero)) zero)))) ((_ is succ) zero)))
(check-sat)
(exit)
