...
(assert (and (and (and (and (and (and (and (not (is-leaf (ite (is-cons x16) (car x16) (leaf zero)))) ((_ is node) x24)) (not (is-cons x19))) (not (is-leaf x29))) (is-cons (cons x22 (ite ((_ is node) (node x18)) (children (node x18)) null)))) (is-leaf x29)) ((_ is zero) x7)) (= x23 x23)))
(check-sat)
(exit)
