...
(assert (and (and (and (and (and (and (and (= x25 x24) ((_ is node) x23)) (= (cons (leaf x10) x17) x14)) (not (= x9 (ite ((_ is succ) x1) (pred x1) zero)))) (is-leaf x21)) (not (= x26 x25))) ((_ is null) x13)) (= x27 x22)))
(check-sat)
(exit)
