...
(assert (and (and (and (and (and (and (and (and (= (node (cons x30 (ite (is-cons (ite ((_ is node) x22) (children x22) null)) (cdr (ite ((_ is node) x22) (children x22) null)) null))) (ite (is-cons (ite (is-cons x15) (cdr x15) null)) (car (ite (is-cons x15) (cdr x15) null)) (leaf zero))) (is-cons (cons x21 x11))) ((_ is node) (node x18))) (= x24 x21)) (not (= (ite (is-leaf x21) (data x21) zero) x2))) (not (is-leaf x26))) (not (= x9 x6))) (not (= x6 x9))) (= x14 x16)))
(check-sat)
(exit)
