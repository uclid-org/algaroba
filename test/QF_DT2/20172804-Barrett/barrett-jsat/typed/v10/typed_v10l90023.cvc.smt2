...
(assert (and (and (and (and (and (and (and (and (is-leaf (leaf zero)) (= (leaf x2) x27)) ((_ is zero) x10)) (not (= x28 x21))) (not (= x4 (ite ((_ is succ) x4) (pred x4) zero)))) ((_ is succ) zero)) ((_ is succ) x7)) (= x14 x13)) ((_ is node) (ite (is-cons x11) (car x11) (leaf zero)))))
(check-sat)
(exit)
