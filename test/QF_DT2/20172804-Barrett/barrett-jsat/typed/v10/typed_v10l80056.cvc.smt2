...
(assert (and (and (and (and (and (and (and (= x20 x11) (= x14 x13)) (not (is-leaf x21))) (= x3 (ite (is-leaf x26) (data x26) zero))) (not (= (ite (is-leaf x24) (data x24) zero) (ite ((_ is succ) x8) (pred x8) zero)))) ((_ is null) x14)) (not (is-cons x13))) ((_ is null) x14)))
(check-sat)
(exit)
