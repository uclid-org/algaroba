...
(assert (and (and (and (and (and (and (not (is-cons x12)) ((_ is null) (cons x26 x14))) (not ((_ is succ) x3))) (= x25 x25)) (not (= x10 x8))) (is-cons x20)) (not (= x11 (cons (ite (is-cons x15) (car x15) (leaf zero)) x15)))))
(check-sat)
(exit)
