...
(assert (and (and (and (and (and (and (not ((_ is null) (ite ((_ is node) x29) (children x29) null))) (= (leaf x7) x22)) (not ((_ is succ) (succ (succ (succ x10)))))) ((_ is succ) x10)) (is-cons x12)) (not (is-cons x13))) ((_ is node) x25)))
(check-sat)
(exit)
