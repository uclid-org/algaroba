...
(assert (and (and (and (and (and (and (and (and (not (= x30 x21)) (= x3 x4)) (= x14 (ite ((_ is node) x27) (children x27) null))) (not ((_ is succ) x9))) (= x29 x23)) (not (= x11 x17))) (not ((_ is zero) x3))) (not ((_ is null) x12))) (= x27 (ite (is-cons x12) (car x12) (leaf zero)))))
(check-sat)
(exit)
