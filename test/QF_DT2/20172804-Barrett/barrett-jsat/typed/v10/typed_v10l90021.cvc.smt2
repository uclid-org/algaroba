...
(assert (and (and (and (and (and (and (and (and (not (= (node x15) (node x11))) (not (= x18 null))) (not (= x17 x11))) (= x29 (node x14))) (= x10 x10)) ((_ is zero) x6)) (not ((_ is null) (ite (is-cons x18) (cdr x18) null)))) (= x5 x5)) ((_ is null) x14)))
(check-sat)
(exit)
