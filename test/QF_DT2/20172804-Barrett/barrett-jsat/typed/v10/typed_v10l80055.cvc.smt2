...
(assert (and (and (and (and (and (and (and (not ((_ is null) (ite (is-cons null) (cdr null) null))) (not (is-cons x12))) (= x8 (ite (is-leaf x28) (data x28) zero))) (= x23 (leaf (succ x4)))) (= x30 x30)) ((_ is zero) x3)) (= x17 x12)) (not ((_ is node) x27))))
(check-sat)
(exit)
