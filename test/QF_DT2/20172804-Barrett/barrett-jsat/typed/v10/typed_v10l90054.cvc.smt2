...
(assert (and (and (and (and (and (and (and (and (not (is-cons (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null))) (not (= x13 x12))) (not (is-cons x17))) (not (= x25 x22))) ((_ is zero) (ite (is-leaf x24) (data x24) zero))) (not (is-leaf x22))) ((_ is null) (ite (is-cons x11) (cdr x11) null))) (= x8 x4)) (= x29 (ite (is-cons x11) (car x11) (leaf zero)))))
(check-sat)
(exit)
