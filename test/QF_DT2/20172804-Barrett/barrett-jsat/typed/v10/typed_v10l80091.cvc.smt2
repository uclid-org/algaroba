...
(assert (and (and (and (and (and (and (and (= x14 (ite ((_ is node) (node x14)) (children (node x14)) null)) (not ((_ is null) x13))) (not ((_ is zero) x10))) (is-cons x14)) (not ((_ is zero) x5))) (= x26 x22)) (not ((_ is zero) x3))) (= x27 x28)))
(check-sat)
(exit)
