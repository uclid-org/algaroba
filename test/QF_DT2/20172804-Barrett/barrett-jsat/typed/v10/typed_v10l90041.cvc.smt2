...
(assert (and (and (and (and (and (and (and (and (= (ite (is-leaf x25) (data x25) zero) x7) (not ((_ is null) x18))) ((_ is succ) (ite ((_ is succ) x2) (pred x2) zero))) (is-cons x19)) (not (= x3 x5))) (= x14 x12)) (not (= x4 (ite ((_ is succ) x5) (pred x5) zero)))) (not ((_ is zero) (ite ((_ is succ) x7) (pred x7) zero)))) (= zero x9)))
(check-sat)
(exit)
