...
(assert (and (and (and (and (and (= x3 (ite ((_ is succ) x1) (pred x1) zero)) (is-leaf x27)) (= x12 (ite ((_ is node) x29) (children x29) null))) (= (ite (is-cons x17) (cdr x17) null) x14)) (= x15 x17)) (not (= x4 x2))))
(check-sat)
(exit)
