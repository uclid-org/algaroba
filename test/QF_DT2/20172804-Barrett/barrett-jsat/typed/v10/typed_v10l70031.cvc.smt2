...
(assert (and (and (and (and (and (and (= x17 (ite (is-cons x15) (cdr x15) null)) (not ((_ is null) null))) (not ((_ is node) x23))) (= x25 x30)) (= (ite ((_ is node) x29) (children x29) null) x19)) (not ((_ is null) x16))) (not (= x12 (ite (is-cons x14) (cdr x14) null)))))
(check-sat)
(exit)
