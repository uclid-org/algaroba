...
(assert (and (and (and (and (and (and (= x28 x28) ((_ is succ) (ite ((_ is succ) (ite (is-leaf x29) (data x29) zero)) (pred (ite (is-leaf x29) (data x29) zero)) zero))) (not (is-cons x20))) (not (= (ite (is-leaf x29) (data x29) zero) x6))) (not (= x24 x25))) (= (cons x26 x13) x16)) ((_ is zero) (ite (is-leaf (leaf x8)) (data (leaf x8)) zero))))
(check-sat)
(exit)
