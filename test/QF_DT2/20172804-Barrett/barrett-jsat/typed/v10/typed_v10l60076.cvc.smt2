...
(assert (and (and (and (and (and (= x11 (ite (is-cons null) (cdr null) null)) (not (is-cons (ite (is-cons x17) (cdr x17) null)))) (= x3 x7)) (= (ite (is-leaf x26) (data x26) zero) x6)) (= (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (car (ite (is-cons x17) (cdr x17) null)) (leaf zero)) x21)) (not ((_ is zero) x5))))
(check-sat)
(exit)
