...
(assert (and (and (and (and (and (not (= (ite ((_ is node) x22) (children x22) null) (cons x23 (cons x26 x15)))) (= x7 x5)) (not (= x3 x8))) ((_ is succ) (ite ((_ is succ) (ite (is-leaf x22) (data x22) zero)) (pred (ite (is-leaf x22) (data x22) zero)) zero))) (not (= x4 x6))) ((_ is zero) x2)))
(check-sat)
(exit)
