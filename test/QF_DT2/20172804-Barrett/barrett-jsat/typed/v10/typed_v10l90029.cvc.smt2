...
(assert (and (and (and (and (and (and (and (and ((_ is null) x16) (not (= x21 (ite (is-cons x11) (car x11) (leaf zero))))) (= (ite (is-cons x16) (car x16) (leaf zero)) (node (ite (is-cons x13) (cdr x13) null)))) (not (= (ite ((_ is node) x26) (children x26) null) x16))) (= x27 x21)) ((_ is node) x30)) (not (= x18 x20))) (= x4 x4)) (is-cons x14)))
(check-sat)
(exit)
