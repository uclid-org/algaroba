...
(assert (and (and (and (and (and (not (= x19 (cons x23 (ite ((_ is node) x22) (children x22) null)))) ((_ is zero) x4)) (= x26 x29)) (= x8 (succ x6))) (not (is-cons x20))) (is-cons (ite ((_ is node) x25) (children x25) null))))
(check-sat)
(exit)
