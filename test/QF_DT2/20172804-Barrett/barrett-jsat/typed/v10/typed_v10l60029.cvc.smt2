...
(assert (and (and (and (and (and (= x1 (ite (is-leaf x26) (data x26) zero)) (not (= x15 x20))) (not ((_ is succ) x5))) ((_ is null) x11)) (is-cons (ite ((_ is node) x28) (children x28) null))) (= (ite (is-cons x19) (car x19) (leaf zero)) (leaf (succ x6)))))
(check-sat)
(exit)
