...
(assert (and (and (and (and (and (and (and (and (not (= null (ite ((_ is node) (leaf x3)) (children (leaf x3)) null))) (not ((_ is zero) zero))) (not (= null x16))) ((_ is null) (ite (is-cons x16) (cdr x16) null))) (= x25 (ite (is-cons (ite (is-cons (ite ((_ is node) x28) (children x28) null)) (cdr (ite ((_ is node) x28) (children x28) null)) null)) (car (ite (is-cons (ite ((_ is node) x28) (children x28) null)) (cdr (ite ((_ is node) x28) (children x28) null)) null)) (leaf zero)))) (= x2 x3)) (not (is-cons x11))) (not (= (node x11) x21))) ((_ is succ) x10)))
(check-sat)
(exit)
