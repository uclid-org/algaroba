...
(assert (and (and (and (and ((_ is succ) (ite (is-leaf x23) (data x23) zero)) (= (ite ((_ is node) x25) (children x25) null) (cons x24 x11))) (not (= x11 x20))) (not ((_ is succ) zero))) (= x17 x12)))
(check-sat)
(exit)
