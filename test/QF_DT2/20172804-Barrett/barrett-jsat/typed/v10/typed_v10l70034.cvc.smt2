...
(assert (and (and (and (and (and (and (= x21 x29) ((_ is node) x21)) (not (= (cons x28 (cons x22 (cons x27 x18))) x20))) (= x12 x16)) (not (is-leaf (ite (is-cons null) (car null) (leaf zero))))) (not (= (node x16) (leaf x3)))) (= x26 x30)))
(check-sat)
(exit)
