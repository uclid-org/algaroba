...
(assert (and (and (and (and (and (is-leaf x26) ((_ is node) x29)) (not ((_ is succ) x3))) ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) (pred (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) zero)) (pred (ite ((_ is succ) (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) (pred (ite ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (pred (ite ((_ is succ) zero) (pred zero) zero)) zero)) zero)) zero))) (not (= x11 (ite (is-cons x11) (cdr x11) null)))) (not ((_ is succ) x5))))
(check-sat)
(exit)
