...
(assert (and (and (and (and (and (and (not ((_ is succ) x7)) ((_ is null) x18)) (= x6 (ite ((_ is succ) x7) (pred x7) zero))) (not (= x20 (ite ((_ is node) x23) (children x23) null)))) (not (= x18 (cons x28 x16)))) (= x17 x16)) (not ((_ is zero) x9))))
(check-sat)
(exit)
