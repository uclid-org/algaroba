...
(assert (and (and (and (and (and (and ((_ is zero) x3) ((_ is node) x25)) (not (= x20 (cons x22 x11)))) ((_ is succ) x3)) (not (= x7 x3))) (not ((_ is null) x17))) (not (= x9 (ite (is-leaf x24) (data x24) zero)))))
(check-sat)
(exit)
