...
(assert (and (and (and (and (not (= (cons (ite (is-cons null) (car null) (leaf zero)) null) x14)) ((_ is zero) (ite ((_ is succ) x1) (pred x1) zero))) (not (= (node x20) x24))) (not ((_ is succ) x10))) (not (is-cons x19))))
(check-sat)
(exit)
