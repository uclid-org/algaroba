...
(assert (and (and (and (and (and (and (and (and (is-cons x18) ((_ is node) x22)) ((_ is zero) zero)) (= (node x14) x30)) (not ((_ is zero) x2))) (not (= x9 x5))) (not (is-leaf (leaf zero)))) (not (= x11 x11))) (not (is-cons (ite (is-cons x20) (cdr x20) null)))))
(check-sat)
(exit)
