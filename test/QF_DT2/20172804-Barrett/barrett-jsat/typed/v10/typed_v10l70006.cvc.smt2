...
(assert (and (and (and (and (and (and (= (ite (is-leaf x23) (data x23) zero) (succ x8)) (not ((_ is node) x26))) (not (= x29 (ite (is-cons (ite ((_ is node) x22) (children x22) null)) (car (ite ((_ is node) x22) (children x22) null)) (leaf zero))))) (not (= x15 x20))) (= x22 x30)) (not ((_ is zero) (succ x1)))) (is-leaf x23)))
(check-sat)
(exit)
