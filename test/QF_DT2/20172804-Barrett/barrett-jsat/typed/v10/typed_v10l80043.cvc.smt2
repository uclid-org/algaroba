...
(assert (and (and (and (and (and (and (and (not (= x25 x21)) (not (= x8 x5))) (is-cons (cons x27 (cons x26 x14)))) (= x9 x5)) (is-leaf x29)) (not (= (ite (is-cons (cons x24 x15)) (car (cons x24 x15)) (leaf zero)) x29))) (= x5 (ite ((_ is succ) x7) (pred x7) zero))) (is-leaf x29)))
(check-sat)
(exit)
