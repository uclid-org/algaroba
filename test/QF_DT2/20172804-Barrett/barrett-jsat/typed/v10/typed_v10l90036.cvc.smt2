...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) x21)) ((_ is node) x29)) (not ((_ is succ) x3))) (not (= x7 x3))) ((_ is null) null)) (not ((_ is node) x27))) (= (cons x28 (ite (is-cons x11) (cdr x11) null)) x16)) ((_ is node) x25)) (not (= x10 x1))))
(check-sat)
(exit)
