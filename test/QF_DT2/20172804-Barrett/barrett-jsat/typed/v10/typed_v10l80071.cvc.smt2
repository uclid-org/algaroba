...
(assert (and (and (and (and (and (and (and (not ((_ is node) (ite (is-cons x14) (car x14) (leaf zero)))) (not (= (ite ((_ is succ) x9) (pred x9) zero) (ite ((_ is succ) x2) (pred x2) zero)))) (= x15 (ite (is-cons x14) (cdr x14) null))) ((_ is succ) x2)) (not (= (ite (is-cons x15) (car x15) (leaf zero)) (ite (is-cons x17) (car x17) (leaf zero))))) (= x27 x26)) (= x12 x16)) (not (= x5 x9))))
(check-sat)
(exit)
