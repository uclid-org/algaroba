...
(assert (and (and (and (and (and (not ((_ is succ) x2)) (= (node x14) (ite (is-cons x19) (car x19) (leaf zero)))) ((_ is succ) (ite (is-leaf x22) (data x22) zero))) (= x24 x23)) ((_ is null) x11)) (= x5 zero)))
(check-sat)
(exit)
