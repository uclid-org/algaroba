...
(assert (and (and (and (not ((_ is zero) (ite (is-leaf (ite (is-cons (cons x22 null)) (car (cons x22 null)) (leaf zero))) (data (ite (is-cons (cons x22 null)) (car (cons x22 null)) (leaf zero))) zero))) (not (= x27 (leaf zero)))) (not (= (ite (is-cons (ite (is-cons x20) (cdr x20) null)) (cdr (ite (is-cons x20) (cdr x20) null)) null) x12))) (= x9 x4)))
(check-sat)
(exit)
