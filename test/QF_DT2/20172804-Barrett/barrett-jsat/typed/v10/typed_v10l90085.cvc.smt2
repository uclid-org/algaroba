...
(assert (and (and (and (and (and (and (and (and (is-leaf x30) (= x4 x5)) (not ((_ is succ) x6))) (not ((_ is null) x20))) (not ((_ is node) x24))) (not (= x13 x13))) (= x28 x21)) (not (= (succ x3) x6))) ((_ is succ) x6)))
(check-sat)
(exit)
