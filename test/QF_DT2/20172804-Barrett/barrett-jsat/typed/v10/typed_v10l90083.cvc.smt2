...
(assert (and (and (and (and (and (and (and (and (not (= x3 x10)) (not ((_ is null) x12))) (not ((_ is succ) x1))) (not (= (ite (is-leaf x25) (data x25) zero) x3))) (is-cons (ite (is-cons x15) (cdr x15) null))) (is-cons (ite (is-cons (cons x25 x15)) (cdr (cons x25 x15)) null))) (not (= x5 x4))) (not (is-cons x12))) (= x15 (cons x25 x12))))
(check-sat)
(exit)
