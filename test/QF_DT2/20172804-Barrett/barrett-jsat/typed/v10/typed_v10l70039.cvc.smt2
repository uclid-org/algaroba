...
(assert (and (and (and (and (and (and (= x3 x2) (not (= x29 (node x12)))) (= (ite (is-leaf (leaf x9)) (data (leaf x9)) zero) x5)) (not ((_ is null) x12))) (= x4 x9)) (not (= x13 (ite ((_ is node) x22) (children x22) null)))) ((_ is node) x25)))
(check-sat)
(exit)
