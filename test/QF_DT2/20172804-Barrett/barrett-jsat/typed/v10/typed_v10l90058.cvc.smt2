...
(assert (and (and (and (and (and (and (and (and (not (= (ite ((_ is succ) (ite ((_ is succ) x7) (pred x7) zero)) (pred (ite ((_ is succ) x7) (pred x7) zero)) zero) x6)) ((_ is succ) x10)) (not ((_ is node) x27))) (= x3 (ite (is-leaf x21) (data x21) zero))) (not ((_ is null) x14))) (= (ite ((_ is succ) x5) (pred x5) zero) (succ x8))) (= x24 (leaf x2))) (not (is-leaf x24))) (= x25 x30)))
(check-sat)
(exit)
