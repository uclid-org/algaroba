...
(assert (and (and (and (and (and (not (is-cons (ite ((_ is node) x30) (children x30) null))) (not (= (leaf zero) x28))) (not (is-cons (ite ((_ is node) x28) (children x28) null)))) (not (= x26 (node x18)))) (= x22 x24)) (not (= x14 x12))))
(check-sat)
(exit)
