...
(assert (and (and (and (and (not (is-leaf (leaf (ite (is-leaf (ite (is-cons (ite (is-cons null) (cdr null) null)) (car (ite (is-cons null) (cdr null) null)) (leaf zero))) (data (ite (is-cons (ite (is-cons null) (cdr null) null)) (car (ite (is-cons null) (cdr null) null)) (leaf zero))) zero)))) (= x2 x1)) (not ((_ is succ) (ite ((_ is succ) x9) (pred x9) zero)))) (not (= x4 x10))) (= x27 (leaf x1))))
(check-sat)
(exit)
