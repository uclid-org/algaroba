...
(assert (and (and (and (and (and (and (and (and (= x12 x13) (= x23 x25)) (= null (ite ((_ is node) x29) (children x29) null))) (= x14 (ite (is-cons x12) (cdr x12) null))) (not ((_ is node) (leaf (ite ((_ is succ) x3) (pred x3) zero))))) ((_ is null) x17)) (= x3 (succ x4))) (is-leaf x30)) (not ((_ is null) x11))))
(check-sat)
(exit)
