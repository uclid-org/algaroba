...
(assert (and (and (and (and (and (and (not (= x15 (cons x27 (ite (is-cons x15) (cdr x15) null)))) ((_ is node) x22)) (not ((_ is succ) x1))) (not (= x27 (ite (is-cons (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null)) (car (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null)) (leaf zero))))) ((_ is zero) (succ (ite (is-leaf x22) (data x22) zero)))) (not ((_ is succ) x6))) (= x24 x26)))
(check-sat)
(exit)
