...
(assert (and (and (and (and (and (= (succ zero) (succ zero)) (= x23 x21)) (= x16 (cons x26 x20))) ((_ is succ) (succ (ite (is-leaf x28) (data x28) zero)))) (not (= x20 x18))) (not ((_ is zero) (succ (succ (succ x1)))))))
(check-sat)
(exit)
