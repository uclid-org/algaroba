...
(assert (and (and (and (and (and (and (not (= (leaf zero) x24)) (= x15 (ite (is-cons null) (cdr null) null))) (= x21 (node x12))) (not ((_ is node) x25))) (not (is-leaf x21))) ((_ is null) x17)) (not ((_ is zero) x1))))
(check-sat)
(exit)
