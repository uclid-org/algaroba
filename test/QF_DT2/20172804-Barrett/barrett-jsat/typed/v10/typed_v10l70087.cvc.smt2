...
(assert (and (and (and (and (and (and (not (is-leaf x26)) (not (is-leaf x30))) (= (ite ((_ is succ) x1) (pred x1) zero) (succ x7))) (not (is-cons x18))) (= x14 (ite (is-cons x18) (cdr x18) null))) (not (= x7 (ite (is-leaf (ite (is-cons x14) (car x14) (leaf zero))) (data (ite (is-cons x14) (car x14) (leaf zero))) zero)))) (not ((_ is node) x21))))
(check-sat)
(exit)
