...
(assert (and (and (and (and (and (and (= (cons x28 x11) (ite (is-cons x17) (cdr x17) null)) (= x5 (ite ((_ is succ) x9) (pred x9) zero))) (not (= x26 x29))) (= zero (ite ((_ is succ) (ite (is-leaf (node x12)) (data (node x12)) zero)) (pred (ite (is-leaf (node x12)) (data (node x12)) zero)) zero))) (not (is-leaf x23))) (not (= x23 x26))) ((_ is node) (ite (is-cons x14) (car x14) (leaf zero)))))
(check-sat)
(exit)
