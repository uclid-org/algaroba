...
(assert (and (and (and (and (and (and (= (ite ((_ is succ) x3) (pred x3) zero) zero) (= (ite ((_ is succ) x2) (pred x2) zero) x10)) (not (= x20 x16))) (not ((_ is null) x18))) ((_ is node) (ite (is-cons (ite ((_ is node) x30) (children x30) null)) (car (ite ((_ is node) x30) (children x30) null)) (leaf zero)))) ((_ is zero) x4)) (not ((_ is zero) x5))))
(check-sat)
(exit)
