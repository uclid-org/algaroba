...
(assert (and (and (and (and (and (and (and (and (not (= x11 x20)) (= (cons x21 x14) (cons x28 x12))) (not (= x22 (leaf x4)))) (not (is-cons x13))) (= (succ x10) x5)) (not (= zero x2))) (= x1 (ite (is-leaf x29) (data x29) zero))) (not ((_ is zero) x10))) ((_ is node) x22)))
(check-sat)
(exit)
