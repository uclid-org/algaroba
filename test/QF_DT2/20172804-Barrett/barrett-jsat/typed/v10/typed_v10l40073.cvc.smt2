...
(assert (and (and (and (= (ite (is-cons null) (car null) (leaf zero)) x27) (not (= x8 (ite (is-leaf x21) (data x21) zero)))) (not (is-leaf (node x12)))) (not ((_ is null) (ite (is-cons (ite (is-cons x13) (cdr x13) null)) (cdr (ite (is-cons x13) (cdr x13) null)) null)))))
(check-sat)
(exit)
