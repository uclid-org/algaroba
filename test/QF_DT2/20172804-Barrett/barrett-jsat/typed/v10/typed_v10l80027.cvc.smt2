...
(assert (and (and (and (and (and (and (and (not (= x1 (ite ((_ is succ) (ite (is-leaf x22) (data x22) zero)) (pred (ite (is-leaf x22) (data x22) zero)) zero))) (= x11 (cons x30 null))) ((_ is zero) x8)) (not ((_ is node) x27))) (not (= x30 x22))) (is-leaf x23)) (not (= x4 x6))) (= x14 x16)))
(check-sat)
(exit)
