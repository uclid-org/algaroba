...
(assert (and (and (and (and (and (and (= x21 x25) (not (= (cons x28 x14) (ite (is-cons x19) (cdr x19) null)))) ((_ is zero) x8)) (not ((_ is null) x17))) (= x22 (node x14))) ((_ is node) x22)) (not (= x12 null))))
(check-sat)
(exit)
