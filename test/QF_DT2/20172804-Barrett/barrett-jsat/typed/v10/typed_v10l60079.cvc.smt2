...
(assert (and (and (and (and (and ((_ is null) x13) (not ((_ is zero) x9))) (not (= x18 (ite (is-cons x14) (cdr x14) null)))) (not ((_ is null) x15))) ((_ is zero) x8)) (not (= (ite ((_ is succ) (ite ((_ is succ) x6) (pred x6) zero)) (pred (ite ((_ is succ) x6) (pred x6) zero)) zero) x9))))
(check-sat)
(exit)
