...
(assert (and (and (and (and (and (and (and (and ((_ is null) (ite (is-cons x14) (cdr x14) null)) (= x27 x22)) (= x10 x9)) (not ((_ is node) x25))) (is-leaf x27)) ((_ is null) null)) (is-leaf (node (ite (is-cons x18) (cdr x18) null)))) (not ((_ is node) x30))) (not ((_ is zero) x8))))
(check-sat)
(exit)
