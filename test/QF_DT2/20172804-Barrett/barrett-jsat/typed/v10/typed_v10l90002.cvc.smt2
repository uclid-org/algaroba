...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x3) (not (is-cons x17))) (not (= x12 null))) (not (= (node null) x30))) ((_ is succ) x2)) (not (is-leaf (node x19)))) (not (= x25 x30))) ((_ is node) x21)) (= x21 (node x16))))
(check-sat)
(exit)
