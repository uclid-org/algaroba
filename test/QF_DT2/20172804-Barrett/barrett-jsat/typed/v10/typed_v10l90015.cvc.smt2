...
(assert (and (and (and (and (and (and (and (and (is-cons x16) ((_ is succ) x2)) ((_ is null) x20)) (= (ite (is-cons x17) (cdr x17) null) x17)) (= (ite (is-cons x18) (car x18) (leaf zero)) (leaf x7))) (is-leaf x29)) (is-leaf x28)) (= x25 x24)) ((_ is null) (cons x24 null))))
(check-sat)
(exit)
