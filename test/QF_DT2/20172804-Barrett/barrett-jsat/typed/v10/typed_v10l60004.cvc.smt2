...
(assert (and (and (and (and (and (is-cons x18) (not ((_ is node) x21))) (= (ite (is-cons x20) (cdr x20) null) (ite (is-cons x13) (cdr x13) null))) (= x23 x22)) ((_ is succ) x1)) (not ((_ is node) x29))))
(check-sat)
(exit)
