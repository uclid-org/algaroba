...
(assert (and (and (and (and (and (= (ite ((_ is node) x27) (children x27) null) (ite ((_ is node) (ite (is-cons (cons (node x19) x17)) (car (cons (node x19) x17)) (leaf zero))) (children (ite (is-cons (cons (node x19) x17)) (car (cons (node x19) x17)) (leaf zero))) null)) ((_ is succ) x2)) (is-leaf (leaf x6))) (is-cons x20)) ((_ is succ) x6)) (not (= x15 x19))))
(check-sat)
(exit)
