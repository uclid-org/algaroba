...
(assert (and (and ((_ is node) (node x14)) (not (= x17 (ite ((_ is node) (ite (is-cons x19) (car x19) (leaf zero))) (children (ite (is-cons x19) (car x19) (leaf zero))) null)))) (= x13 (cons x30 x19))))
(check-sat)
(exit)
