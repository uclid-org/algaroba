...
(assert (and (and (and (and (and (and (and ((_ is zero) (ite ((_ is succ) x10) (pred x10) zero)) ((_ is null) x12)) (not (= x17 (ite (is-cons x16) (cdr x16) null)))) (= (cons x23 x19) x14)) (= x15 x12)) (not (= (ite (is-cons x19) (car x19) (leaf zero)) x28))) (not (= x5 zero))) (= x13 x15)))
(check-sat)
(exit)
