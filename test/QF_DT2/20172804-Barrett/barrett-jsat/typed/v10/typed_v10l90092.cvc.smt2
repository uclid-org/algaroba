...
(assert (and (and (and (and (and (and (and (and ((_ is node) x21) ((_ is node) x26)) (not (= x12 x11))) (not ((_ is succ) x3))) (not ((_ is succ) x10))) (not (= (node x14) x21))) ((_ is succ) x9)) (= x11 x14)) (= x13 x19)))
(check-sat)
(exit)
