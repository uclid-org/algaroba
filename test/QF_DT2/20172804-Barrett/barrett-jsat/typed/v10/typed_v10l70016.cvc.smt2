...
(assert (and (and (and (and (and (and (not (is-cons x12)) (is-leaf (ite (is-cons x16) (car x16) (leaf zero)))) (not (= x26 (node x19)))) ((_ is node) x28)) (= x17 x19)) (= x24 x29)) ((_ is succ) (succ x7))))
(check-sat)
(exit)
