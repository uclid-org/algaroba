...
(assert (and (and (and (and (and (and ((_ is zero) x4) (not (= x2 x3))) (= (ite (is-leaf x26) (data x26) zero) (ite (is-leaf x24) (data x24) zero))) (not (is-leaf x23))) (= zero x3)) (not (is-cons x17))) (not (= x26 x29))))
(check-sat)
(exit)
