...
(assert (and (and (and (and (and (and (and (not (= x16 x17)) (not (= x18 x18))) (not ((_ is null) x18))) (not ((_ is zero) x4))) (not (is-cons x14))) (= (cons x24 x17) (ite ((_ is node) x23) (children x23) null))) (= x7 x4)) (= x4 x2)))
(check-sat)
(exit)
