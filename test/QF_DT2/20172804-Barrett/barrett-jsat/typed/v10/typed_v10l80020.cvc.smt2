...
(assert (and (and (and (and (and (and (and (is-leaf x30) (not ((_ is zero) x9))) (= x14 x12)) (= x6 zero)) (not ((_ is zero) x5))) (not (= (ite (is-cons (cons x21 x15)) (car (cons x21 x15)) (leaf zero)) x26))) (is-leaf x22)) (not (= (ite ((_ is succ) x4) (pred x4) zero) x6))))
(check-sat)
(exit)
