...
(assert (and (and (and (and (and (and (not (= x15 null)) (not (= (leaf x1) (ite (is-cons x20) (car x20) (leaf zero))))) (not ((_ is zero) x9))) ((_ is null) x16)) (not (= (ite ((_ is node) (node (cons x21 x14))) (children (node (cons x21 x14))) null) x20))) (not (= (ite (is-cons x12) (cdr x12) null) x18))) (= x6 x3)))
(check-sat)
(exit)
