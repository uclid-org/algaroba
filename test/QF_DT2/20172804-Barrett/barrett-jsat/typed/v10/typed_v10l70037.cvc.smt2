...
(assert (and (and (and (and (and (and (not (= x24 x28)) (not (is-cons (ite (is-cons (ite (is-cons x13) (cdr x13) null)) (cdr (ite (is-cons x13) (cdr x13) null)) null)))) ((_ is zero) x3)) (not ((_ is succ) x5))) ((_ is null) x19)) (not (= (ite ((_ is succ) (succ x2)) (pred (succ x2)) zero) x3))) ((_ is node) x29)))
(check-sat)
(exit)
