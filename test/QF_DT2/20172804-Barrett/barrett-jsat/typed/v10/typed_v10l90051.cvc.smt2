...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x2)) (= x1 x4)) (not (= x25 x27))) (is-leaf x21)) (not (= (ite (is-cons x19) (cdr x19) null) x17))) (not (= (ite ((_ is succ) x10) (pred x10) zero) x9))) (= (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null) x12)) (not ((_ is zero) x7))) (not ((_ is node) x23))))
(check-sat)
(exit)
