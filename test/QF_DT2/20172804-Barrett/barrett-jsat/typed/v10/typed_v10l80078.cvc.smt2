...
(assert (and (and (and (and (and (and (and (not (= x25 x24)) ((_ is node) x21)) (= x16 null)) (not (= x14 x13))) (= x11 (cons (leaf zero) x17))) (not (= x17 null))) (is-leaf (ite (is-cons x15) (car x15) (leaf zero)))) ((_ is node) x24)))
(check-sat)
(exit)
