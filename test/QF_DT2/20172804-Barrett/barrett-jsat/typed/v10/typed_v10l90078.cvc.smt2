...
(assert (and (and (and (and (and (and (and (and ((_ is node) x27) (is-cons x19)) (not ((_ is zero) (succ x6)))) (= x22 (node x17))) (not ((_ is null) (cons x23 (ite ((_ is node) x23) (children x23) null))))) (= x22 x28)) (not (= x7 x8))) (is-cons x17)) (not (= x2 x5))))
(check-sat)
(exit)
