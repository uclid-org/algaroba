...
(assert (and (and (and (and (and (and (not (is-cons x12)) (= x24 x21)) (is-leaf (leaf x9))) ((_ is succ) (ite (is-leaf x29) (data x29) zero))) (not (= (ite ((_ is node) x21) (children x21) null) null))) (not ((_ is node) x30))) (= x23 x22)))
(check-sat)
(exit)
