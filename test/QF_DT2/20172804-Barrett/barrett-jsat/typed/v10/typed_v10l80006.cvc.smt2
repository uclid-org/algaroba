...
(assert (and (and (and (and (and (and (and (= (ite (is-cons x20) (cdr x20) null) x17) (is-cons (ite (is-cons x18) (cdr x18) null))) (not (= x16 x14))) (= (succ x6) zero)) (not ((_ is zero) x8))) (is-leaf x27)) (= (ite ((_ is node) x29) (children x29) null) x11)) (= (ite ((_ is succ) zero) (pred zero) zero) x8)))
(check-sat)
(exit)
