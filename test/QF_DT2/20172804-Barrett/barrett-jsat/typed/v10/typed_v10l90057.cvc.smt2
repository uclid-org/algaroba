...
(assert (and (and (and (and (and (and (and (and ((_ is node) x25) (not (is-leaf x24))) (= x2 x2)) (not (is-leaf x30))) ((_ is zero) x3)) (= x8 x7)) (= x13 x13)) (not (is-cons x16))) (not (= (ite (is-leaf (node (ite (is-cons x19) (cdr x19) null))) (data (node (ite (is-cons x19) (cdr x19) null))) zero) zero))))
(check-sat)
(exit)
