...
(assert (and (and (and (and (and (and (and (= (ite (is-cons (ite (is-cons (cons x29 x19)) (cdr (cons x29 x19)) null)) (car (ite (is-cons (cons x29 x19)) (cdr (cons x29 x19)) null)) (leaf zero)) x26) (= x3 x7)) (not ((_ is null) null))) ((_ is null) (ite (is-cons (ite ((_ is node) (node x16)) (children (node x16)) null)) (cdr (ite ((_ is node) (node x16)) (children (node x16)) null)) null))) ((_ is zero) x9)) (not ((_ is null) (ite ((_ is node) x22) (children x22) null)))) ((_ is null) x18)) (not (= x9 (succ x8)))))
(check-sat)
(exit)
