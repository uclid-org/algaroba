...
(assert (and (and (and (is-leaf x28) (not ((_ is null) (cons (ite (is-cons (ite (is-cons x16) (cdr x16) null)) (car (ite (is-cons x16) (cdr x16) null)) (leaf zero)) (ite (is-cons x17) (cdr x17) null))))) (not (is-leaf x25))) ((_ is zero) x9)))
(check-sat)
(exit)
