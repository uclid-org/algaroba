...
(assert (and (and (and (and (and (and ((_ is zero) x5) ((_ is null) x11)) (not (= (leaf (ite (is-leaf x21) (data x21) zero)) x21))) (not (is-leaf x30))) (not (is-cons x16))) (not ((_ is node) x27))) (not (= x8 x4))))
(check-sat)
(exit)
