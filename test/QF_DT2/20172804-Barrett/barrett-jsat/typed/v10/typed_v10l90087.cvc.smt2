...
(assert (and (and (and (and (and (and (and (and (= x5 (ite (is-leaf x30) (data x30) zero)) (= x20 x16)) (not ((_ is zero) x7))) (not ((_ is node) x29))) (not (is-cons (ite ((_ is node) (node (ite ((_ is node) x25) (children x25) null))) (children (node (ite ((_ is node) x25) (children x25) null))) null)))) (not ((_ is succ) x8))) (not (is-leaf x23))) (not (is-leaf (leaf x3)))) (= x16 (ite ((_ is node) x22) (children x22) null))))
(check-sat)
(exit)
