...
(assert (and (and (and (and (and (and (and (not (is-leaf x22)) (not ((_ is node) x26))) (not (is-cons (ite ((_ is node) x26) (children x26) null)))) (not ((_ is zero) x4))) (not ((_ is zero) x1))) ((_ is zero) x9)) (= zero x8)) ((_ is node) x24)))
(check-sat)
(exit)
