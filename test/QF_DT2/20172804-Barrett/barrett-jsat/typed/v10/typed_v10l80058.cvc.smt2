...
(assert (and (and (and (and (and (and (and (= x9 x9) (not (= x4 x9))) ((_ is succ) x9)) (not (is-cons x17))) ((_ is node) x21)) (= x9 (ite ((_ is succ) x7) (pred x7) zero))) ((_ is zero) (succ zero))) (not ((_ is zero) zero))))
(check-sat)
(exit)
