...
(assert (and (and (and (and (and (and (and (and ((_ is succ) (ite (is-leaf x29) (data x29) zero)) ((_ is succ) x6)) (not ((_ is node) x28))) (not (= x3 (succ x4)))) ((_ is null) (cons x23 (cons x23 x19)))) (not (is-cons x13))) (not ((_ is succ) (ite (is-leaf x24) (data x24) zero)))) (not ((_ is node) (leaf x5)))) (not (= x3 x3))))
(check-sat)
(exit)
