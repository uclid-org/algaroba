...
(assert (and (and (and (and (and (and (not (= x30 (leaf (ite (is-leaf x22) (data x22) zero)))) (= x23 (node x17))) (= x14 x18)) (not (= (ite (is-leaf x21) (data x21) zero) x9))) (not (= x9 (ite (is-leaf x27) (data x27) zero)))) (not (= x9 x8))) (not (= x19 x15))))
(check-sat)
(exit)
