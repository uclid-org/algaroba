...
(assert (and (and (and (and (and (and (and ((_ is succ) (succ (ite ((_ is succ) x8) (pred x8) zero))) (= (leaf x9) x25)) ((_ is null) x13)) (not (= x25 x24))) (not (= x29 (ite (is-cons (ite ((_ is node) x24) (children x24) null)) (car (ite ((_ is node) x24) (children x24) null)) (leaf zero))))) (not (is-cons (ite (is-cons x13) (cdr x13) null)))) (= x24 x21)) (not (= x5 (ite ((_ is succ) x4) (pred x4) zero)))))
(check-sat)
(exit)
