...
(assert (and (and (and (and (and (and (and (and ((_ is null) x19) (not (= x19 x17))) (is-cons (cons (node (cons x25 (ite (is-cons x20) (cdr x20) null))) x19))) (not ((_ is node) x29))) ((_ is node) x26)) (= x6 x5)) (not (= x30 x23))) (= x22 x25)) (= (leaf (succ x8)) x27)))
(check-sat)
(exit)
