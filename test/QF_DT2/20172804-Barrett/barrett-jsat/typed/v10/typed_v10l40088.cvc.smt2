...
(assert (and (and (and (not ((_ is node) x26)) (not (= x7 (ite (is-leaf x24) (data x24) zero)))) (= (ite ((_ is node) x23) (children x23) null) (ite (is-cons x20) (cdr x20) null))) ((_ is succ) x5)))
(check-sat)
(exit)
