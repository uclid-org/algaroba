...
(assert (and (and (and (and (and (and (and (and (= x15 x13) (= x11 (cons x29 (ite ((_ is node) x24) (children x24) null)))) ((_ is null) x11)) ((_ is node) (ite (is-cons x17) (car x17) (leaf zero)))) (= x22 x26)) (not (= x8 x6))) ((_ is null) x20)) (= x9 zero)) (is-leaf x23)))
(check-sat)
(exit)
