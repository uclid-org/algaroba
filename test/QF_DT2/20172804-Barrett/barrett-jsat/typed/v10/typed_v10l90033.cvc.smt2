...
(assert (and (and (and (and (and (and (and (and ((_ is succ) (ite ((_ is succ) zero) (pred zero) zero)) (not ((_ is succ) (ite ((_ is succ) x7) (pred x7) zero)))) (not (= (ite (is-leaf x24) (data x24) zero) x1))) (not (= x28 x28))) (= x21 x23)) (= x12 x14)) ((_ is null) (cons x22 x13))) (not (= x13 (ite (is-cons x18) (cdr x18) null)))) (not (is-cons x18))))
(check-sat)
(exit)
