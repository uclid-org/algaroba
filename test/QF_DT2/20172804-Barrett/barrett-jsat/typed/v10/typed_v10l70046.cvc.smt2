...
(assert (and (and (and (and (and (and (= x18 (ite ((_ is node) x26) (children x26) null)) (not (= (node x20) x25))) (not ((_ is null) x18))) (not (= (succ x7) x3))) (= null (ite (is-cons x14) (cdr x14) null))) (is-leaf x30)) (not (= x22 x30))))
(check-sat)
(exit)
