...
(assert (and (and (and (and (and (and (and (and ((_ is node) x27) (= (ite (is-leaf (node x13)) (data (node x13)) zero) x9)) (= x8 (succ zero))) (not (= x1 x7))) (= x12 x13)) (= (node null) x28)) (not ((_ is zero) x2))) (not ((_ is zero) x4))) (not ((_ is zero) x3))))
(check-sat)
(exit)
