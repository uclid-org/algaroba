...
(assert (and (and (and (and (and (and (and (= (cons (leaf x3) null) x11) (not ((_ is node) (leaf x5)))) ((_ is succ) (ite (is-leaf x25) (data x25) zero))) (not (= x9 x8))) (not (= x23 (ite (is-cons x16) (car x16) (leaf zero))))) (not ((_ is succ) x1))) (not (= x23 x27))) (not ((_ is zero) x1))))
(check-sat)
(exit)
