...
(assert (and (and (and (and (and (and (and ((_ is succ) x1) (is-leaf (node x17))) (is-cons x18)) ((_ is null) x14)) (is-leaf (ite (is-cons (ite ((_ is node) (ite (is-cons x18) (car x18) (leaf zero))) (children (ite (is-cons x18) (car x18) (leaf zero))) null)) (car (ite ((_ is node) (ite (is-cons x18) (car x18) (leaf zero))) (children (ite (is-cons x18) (car x18) (leaf zero))) null)) (leaf zero)))) (= x2 x7)) (not ((_ is null) (ite (is-cons x17) (cdr x17) null)))) (not ((_ is null) x11))))
(check-sat)
(exit)
