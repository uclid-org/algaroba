...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x1) (not (is-cons x20))) ((_ is null) x15)) (not (= zero (ite (is-leaf x25) (data x25) zero)))) ((_ is node) x29)) (= x5 x8)) (is-cons x19)) (= x11 x17)) ((_ is succ) (ite (is-leaf x22) (data x22) zero))))
(check-sat)
(exit)
