...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) (ite ((_ is succ) x9) (pred x9) zero))) (= x16 x14)) ((_ is null) x15)) (= x14 x11)) (not (= zero x3))) (not (is-cons x20))) (not (= x18 x13))) (not (is-leaf (node x12)))) (not (is-leaf (node x16)))))
(check-sat)
(exit)
