...
(assert (and (and (and (and (and (and (and (and (= (ite (is-leaf x29) (data x29) zero) x5) (not (is-cons x19))) (= (ite ((_ is node) x25) (children x25) null) x17)) (is-cons x19)) ((_ is node) x24)) (not (= x25 x22))) ((_ is node) (node x14))) (not (= (ite (is-cons x16) (car x16) (leaf zero)) x29))) (is-leaf x23)))
(check-sat)
(exit)
