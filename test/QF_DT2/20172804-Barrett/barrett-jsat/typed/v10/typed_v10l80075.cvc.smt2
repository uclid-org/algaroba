...
(assert (and (and (and (and (and (and (and (not (= x29 x29)) ((_ is succ) x3)) (not (= x7 x8))) (= x16 (cons x25 x14))) (= x8 (ite ((_ is succ) x3) (pred x3) zero))) (not (= x24 x26))) (= x16 x16)) (not (= x18 x12))))
(check-sat)
(exit)
