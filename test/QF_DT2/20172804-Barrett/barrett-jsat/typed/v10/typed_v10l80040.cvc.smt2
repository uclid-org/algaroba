...
(assert (and (and (and (and (and (and (and (is-cons x18) ((_ is null) x15)) (not (= x27 x21))) (not ((_ is null) null))) (= (node (cons (ite (is-cons x12) (car x12) (leaf zero)) x16)) x29)) (not (= x5 x10))) ((_ is node) x27)) (= x19 (cons x26 null))))
(check-sat)
(exit)
