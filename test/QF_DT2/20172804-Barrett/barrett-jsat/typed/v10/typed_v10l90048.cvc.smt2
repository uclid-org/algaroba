...
(assert (and (and (and (and (and (and (and (and (is-leaf x23) (not (= x13 x18))) ((_ is succ) x3)) (not (= x14 x18))) (is-leaf x22)) (not ((_ is node) (node x14)))) ((_ is null) x15)) (not (is-cons x16))) ((_ is node) (leaf zero))))
(check-sat)
(exit)
