...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x2)) (is-cons x18)) (not (= (ite ((_ is node) x28) (children x28) null) x16))) (not ((_ is zero) zero))) (= x12 (ite ((_ is node) x21) (children x21) null))) (not ((_ is succ) x9))) ((_ is zero) (ite ((_ is succ) x7) (pred x7) zero))) (not (= x6 x8))) (not ((_ is node) x28))))
(check-sat)
(exit)
