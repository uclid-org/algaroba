...
(assert (and (and (and (and (and (and (not ((_ is zero) (ite (is-leaf x22) (data x22) zero))) (not (is-leaf x25))) (not (= x22 x27))) ((_ is zero) (ite ((_ is succ) x5) (pred x5) zero))) (= x4 (ite ((_ is succ) x6) (pred x6) zero))) ((_ is null) x17)) (not (is-cons x13))))
(check-sat)
(exit)
