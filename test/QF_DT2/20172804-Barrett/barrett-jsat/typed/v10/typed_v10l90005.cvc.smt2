...
(assert (and (and (and (and (and (and (and (and ((_ is zero) zero) (= (succ (ite ((_ is succ) x10) (pred x10) zero)) (ite ((_ is succ) (ite ((_ is succ) x1) (pred x1) zero)) (pred (ite ((_ is succ) x1) (pred x1) zero)) zero))) (not (= x15 x13))) (= x8 (ite (is-leaf x23) (data x23) zero))) (is-leaf x25)) ((_ is node) x22)) ((_ is zero) x5)) (= x23 x22)) (not (= (cons (node x11) x15) x13))))
(check-sat)
(exit)
