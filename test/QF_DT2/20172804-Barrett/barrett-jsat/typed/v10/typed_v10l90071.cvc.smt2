...
(assert (and (and (and (and (and (and (and (and (= (leaf x8) x28) (not (= x7 x8))) (not ((_ is null) x17))) (not ((_ is null) x15))) (not (= x26 x27))) (not ((_ is null) (ite (is-cons x17) (cdr x17) null)))) (= x19 x13)) (not (is-cons x17))) ((_ is zero) x8)))
(check-sat)
(exit)
