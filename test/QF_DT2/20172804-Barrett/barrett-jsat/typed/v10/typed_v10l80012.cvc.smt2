...
(assert (and (and (and (and (and (and (and (= (ite (is-cons x16) (car x16) (leaf zero)) x24) (= x23 x21)) (not (= x27 (node (ite (is-cons null) (cdr null) null))))) (= (node x17) x30)) (is-leaf x26)) (= x26 x29)) (= (ite (is-cons (cons (node x17) x15)) (car (cons (node x17) x15)) (leaf zero)) x28)) ((_ is null) x20)))
(check-sat)
(exit)
