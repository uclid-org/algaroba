...
(assert (and (and (and (and (and (and (and (not (is-cons x19)) (not (= x7 x4))) (not (= x30 x29))) (not ((_ is zero) x5))) ((_ is null) null)) (not ((_ is succ) x9))) (not (= (ite (is-cons (ite (is-cons (ite ((_ is node) x25) (children x25) null)) (cdr (ite ((_ is node) x25) (children x25) null)) null)) (car (ite (is-cons (ite ((_ is node) x25) (children x25) null)) (cdr (ite ((_ is node) x25) (children x25) null)) null)) (leaf zero)) x21))) ((_ is succ) x3)))
(check-sat)
(exit)
