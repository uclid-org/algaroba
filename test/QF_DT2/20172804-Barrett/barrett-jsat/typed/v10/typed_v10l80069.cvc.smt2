...
(assert (and (and (and (and (and (and (and (not (is-leaf x25)) ((_ is succ) x10)) (not (is-leaf (ite (is-cons x14) (car x14) (leaf zero))))) (is-leaf x23)) (not (is-cons x13))) (is-leaf (node (cons x26 (ite ((_ is node) (node null)) (children (node null)) null))))) (not ((_ is succ) x1))) (= x16 x16)))
(check-sat)
(exit)
