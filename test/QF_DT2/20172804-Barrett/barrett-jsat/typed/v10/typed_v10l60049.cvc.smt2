...
(assert (and (and (and (and (and (= x23 (leaf x6)) (not (= (ite (is-cons x16) (cdr x16) null) x18))) (not (is-cons null))) (= x30 x29)) (not (is-leaf (ite (is-cons x13) (car x13) (leaf zero))))) ((_ is node) x28)))
(check-sat)
(exit)
