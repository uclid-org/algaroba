...
(assert (and (and (and (and (and (and (and (and (not (= x30 (ite (is-cons (ite (is-cons x19) (cdr x19) null)) (car (ite (is-cons x19) (cdr x19) null)) (leaf zero)))) (not ((_ is zero) x10))) (not (is-leaf x24))) (not (is-leaf (node x13)))) (= x10 x2)) ((_ is zero) x7)) (not (= x9 (succ (succ x2))))) (not (is-cons (ite ((_ is node) x28) (children x28) null)))) (not (is-cons x12))))
(check-sat)
(exit)
