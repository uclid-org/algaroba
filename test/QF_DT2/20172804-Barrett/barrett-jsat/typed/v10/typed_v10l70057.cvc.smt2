...
(assert (and (and (and (and (and (and ((_ is succ) (succ x9)) (not (= (node x15) x28))) (not (= (ite (is-cons x20) (car x20) (leaf zero)) x24))) (= x23 x22)) ((_ is succ) (succ x9))) ((_ is node) (node x13))) (not (= x28 x28))))
(check-sat)
(exit)
