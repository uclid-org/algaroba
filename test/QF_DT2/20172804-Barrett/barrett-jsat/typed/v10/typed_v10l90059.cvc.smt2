...
(assert (and (and (and (and (and (and (and (and (= x3 x3) (not ((_ is succ) x7))) (not (= (ite (is-cons (cons x24 (cons x26 null))) (car (cons x24 (cons x26 null))) (leaf zero)) x29))) ((_ is null) (ite (is-cons x16) (cdr x16) null))) (is-cons x18)) (not (= (node x19) x25))) (= (ite (is-cons (ite ((_ is node) x21) (children x21) null)) (car (ite ((_ is node) x21) (children x21) null)) (leaf zero)) x26)) (not ((_ is node) x29))) (is-cons x19)))
(check-sat)
(exit)
