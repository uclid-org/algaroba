...
(assert (and (and (and (and (and (not (= x28 x22)) (= zero (succ zero))) (not ((_ is zero) (ite (is-leaf x21) (data x21) zero)))) (not (= (ite ((_ is succ) x8) (pred x8) zero) zero))) (= (node x18) x28)) (not ((_ is zero) x3))))
(check-sat)
(exit)
