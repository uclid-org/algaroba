...
(assert (and (and (and (and (and (and (= x5 (ite ((_ is succ) x7) (pred x7) zero)) (= x13 (ite (is-cons x19) (cdr x19) null))) (is-leaf x26)) (= x10 (ite (is-leaf (node x12)) (data (node x12)) zero))) (is-leaf x29)) ((_ is succ) (succ x4))) (not (= x7 x9))))
(check-sat)
(exit)
