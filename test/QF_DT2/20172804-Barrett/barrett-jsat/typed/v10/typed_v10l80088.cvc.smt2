...
(assert (and (and (and (and (and (and (and ((_ is node) x26) (not (= x24 x26))) (is-cons x15)) (is-cons (ite ((_ is node) x21) (children x21) null))) (= x12 x20)) (not (= x30 x28))) (= null x18)) (is-cons x13)))
(check-sat)
(exit)
