...
(assert (and (and (and (and (not (= (cons (ite (is-cons x20) (car x20) (leaf zero)) x18) (ite ((_ is node) x21) (children x21) null))) (= x14 x13)) (not (is-cons x14))) (= (ite ((_ is node) x26) (children x26) null) x16)) (not (= x1 x10))))
(check-sat)
(exit)
