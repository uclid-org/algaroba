...
(assert (and (and (and (and (and (and ((_ is zero) x7) (not ((_ is succ) x9))) (= (ite ((_ is node) x29) (children x29) null) (cons x23 (ite ((_ is node) x29) (children x29) null)))) (not ((_ is null) x19))) (is-cons x17)) (= x22 x22)) (not ((_ is node) x22))))
(check-sat)
(exit)
