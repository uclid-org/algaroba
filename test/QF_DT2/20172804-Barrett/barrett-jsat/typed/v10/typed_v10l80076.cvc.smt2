...
(assert (and (and (and (and (and (and (and ((_ is node) x25) (= x23 (ite (is-cons x19) (car x19) (leaf zero)))) (not ((_ is null) (ite (is-cons (cons x25 x18)) (cdr (cons x25 x18)) null)))) (not (is-cons (ite ((_ is node) x30) (children x30) null)))) (not ((_ is null) (cons (node x20) x13)))) ((_ is succ) x2)) ((_ is succ) x1)) (not ((_ is null) x20))))
(check-sat)
(exit)
