...
(assert (and (and (and (and (and (not (= x14 x20)) ((_ is null) (cons x29 x18))) (not (= null (cons x27 x11)))) (not ((_ is succ) x3))) (= (cons (ite (is-cons x19) (car x19) (leaf zero)) x11) x20)) (is-cons x11)))
(check-sat)
(exit)
