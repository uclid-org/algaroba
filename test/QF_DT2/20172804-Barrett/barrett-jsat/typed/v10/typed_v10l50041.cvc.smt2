...
(assert (and (and (and (and ((_ is node) (ite (is-cons (ite (is-cons (cons x23 x12)) (cdr (cons x23 x12)) null)) (car (ite (is-cons (cons x23 x12)) (cdr (cons x23 x12)) null)) (leaf zero))) (not (= x26 x21))) (is-cons null)) (= x8 (succ x9))) (not ((_ is null) x16))))
(check-sat)
(exit)
