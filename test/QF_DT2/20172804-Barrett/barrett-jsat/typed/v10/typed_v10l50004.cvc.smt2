...
(assert (and (and (and (and ((_ is zero) (succ (succ (ite (is-leaf (ite (is-cons x17) (car x17) (leaf zero))) (data (ite (is-cons x17) (car x17) (leaf zero))) zero)))) (is-leaf x25)) (not (= x2 x9))) (= x6 x5)) (not (= (leaf x7) x27))))
(check-sat)
(exit)
