...
(assert (and (and (and (and (and (not (= (ite (is-leaf x29) (data x29) zero) x2)) ((_ is zero) x8)) (is-leaf (node x19))) (not ((_ is node) x23))) (= (cons (leaf x1) (ite (is-cons (cons x21 x12)) (cdr (cons x21 x12)) null)) x19)) (not ((_ is node) x28))))
(check-sat)
(exit)
