...
(assert (and (and (and (and (and (and (and (and ((_ is node) x26) (not (= x11 x19))) (= x28 x27)) (= x11 x12)) (not ((_ is node) x29))) ((_ is node) (node x11))) (not ((_ is null) x18))) (not (= x11 x20))) (is-leaf x24)))
(check-sat)
(exit)
