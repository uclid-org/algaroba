...
(assert (and (and (and (and (and (= (ite ((_ is node) (ite (is-cons x17) (car x17) (leaf zero))) (children (ite (is-cons x17) (car x17) (leaf zero))) null) x14) ((_ is zero) x10)) (is-leaf x25)) (not ((_ is null) x19))) ((_ is null) x12)) (not (is-leaf x30))))
(check-sat)
(exit)
