...
(assert (and (and (and (and (and (and (and ((_ is succ) (ite (is-leaf x25) (data x25) zero)) (= x2 x7)) (= x8 x8)) (not (is-leaf x28))) (= x19 (ite ((_ is node) x29) (children x29) null))) (not ((_ is null) (cons x25 x14)))) (not ((_ is node) x30))) (not (= x14 x11))))
(check-sat)
(exit)
