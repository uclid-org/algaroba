...
(assert (and (and (and (and (= x22 x27) (= x11 x17)) (not (= x14 x18))) (not (= (ite ((_ is node) x22) (children x22) null) (ite (is-cons (ite (is-cons (cons x23 x16)) (cdr (cons x23 x16)) null)) (cdr (ite (is-cons (cons x23 x16)) (cdr (cons x23 x16)) null)) null)))) (not (= (node x18) (node (cons x25 x14))))))
(check-sat)
(exit)
