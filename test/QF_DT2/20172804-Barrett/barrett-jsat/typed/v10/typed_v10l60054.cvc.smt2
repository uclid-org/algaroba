...
(assert (and (and (and (and (and (= x25 x29) ((_ is succ) x5)) (not (= (ite (is-leaf (leaf x3)) (data (leaf x3)) zero) (ite ((_ is succ) x7) (pred x7) zero)))) ((_ is node) x27)) (not (= (succ x8) (ite (is-leaf x25) (data x25) zero)))) (not (= x16 x18))))
(check-sat)
(exit)
