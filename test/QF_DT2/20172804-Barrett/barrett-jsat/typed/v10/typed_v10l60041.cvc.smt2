...
(assert (and (and (and (and (and (is-leaf x21) ((_ is zero) x4)) (is-cons (ite ((_ is node) x28) (children x28) null))) (is-cons x12)) (is-leaf (node (ite (is-cons x16) (cdr x16) null)))) (not ((_ is succ) x8))))
(check-sat)
(exit)
