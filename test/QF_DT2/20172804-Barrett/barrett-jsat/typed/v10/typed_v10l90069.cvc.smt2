...
(assert (and (and (and (and (and (and (and (and (= (node x16) x25) (not (= x23 x24))) (not ((_ is node) x25))) (= x26 x23)) ((_ is succ) (ite (is-leaf x30) (data x30) zero))) (not (= x5 (ite ((_ is succ) x7) (pred x7) zero)))) (= x23 x30)) (= (ite (is-leaf x25) (data x25) zero) x8)) (not (= x24 x22))))
(check-sat)
(exit)
