...
(assert (and (and (and (and (and (and (and (and (= null null) (not (= x30 (node x14)))) (is-cons x20)) (not (= x1 x10))) (not ((_ is null) x15))) (not (= x21 x27))) (not (is-leaf x22))) ((_ is succ) x1)) (= (ite (is-cons x20) (cdr x20) null) x11)))
(check-sat)
(exit)
