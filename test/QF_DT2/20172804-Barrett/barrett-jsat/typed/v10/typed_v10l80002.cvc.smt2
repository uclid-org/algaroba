...
(assert (and (and (and (and (and (and (and (not ((_ is succ) x1)) (= x19 (cons (leaf x1) x16))) (not (is-cons x15))) (= x27 (ite (is-cons x14) (car x14) (leaf zero)))) (= (succ x4) x10)) (not ((_ is succ) x10))) (= x16 null)) (= x3 x1)))
(check-sat)
(exit)
