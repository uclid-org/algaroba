...
(assert (and (and (and (and (and (and (and (and (not (= x16 x12)) (not (= x21 x22))) ((_ is succ) (succ x2))) (not (= x23 x25))) (not (= x26 (ite (is-cons x15) (car x15) (leaf zero))))) (not ((_ is zero) x3))) ((_ is node) x21)) ((_ is zero) x1)) (= x18 (ite ((_ is node) x29) (children x29) null))))
(check-sat)
(exit)
