...
(assert (and (and (and (and (and (and (and (and (not (is-leaf x26)) (is-leaf x28)) (not (= x19 (ite (is-cons (ite (is-cons x18) (cdr x18) null)) (cdr (ite (is-cons x18) (cdr x18) null)) null)))) (= x10 x7)) (not (= x19 null))) ((_ is zero) (succ zero))) (not (= (ite ((_ is node) x30) (children x30) null) (cons x23 null)))) (not (= x2 x8))) (= x20 x16)))
(check-sat)
(exit)
