...
(assert (and (and (and (and (and (and (= (ite ((_ is node) x25) (children x25) null) x20) (not (is-cons x20))) (= x24 x28)) ((_ is null) x12)) ((_ is node) (ite (is-cons x17) (car x17) (leaf zero)))) ((_ is node) x21)) (= zero x5)))
(check-sat)
(exit)
