...
(assert (and (and (and (and (and (and (and (= x6 x2) (not (= x26 x25))) (= x20 x14)) (not (= x1 zero))) ((_ is node) (leaf x2))) (= x4 x5)) (is-cons (ite ((_ is node) (ite (is-cons (ite ((_ is node) x30) (children x30) null)) (car (ite ((_ is node) x30) (children x30) null)) (leaf zero))) (children (ite (is-cons (ite ((_ is node) x30) (children x30) null)) (car (ite ((_ is node) x30) (children x30) null)) (leaf zero))) null))) (= x20 null)))
(check-sat)
(exit)
