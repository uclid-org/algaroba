...
(assert (and (and (and (and (and (and (= (ite (is-cons (ite ((_ is node) x24) (children x24) null)) (car (ite ((_ is node) x24) (children x24) null)) (leaf zero)) x27) (is-leaf x28)) (not (= zero (ite ((_ is succ) zero) (pred zero) zero)))) (not ((_ is succ) x8))) (= zero x9)) (not ((_ is node) x27))) ((_ is null) x12)))
(check-sat)
(exit)
