...
(assert (and (and (and (not ((_ is null) (ite ((_ is node) x27) (children x27) null))) ((_ is null) (ite (is-cons x17) (cdr x17) null))) (not (= x3 (ite (is-leaf x29) (data x29) zero)))) (= x5 (ite ((_ is succ) x8) (pred x8) zero))))
(check-sat)
(exit)
