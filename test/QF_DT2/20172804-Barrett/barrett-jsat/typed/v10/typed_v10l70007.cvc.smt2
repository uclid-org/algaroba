...
(assert (and (and (and (and (and (and (not ((_ is null) x16)) ((_ is succ) x9)) ((_ is node) x23)) (= x17 (cons x26 x17))) (= (ite ((_ is node) x25) (children x25) null) (ite (is-cons null) (cdr null) null))) (not (is-leaf x29))) (= x7 x8)))
(check-sat)
(exit)
