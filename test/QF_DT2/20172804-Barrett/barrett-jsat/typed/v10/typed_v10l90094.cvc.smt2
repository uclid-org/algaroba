...
(assert (and (and (and (and (and (and (and (and (not (= x1 x3)) (not (= x4 x6))) (not ((_ is zero) x5))) (= x5 x4)) (is-leaf x21)) (= x30 x24)) (not ((_ is null) x15))) (not ((_ is zero) x5))) (is-leaf (leaf x6))))
(check-sat)
(exit)
