...
(assert (and (and (and (and ((_ is zero) (ite ((_ is succ) x1) (pred x1) zero)) (not ((_ is node) x25))) (= x29 (ite (is-cons (cons x21 x12)) (car (cons x21 x12)) (leaf zero)))) (not (is-leaf x29))) (= x23 x26)))
(check-sat)
(exit)
