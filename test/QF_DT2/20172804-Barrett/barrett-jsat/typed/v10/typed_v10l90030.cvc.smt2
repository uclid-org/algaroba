...
(assert (and (and (and (and (and (and (and (and (is-leaf x28) (not (= x1 x7))) (= x1 x1)) (not (= (ite (is-leaf x28) (data x28) zero) x4))) (not (= (succ x3) x7))) (not ((_ is null) (ite ((_ is node) x29) (children x29) null)))) (not (= x27 x27))) ((_ is succ) x8)) (not (is-cons x11))))
(check-sat)
(exit)
