...
(assert (and (and (and (and (and (and (and (not (is-leaf x30)) (not ((_ is node) x28))) (not (= (ite (is-cons null) (cdr null) null) x11))) (= x25 (node (cons x28 x13)))) (not (= zero x1))) (not ((_ is zero) (ite (is-leaf (leaf x6)) (data (leaf x6)) zero)))) (not (= (cons x26 x12) x15))) (not ((_ is null) (cons x27 (ite ((_ is node) x25) (children x25) null))))))
(check-sat)
(exit)
