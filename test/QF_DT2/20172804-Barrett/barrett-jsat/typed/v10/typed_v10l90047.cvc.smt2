...
(assert (and (and (and (and (and (and (and (and (not (= x12 x11)) (not (is-cons x13))) (not (= x25 x21))) (not ((_ is node) x23))) (not (= (ite ((_ is succ) x9) (pred x9) zero) x4))) (= x16 (ite (is-cons x11) (cdr x11) null))) (= x12 x11)) ((_ is zero) x3)) (= x23 x25)))
(check-sat)
(exit)
