...
(assert (and (and (and (and (and (and ((_ is zero) x10) (not ((_ is null) null))) (not (is-cons (ite ((_ is node) x27) (children x27) null)))) (not ((_ is succ) (ite ((_ is succ) x9) (pred x9) zero)))) (not (= x23 x22))) (= x30 x28)) (not (is-cons x15))))
(check-sat)
(exit)
