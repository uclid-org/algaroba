...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) x5)) ((_ is succ) x2)) ((_ is null) x17)) (not (= x2 x4))) (= x26 x21)) (not (is-leaf x26))) (is-cons x15)) (not (= x22 x21))) (not (= x1 x10))))
(check-sat)
(exit)
