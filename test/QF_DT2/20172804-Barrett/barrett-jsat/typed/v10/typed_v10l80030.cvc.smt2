...
(assert (and (and (and (and (and (and (and (not (is-leaf x28)) (= x15 x11)) (= x19 x16)) (= (leaf (ite (is-leaf (leaf x1)) (data (leaf x1)) zero)) x28)) (is-leaf x29)) ((_ is null) x14)) ((_ is succ) x1)) (not (= x9 x3))))
(check-sat)
(exit)
