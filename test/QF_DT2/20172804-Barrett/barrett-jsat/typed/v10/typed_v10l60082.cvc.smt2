...
(assert (and (and (and (and (and (not (= x2 x7)) (not (= (succ x6) zero))) (= x1 (succ (succ x7)))) (is-cons (ite (is-cons (cons x26 x16)) (cdr (cons x26 x16)) null))) (not ((_ is node) x27))) ((_ is node) x21)))
(check-sat)
(exit)
