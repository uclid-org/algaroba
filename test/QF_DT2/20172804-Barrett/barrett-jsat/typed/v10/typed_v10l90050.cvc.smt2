...
(assert (and (and (and (and (and (and (and (and (not (= x6 (succ x4))) (= x21 x24)) (not ((_ is zero) x2))) (not (is-leaf x27))) (= (ite (is-cons (ite (is-cons x11) (cdr x11) null)) (cdr (ite (is-cons x11) (cdr x11) null)) null) x14)) (= x24 x27)) (= x21 x25)) (not (= x10 (ite ((_ is succ) x5) (pred x5) zero)))) (is-leaf x21)))
(check-sat)
(exit)
