...
(assert (and (and (and (and (and (and (not (= (leaf x4) x23)) (not ((_ is node) x22))) ((_ is zero) zero)) (not (= x24 x23))) (not ((_ is succ) (ite ((_ is succ) x1) (pred x1) zero)))) (= x23 x21)) (not (= x10 x8))))
(check-sat)
(exit)
