...
(assert (and (and (and (and (and (and (and (not (= x13 (ite ((_ is node) x26) (children x26) null))) (= (ite (is-leaf x24) (data x24) zero) x8)) (= x8 (succ x8))) (not (= x15 x11))) (= x22 (leaf (succ x5)))) (not ((_ is succ) x6))) (not (= x5 x4))) (is-cons (ite (is-cons (cons x29 x17)) (cdr (cons x29 x17)) null))))
(check-sat)
(exit)
