...
(assert (and (and (and (and (and (and (and (= (ite ((_ is succ) x2) (pred x2) zero) zero) ((_ is null) x19)) (not (= x19 x11))) (not ((_ is zero) x6))) (not ((_ is null) x19))) (not ((_ is zero) (ite ((_ is succ) x4) (pred x4) zero)))) (is-cons x15)) ((_ is node) (leaf x9))))
(check-sat)
(exit)
