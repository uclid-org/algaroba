...
(assert (and (and (and (and (and (and (and (and (not ((_ is zero) zero)) (not (= x24 x21))) (not (is-cons (ite (is-cons (ite ((_ is node) x28) (children x28) null)) (cdr (ite ((_ is node) x28) (children x28) null)) null)))) (is-leaf x23)) ((_ is null) x15)) ((_ is node) x27)) ((_ is node) x29)) (not ((_ is node) x26))) ((_ is null) x12)))
(check-sat)
(exit)
