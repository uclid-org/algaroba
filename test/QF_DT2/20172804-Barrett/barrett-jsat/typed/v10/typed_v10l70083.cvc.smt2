...
(assert (and (and (and (and (and (and (not ((_ is node) (ite (is-cons (cons x24 x13)) (car (cons x24 x13)) (leaf zero)))) (is-leaf x25)) (= x26 x27)) (not ((_ is node) (node (cons x23 x11))))) (not (= x28 x28))) (not (is-leaf x30))) ((_ is succ) x1)))
(check-sat)
(exit)
