...
(assert (and (and (and (and (and (and (and (and (not (is-cons x12)) ((_ is succ) (ite (is-leaf (ite (is-cons x17) (car x17) (leaf zero))) (data (ite (is-cons x17) (car x17) (leaf zero))) zero))) (= null x20)) (not (= (ite ((_ is node) x26) (children x26) null) x16))) (not (= x22 (node x20)))) (not ((_ is succ) x5))) (= x5 x6)) (not (= x18 x17))) (not (= zero x1))))
(check-sat)
(exit)
