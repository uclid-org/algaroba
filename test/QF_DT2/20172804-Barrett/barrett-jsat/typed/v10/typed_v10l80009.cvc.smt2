...
(assert (and (and (and (and (and (and (and (not (is-leaf x28)) ((_ is succ) x8)) (not ((_ is node) x21))) (not (= (ite (is-cons x15) (car x15) (leaf zero)) (node x13)))) (= x3 x4)) (= x24 x26)) (not (= x2 x10))) (not (= (ite (is-leaf x27) (data x27) zero) (ite (is-leaf x24) (data x24) zero)))))
(check-sat)
(exit)
