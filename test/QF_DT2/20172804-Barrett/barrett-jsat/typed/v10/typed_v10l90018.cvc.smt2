...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x7) (is-leaf x28)) (= x20 (cons x27 x15))) ((_ is node) x24)) (= x25 x28)) ((_ is node) x23)) (is-leaf x24)) (not (= x20 x15))) (not (is-cons x16))))
(check-sat)
(exit)
