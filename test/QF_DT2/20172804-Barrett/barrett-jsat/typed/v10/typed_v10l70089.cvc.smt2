...
(assert (and (and (and (and (and (and (is-cons null) ((_ is null) (ite ((_ is node) x21) (children x21) null))) (not ((_ is node) x26))) (= x13 x17)) (= x10 x7)) (not (= x8 x8))) (is-leaf (ite (is-cons (cons x22 x14)) (car (cons x22 x14)) (leaf zero)))))
(check-sat)
(exit)
