...
(assert (and (and (and (and (and (and ((_ is succ) x6) (not ((_ is node) x30))) ((_ is succ) x9)) (= (ite ((_ is node) (node x15)) (children (node x15)) null) x13)) (not (= (ite (is-cons (ite ((_ is node) x25) (children x25) null)) (cdr (ite ((_ is node) x25) (children x25) null)) null) x20))) (not (is-leaf x24))) (is-cons x14)))
(check-sat)
(exit)
