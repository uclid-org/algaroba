...
(assert (and (and (and (and (not (= x26 x29)) (not (= x15 (cons (ite (is-cons x17) (car x17) (leaf zero)) (ite ((_ is node) x24) (children x24) null))))) (= x4 x8)) (not ((_ is node) (ite (is-cons x19) (car x19) (leaf zero))))) (not (= x13 x17))))
(check-sat)
(exit)
