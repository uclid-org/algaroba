...
(assert (and (and (and (and (and (not ((_ is null) x14)) (= x15 x19)) (= (succ (ite ((_ is succ) x6) (pred x6) zero)) x10)) (not (= x25 (leaf x5)))) (= (ite (is-leaf x22) (data x22) zero) x1)) (not (= x22 x27))))
(check-sat)
(exit)
