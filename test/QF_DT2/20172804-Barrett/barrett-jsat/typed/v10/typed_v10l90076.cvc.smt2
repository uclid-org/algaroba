...
(assert (and (and (and (and (and (and (and (and (not (= x23 x21)) ((_ is zero) x1)) (is-cons (cons x21 x12))) (= x11 x14)) ((_ is null) x15)) (is-cons x18)) (= x11 x18)) (not (is-leaf (node x15)))) (not ((_ is zero) x6))))
(check-sat)
(exit)
