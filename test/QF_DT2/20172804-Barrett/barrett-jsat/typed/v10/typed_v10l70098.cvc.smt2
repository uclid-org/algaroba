...
(assert (and (and (and (and (and (and ((_ is node) (node (ite (is-cons (ite ((_ is node) x26) (children x26) null)) (cdr (ite ((_ is node) x26) (children x26) null)) null))) ((_ is zero) (succ x2))) (= x3 (ite (is-leaf x25) (data x25) zero))) (= x9 x5)) (not (is-leaf (ite (is-cons x19) (car x19) (leaf zero))))) (= x23 x27)) (is-leaf x21)))
(check-sat)
(exit)
