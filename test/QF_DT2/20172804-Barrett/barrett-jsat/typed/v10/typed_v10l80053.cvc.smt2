...
(assert (and (and (and (and (and (and (and ((_ is succ) (succ x8)) (= x23 x27)) (is-leaf (node x13))) (not ((_ is succ) x1))) (not ((_ is null) x14))) (= null x13)) ((_ is zero) zero)) (not (= (ite (is-leaf (ite (is-cons x16) (car x16) (leaf zero))) (data (ite (is-cons x16) (car x16) (leaf zero))) zero) x10))))
(check-sat)
(exit)
