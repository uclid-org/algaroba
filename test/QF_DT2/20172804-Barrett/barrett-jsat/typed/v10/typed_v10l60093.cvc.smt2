...
(assert (and (and (and (and (and (not (is-cons (ite (is-cons x16) (cdr x16) null))) (not (= zero x6))) (= (ite (is-cons x19) (cdr x19) null) null)) ((_ is node) x23)) ((_ is zero) x8)) (not ((_ is null) x15))))
(check-sat)
(exit)
