...
(assert (and (and (and (and (and (and (and (is-cons (cons x26 x19)) (not (= x20 (ite ((_ is node) x25) (children x25) null)))) (is-leaf x23)) (= x3 (ite ((_ is succ) (ite (is-leaf x23) (data x23) zero)) (pred (ite (is-leaf x23) (data x23) zero)) zero))) ((_ is node) (leaf x3))) ((_ is zero) zero)) (not ((_ is succ) x2))) (is-leaf x28)))
(check-sat)
(exit)
