...
(assert (and (and (and (and (and (and ((_ is null) (ite (is-cons x15) (cdr x15) null)) (= x27 x24)) (not (is-cons (cons x25 (ite (is-cons x17) (cdr x17) null))))) (= x11 x15)) (is-cons x12)) (= x27 x27)) (not (= x4 (ite ((_ is succ) (ite ((_ is succ) x8) (pred x8) zero)) (pred (ite ((_ is succ) x8) (pred x8) zero)) zero)))))
(check-sat)
(exit)
