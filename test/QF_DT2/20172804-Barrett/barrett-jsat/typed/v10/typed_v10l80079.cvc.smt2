...
(assert (and (and (and (and (and (and (and (= x16 (ite ((_ is node) x23) (children x23) null)) (not ((_ is succ) x1))) (= (cons x27 x12) x12)) (not (= x28 (node null)))) (not ((_ is succ) x3))) (not (= x21 x28))) (is-cons x17)) (not (= x11 x16))))
(check-sat)
(exit)
