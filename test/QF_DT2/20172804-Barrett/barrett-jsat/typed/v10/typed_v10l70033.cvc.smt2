...
(assert (and (and (and (and (and (and ((_ is null) x19) (not (= x15 (ite ((_ is node) (leaf x6)) (children (leaf x6)) null)))) (not (= x21 x22))) ((_ is zero) (ite ((_ is succ) (succ x10)) (pred (succ x10)) zero))) (= x9 x4)) ((_ is succ) x8)) (= x5 x10)))
(check-sat)
(exit)
