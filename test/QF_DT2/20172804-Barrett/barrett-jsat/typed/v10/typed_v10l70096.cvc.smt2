...
(assert (and (and (and (and (and (and (not ((_ is node) (ite (is-cons (cons x25 x16)) (car (cons x25 x16)) (leaf zero)))) (not (= x24 x26))) (is-cons x16)) (= (leaf x2) x21)) (not ((_ is null) x15))) (not (= zero zero))) (not (is-cons x18))))
(check-sat)
(exit)
