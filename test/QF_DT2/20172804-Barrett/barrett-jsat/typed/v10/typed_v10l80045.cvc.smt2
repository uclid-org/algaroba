...
(assert (and (and (and (and (and (and (and (= x17 x18) (not ((_ is node) x25))) (not (= x14 null))) (is-leaf (leaf x3))) (not (is-cons x20))) (= x24 x21)) (= x30 x23)) ((_ is zero) (ite (is-leaf x24) (data x24) zero))))
(check-sat)
(exit)
