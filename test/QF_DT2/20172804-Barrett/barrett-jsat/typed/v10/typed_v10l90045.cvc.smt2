...
(assert (and (and (and (and (and (and (and (and (not (is-leaf x25)) (not (is-leaf x27))) ((_ is node) x29)) ((_ is zero) x2)) (not (is-leaf (leaf x1)))) (= x5 x1)) (not (= x8 x3))) (= x3 x3)) (not ((_ is succ) x3))))
(check-sat)
(exit)
