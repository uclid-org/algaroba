...
(assert (and (and (and (and ((_ is zero) (ite ((_ is succ) x10) (pred x10) zero)) (is-leaf x22)) ((_ is zero) x2)) (is-leaf (ite (is-cons null) (car null) (leaf zero)))) (not ((_ is node) x27))))
(check-sat)
(exit)
