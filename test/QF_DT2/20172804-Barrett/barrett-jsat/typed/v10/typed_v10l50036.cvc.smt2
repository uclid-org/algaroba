...
(assert (and (and (and (and (not (is-cons x15)) (not (= x28 x27))) (not ((_ is null) x17))) (= x9 (ite (is-leaf (ite (is-cons x16) (car x16) (leaf zero))) (data (ite (is-cons x16) (car x16) (leaf zero))) zero))) (= x12 x16)))
(check-sat)
(exit)
