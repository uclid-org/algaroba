...
(assert (and (and (and (and (and (and (and (= x13 (ite (is-cons (ite (is-cons x13) (cdr x13) null)) (cdr (ite (is-cons x13) (cdr x13) null)) null)) (not ((_ is null) x18))) (is-leaf x28)) (is-leaf x27)) (not (= (succ x9) x1))) (not (= x15 x13))) (not ((_ is null) x13))) ((_ is succ) x3)))
(check-sat)
(exit)
