...
(assert (and (and (and (and (and (and ((_ is succ) x4) (= x14 x11)) (not (= (ite (is-cons x18) (cdr x18) null) x13))) (not (= x18 (ite ((_ is node) (node null)) (children (node null)) null)))) (not ((_ is null) x17))) (= x10 x6)) (not (is-cons x20))))
(check-sat)
(exit)
