...
(assert (and (and (and (and (and (and (and (not (= x1 x7)) (not ((_ is succ) x5))) (not (= x26 x21))) (is-leaf (node null))) (= x8 (ite ((_ is succ) x10) (pred x10) zero))) ((_ is zero) (ite (is-leaf x27) (data x27) zero))) (not (= x9 x4))) ((_ is null) x13)))
(check-sat)
(exit)
