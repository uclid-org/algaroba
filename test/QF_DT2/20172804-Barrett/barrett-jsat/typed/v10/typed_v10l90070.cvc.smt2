...
(assert (and (and (and (and (and (and (and (and (not ((_ is null) x11)) (not (= x20 x13))) (= x9 x3)) (not ((_ is node) x23))) (not (= x22 x23))) (not (= (ite (is-cons (cons x21 x18)) (cdr (cons x21 x18)) null) (cons x25 x12)))) (= x25 (node x18))) (not ((_ is null) x17))) ((_ is null) x15)))
(check-sat)
(exit)
