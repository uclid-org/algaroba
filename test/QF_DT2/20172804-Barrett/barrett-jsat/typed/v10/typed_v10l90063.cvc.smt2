...
(assert (and (and (and (and (and (and (and (and (not (= (ite (is-cons x20) (cdr x20) null) x19)) ((_ is succ) x3)) (is-cons (cons (ite (is-cons x16) (car x16) (leaf zero)) x20))) (not (= x3 x6))) (not ((_ is zero) zero))) ((_ is node) (leaf x7))) (not (= x17 x17))) (not (= x12 x12))) (= x21 x27)))
(check-sat)
(exit)
