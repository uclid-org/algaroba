...
(assert (and (and (and (and (and (and (and (not (= x3 x10)) ((_ is null) x20)) (is-cons null)) (not ((_ is succ) x10))) (not ((_ is succ) (ite ((_ is succ) x3) (pred x3) zero)))) (= x17 x14)) (is-cons x12)) (not (= x11 x16))))
(check-sat)
(exit)
