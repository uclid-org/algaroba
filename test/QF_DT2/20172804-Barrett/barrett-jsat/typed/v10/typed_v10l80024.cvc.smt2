...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x5)) (not (is-cons x15))) (not ((_ is zero) x10))) (not ((_ is null) x20))) ((_ is node) x21)) ((_ is null) x15)) (= x9 x7)) (= x7 (ite (is-leaf x30) (data x30) zero))))
(check-sat)
(exit)
