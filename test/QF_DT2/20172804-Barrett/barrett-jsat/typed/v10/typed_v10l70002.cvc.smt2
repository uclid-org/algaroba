...
(assert (and (and (and (and (and (and (not ((_ is zero) x9)) (= null x13)) (= x28 x24)) (not ((_ is null) (ite ((_ is node) x28) (children x28) null)))) (is-leaf x22)) ((_ is node) x24)) (not ((_ is node) x27))))
(check-sat)
(exit)
