...
(assert (and (and (and (and (and (and (and (and (not (is-cons x18)) (= x25 x24)) (not (= x23 x22))) (not (is-cons x18))) (not (= (succ zero) x3))) (not (is-cons (cons (node (ite ((_ is node) x24) (children x24) null)) null)))) (= null x15)) (= x27 (node x16))) (not (is-leaf x22))))
(check-sat)
(exit)
