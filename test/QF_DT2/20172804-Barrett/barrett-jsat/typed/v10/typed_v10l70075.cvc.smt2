...
(assert (and (and (and (and (and (and (not (= x5 (ite (is-leaf x28) (data x28) zero))) (is-leaf x27)) (not (is-cons x18))) (not ((_ is null) x17))) (= x12 x14)) (not (= x20 x13))) (= (cons x30 x12) x15)))
(check-sat)
(exit)
