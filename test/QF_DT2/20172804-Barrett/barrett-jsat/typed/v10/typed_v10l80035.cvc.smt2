...
(assert (and (and (and (and (and (and (and (not (= x2 x9)) (not ((_ is node) (ite (is-cons (cons (node x12) x20)) (car (cons (node x12) x20)) (leaf zero))))) (not ((_ is zero) x7))) ((_ is null) x14)) ((_ is node) (node x15))) (not (is-leaf x28))) (is-leaf x27)) (not (= x2 x6))))
(check-sat)
(exit)
