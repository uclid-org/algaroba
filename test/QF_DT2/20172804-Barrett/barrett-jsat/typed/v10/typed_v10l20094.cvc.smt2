...
(assert (and (= x23 (node (ite (is-cons x20) (cdr x20) null))) (not (= null (ite ((_ is node) (node (ite (is-cons x18) (cdr x18) null))) (children (node (ite (is-cons x18) (cdr x18) null))) null)))))
(check-sat)
(exit)
