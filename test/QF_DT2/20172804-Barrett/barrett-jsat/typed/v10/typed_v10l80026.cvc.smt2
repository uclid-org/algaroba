...
(assert (and (and (and (and (and (and (and (not (= x3 (ite (is-leaf x26) (data x26) zero))) (is-leaf x28)) (not (= x21 x29))) ((_ is node) x26)) (not (= x2 zero))) (is-cons (ite ((_ is node) x27) (children x27) null))) (is-cons x14)) (= x18 x14)))
(check-sat)
(exit)
