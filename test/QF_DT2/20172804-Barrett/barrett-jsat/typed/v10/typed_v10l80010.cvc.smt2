...
(assert (and (and (and (and (and (and (and (= x20 x19) (not (= x16 x15))) (not ((_ is succ) x6))) (not (= x1 x1))) (not (= (ite (is-cons x19) (cdr x19) null) x17))) (not (= x26 (ite (is-cons x13) (car x13) (leaf zero))))) (not (= x10 x7))) (not (= x14 x20))))
(check-sat)
(exit)
