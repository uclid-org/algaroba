...
(assert (and (and (and (and (and ((_ is null) x14) (not (is-cons x15))) (not (= (ite ((_ is node) x23) (children x23) null) (ite (is-cons x18) (cdr x18) null)))) ((_ is node) x27)) (= x17 x19)) (= x1 x8)))
(check-sat)
(exit)
