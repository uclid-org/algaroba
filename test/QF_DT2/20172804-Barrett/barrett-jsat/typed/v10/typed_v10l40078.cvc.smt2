...
(assert (and (and (and (not (= x16 (ite ((_ is node) (ite (is-cons x14) (car x14) (leaf zero))) (children (ite (is-cons x14) (car x14) (leaf zero))) null))) (= x25 x24)) (not ((_ is succ) x4))) (not (= x1 x1))))
(check-sat)
(exit)
