...
(assert (and (and (and (and (and (and (and (and (= x14 (cons x26 x20)) (= x4 x5)) (= x8 x3)) (not ((_ is zero) zero))) ((_ is succ) x8)) (not ((_ is null) x12))) ((_ is null) x15)) (not ((_ is null) null))) ((_ is succ) (ite (is-leaf (node null)) (data (node null)) zero))))
(check-sat)
(exit)
