...
(assert (and (and (and (and (and (and (= (ite ((_ is node) x23) (children x23) null) (ite (is-cons x15) (cdr x15) null)) (not ((_ is zero) x8))) (not (= x22 x29))) (not (= (node null) x26))) ((_ is succ) zero)) (= x6 x9)) (not (= x25 (node x15)))))
(check-sat)
(exit)
