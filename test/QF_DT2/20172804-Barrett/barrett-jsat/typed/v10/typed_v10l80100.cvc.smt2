...
(assert (and (and (and (and (and (and (and ((_ is node) x25) (not ((_ is node) (leaf (succ x2))))) (not ((_ is zero) x4))) (= x19 x15)) (= x7 x8)) (not (= x13 (ite (is-cons x12) (cdr x12) null)))) (= x22 x21)) (= x13 x18)))
(check-sat)
(exit)
