...
(assert (and (and (and (and (not (= x30 (ite (is-cons x16) (car x16) (leaf zero)))) (= x21 x22)) ((_ is zero) (ite (is-leaf x23) (data x23) zero))) (is-leaf (ite (is-cons (cons x22 x14)) (car (cons x22 x14)) (leaf zero)))) (not (= (ite (is-cons x19) (cdr x19) null) x18))))
(check-sat)
(exit)
