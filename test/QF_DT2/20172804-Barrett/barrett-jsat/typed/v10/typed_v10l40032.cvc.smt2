...
(assert (and (and (and (= x18 (ite ((_ is node) x27) (children x27) null)) (= x26 x23)) (not (= x26 x26))) (not (= x28 (node (ite ((_ is node) (ite (is-cons x19) (car x19) (leaf zero))) (children (ite (is-cons x19) (car x19) (leaf zero))) null))))))
(check-sat)
(exit)
