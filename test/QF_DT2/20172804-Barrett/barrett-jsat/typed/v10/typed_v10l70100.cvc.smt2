...
(assert (and (and (and (and (and (and (is-leaf x26) (not (= x11 x13))) (is-cons (ite (is-cons x18) (cdr x18) null))) (= (leaf (ite (is-leaf (leaf x5)) (data (leaf x5)) zero)) x27)) (not (is-leaf x22))) ((_ is succ) (succ x1))) (not (= x8 zero))))
(check-sat)
(exit)
