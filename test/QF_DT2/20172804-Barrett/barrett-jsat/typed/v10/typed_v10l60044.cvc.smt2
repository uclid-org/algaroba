...
(assert (and (and (and (and (and (is-leaf (node (ite (is-cons x18) (cdr x18) null))) (is-leaf (node (cons (node x15) x17)))) (not (is-cons (ite ((_ is node) x29) (children x29) null)))) (not (= x22 x23))) ((_ is zero) x2)) ((_ is node) x23)))
(check-sat)
(exit)
