...
(assert (and (and (and (and (and (= x29 (ite (is-cons x14) (car x14) (leaf zero))) ((_ is succ) x8)) ((_ is null) x17)) (not ((_ is null) (ite ((_ is node) x23) (children x23) null)))) (= x8 zero)) (not ((_ is zero) x7))))
(check-sat)
(exit)
