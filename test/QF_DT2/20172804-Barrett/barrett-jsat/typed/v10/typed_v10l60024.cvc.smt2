...
(assert (and (and (and (and (and (not (= x11 x20)) (= (cons x27 x16) (ite (is-cons x16) (cdr x16) null))) (not ((_ is null) (ite ((_ is node) x22) (children x22) null)))) ((_ is null) x19)) ((_ is node) x22)) ((_ is node) (ite (is-cons (cons x24 x18)) (car (cons x24 x18)) (leaf zero)))))
(check-sat)
(exit)
