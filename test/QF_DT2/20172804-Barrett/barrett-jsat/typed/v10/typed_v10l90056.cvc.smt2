...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x2) ((_ is node) x25)) ((_ is zero) x1)) ((_ is zero) x3)) ((_ is node) x23)) (= x14 x11)) (is-cons (ite ((_ is node) x28) (children x28) null))) (is-leaf x28)) (not ((_ is succ) x7))))
(check-sat)
(exit)
