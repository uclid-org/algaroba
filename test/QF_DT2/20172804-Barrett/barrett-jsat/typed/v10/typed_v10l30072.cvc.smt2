...
(assert (and (and (not (is-cons x11)) (is-cons (ite ((_ is node) (ite (is-cons (ite ((_ is node) x21) (children x21) null)) (car (ite ((_ is node) x21) (children x21) null)) (leaf zero))) (children (ite (is-cons (ite ((_ is node) x21) (children x21) null)) (car (ite ((_ is node) x21) (children x21) null)) (leaf zero))) null))) (= x16 x14)))
(check-sat)
(exit)
