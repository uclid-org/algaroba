...
(assert (and (and (and (and (and (and (and (and (= x22 x21) (= (cons x28 null) null)) (not ((_ is null) x16))) (not (= null (ite ((_ is node) x25) (children x25) null)))) (= x28 (ite (is-cons x16) (car x16) (leaf zero)))) (not ((_ is null) x20))) (not (= x17 x15))) (not (= x12 x15))) (= x10 x5)))
(check-sat)
(exit)
