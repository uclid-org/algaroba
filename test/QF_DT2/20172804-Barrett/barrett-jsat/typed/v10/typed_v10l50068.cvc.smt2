...
(assert (and (and (and (and (= (node x20) (ite (is-cons x20) (car x20) (leaf zero))) (not ((_ is node) x27))) (not (= (ite (is-leaf x24) (data x24) zero) (ite (is-leaf x25) (data x25) zero)))) (is-cons x13)) (= (leaf (succ x5)) x25)))
(check-sat)
(exit)
