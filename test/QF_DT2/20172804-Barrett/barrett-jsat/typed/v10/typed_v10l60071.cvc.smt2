...
(assert (and (and (and (and (and (= x24 x30) (not (= x2 zero))) (= (ite ((_ is succ) x6) (pred x6) zero) zero)) (not (= x27 x23))) ((_ is succ) (succ x10))) (= (ite (is-cons (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null)) (car (ite (is-cons (ite (is-cons x17) (cdr x17) null)) (cdr (ite (is-cons x17) (cdr x17) null)) null)) (leaf zero)) x24)))
(check-sat)
(exit)
