...
(assert (and (and (and (and (and (and (and (not ((_ is node) x25)) (not (= x14 x13))) ((_ is node) x26)) (= x8 (ite ((_ is succ) (ite ((_ is succ) (ite (is-leaf x22) (data x22) zero)) (pred (ite (is-leaf x22) (data x22) zero)) zero)) (pred (ite ((_ is succ) (ite (is-leaf x22) (data x22) zero)) (pred (ite (is-leaf x22) (data x22) zero)) zero)) zero))) ((_ is node) x24)) (not (is-cons null))) (not ((_ is zero) x8))) (not (is-leaf x26))))
(check-sat)
(exit)
