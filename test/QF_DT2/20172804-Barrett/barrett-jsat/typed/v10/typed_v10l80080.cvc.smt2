...
(assert (and (and (and (and (and (and (and (not (= x10 zero)) (not ((_ is null) (cons x25 x20)))) (= x24 x28)) (not (= x14 x20))) (= x7 x8)) (not (= (cons (node x14) x15) (ite ((_ is node) x26) (children x26) null)))) (not (= x14 null))) (not ((_ is zero) x9))))
(check-sat)
(exit)
