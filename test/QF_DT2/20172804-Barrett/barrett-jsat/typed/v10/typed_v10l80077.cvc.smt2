...
(assert (and (and (and (and (and (and (and (not ((_ is node) x30)) (not (= x22 x29))) ((_ is node) x30)) (not ((_ is null) x14))) (not (= x11 x19))) (not (is-leaf x27))) (not (= x3 x5))) (not ((_ is null) x20))))
(check-sat)
(exit)
