...
(assert (and (and (and (and (and (and (and (not (= x11 x13)) (= x25 (ite (is-cons x12) (car x12) (leaf zero)))) (not (is-cons x19))) (= x14 x20)) (= x23 x25)) ((_ is zero) x10)) (= (ite ((_ is succ) x2) (pred x2) zero) x1)) (not (is-leaf x24))))
(check-sat)
(exit)
