...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x3)) (not (= (cons x25 x11) x16))) (not (= x29 x30))) (not (= x15 x12))) ((_ is null) x11)) (not ((_ is succ) x8))) (is-cons (cons (node x16) x17))) ((_ is zero) x4)) (not (is-cons x20))))
(check-sat)
(exit)
