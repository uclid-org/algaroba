...
(assert (and (and (and (and (and (and (and (not ((_ is succ) x6)) ((_ is null) x13)) (is-cons (ite (is-cons x11) (cdr x11) null))) (not (is-cons x20))) (is-cons (ite (is-cons x11) (cdr x11) null))) (not (= x1 (ite ((_ is succ) (succ x4)) (pred (succ x4)) zero)))) (not ((_ is succ) x8))) (= x9 x2)))
(check-sat)
(exit)
