...
(assert (and (and (and (and (and (and (not ((_ is node) x22)) (= x6 (ite ((_ is succ) (ite ((_ is succ) (ite (is-leaf x25) (data x25) zero)) (pred (ite (is-leaf x25) (data x25) zero)) zero)) (pred (ite ((_ is succ) (ite (is-leaf x25) (data x25) zero)) (pred (ite (is-leaf x25) (data x25) zero)) zero)) zero))) (not (is-cons x19))) (not (= x5 x10))) (not (= x10 (ite (is-leaf (leaf x5)) (data (leaf x5)) zero)))) (is-cons x19)) (= x21 x29)))
(check-sat)
(exit)
