...
(assert (and (and (and (and (and (and (and (and ((_ is zero) x9) (not (= x5 (succ (ite (is-leaf x25) (data x25) zero))))) (= (ite (is-leaf x23) (data x23) zero) x3)) (not (is-cons x17))) ((_ is null) x18)) (not (= x14 x19))) (= x28 x22)) (= x17 x11)) (not (= x18 x12))))
(check-sat)
(exit)
