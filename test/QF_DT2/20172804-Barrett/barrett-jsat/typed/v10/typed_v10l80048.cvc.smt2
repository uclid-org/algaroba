...
(assert (and (and (and (and (and (and (and (not (= x6 x4)) (not ((_ is node) (ite (is-cons (ite (is-cons x18) (cdr x18) null)) (car (ite (is-cons x18) (cdr x18) null)) (leaf zero))))) (= (ite ((_ is succ) (succ x1)) (pred (succ x1)) zero) x4)) (not (= x18 x19))) (not (is-leaf x21))) (not (= (ite ((_ is node) x22) (children x22) null) x13))) (not (= x17 null))) (= x19 (ite ((_ is node) x29) (children x29) null))))
(check-sat)
(exit)
