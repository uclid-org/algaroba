...
(assert (and (and (and (and (and (and (and (not ((_ is null) x20)) (not (is-leaf x25))) (= x16 x16)) (not ((_ is node) x29))) (not ((_ is node) x21))) (= x9 (ite (is-leaf x24) (data x24) zero))) (not (= (node x11) x30))) (= x13 x14)))
(check-sat)
(exit)
