...
(assert (and (and (and (and (and (and (not (= x14 x17)) (not (= (ite (is-leaf x23) (data x23) zero) x9))) (not ((_ is zero) x7))) (= x7 x8)) (not (= (ite ((_ is succ) x6) (pred x6) zero) x9))) ((_ is null) x17)) (= x27 (node x17))))
(check-sat)
(exit)
