...
(assert (and (and (and (and (and (and (and (not ((_ is succ) (ite ((_ is succ) x5) (pred x5) zero))) (not ((_ is null) x15))) (is-leaf x22)) (= x20 x14)) (= zero x1)) (not (is-cons x19))) (not (is-cons x14))) ((_ is null) x17)))
(check-sat)
(exit)
