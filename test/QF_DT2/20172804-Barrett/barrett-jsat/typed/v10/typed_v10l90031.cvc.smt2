...
(assert (and (and (and (and (and (and (and (and ((_ is succ) x5) (not (= x21 x25))) ((_ is node) (ite (is-cons x17) (car x17) (leaf zero)))) (not ((_ is zero) (succ x9)))) (not (is-leaf x24))) (not ((_ is zero) x8))) (not ((_ is succ) (ite (is-leaf x21) (data x21) zero)))) ((_ is succ) x2)) (= x28 x30)))
(check-sat)
(exit)
