...
(assert (and (and (and (and (and (and (and (and (= x15 x20) (not (= (node x15) x26))) (= x1 (ite (is-leaf (ite (is-cons x13) (car x13) (leaf zero))) (data (ite (is-cons x13) (car x13) (leaf zero))) zero))) (= x8 x9)) (= x26 x23)) ((_ is node) x25)) (not ((_ is succ) x1))) (not (is-cons x14))) (not ((_ is zero) x4))))
(check-sat)
(exit)
