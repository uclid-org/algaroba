...
(assert (and (and (and (and (and (and (is-leaf x22) (not ((_ is zero) x8))) (not (= (ite ((_ is node) (node x13)) (children (node x13)) null) x12))) (not (= x29 (node null)))) ((_ is null) x11)) (not ((_ is null) (ite ((_ is node) x26) (children x26) null)))) (not (= x14 null))))
(check-sat)
(exit)
