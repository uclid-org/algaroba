...
(assert (and (and (and (and (and (= x7 x4) (is-leaf (node x15))) (not (= (ite ((_ is node) x26) (children x26) null) (ite ((_ is node) x22) (children x22) null)))) (= x21 x26)) (is-leaf x25)) (not (= x28 x25))))
(check-sat)
(exit)
