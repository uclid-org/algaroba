...
(assert (and (and (and (and (and (not (= (ite (is-cons (ite (is-cons x18) (cdr x18) null)) (car (ite (is-cons x18) (cdr x18) null)) (leaf zero)) x22)) (= x28 x29)) (= x22 x25)) (not ((_ is null) (cons x23 x13)))) (not ((_ is node) (leaf x7)))) (not (= x14 (ite (is-cons x20) (cdr x20) null)))))
(check-sat)
(exit)
