...
(assert (and (and (and (and (and (and (not ((_ is null) (cons x28 (cons (leaf x3) null)))) (is-leaf x22)) (= x18 (ite ((_ is node) x30) (children x30) null))) (not ((_ is null) x14))) (= x29 x27)) (= x8 x4)) (not ((_ is zero) x6))))
(check-sat)
(exit)
