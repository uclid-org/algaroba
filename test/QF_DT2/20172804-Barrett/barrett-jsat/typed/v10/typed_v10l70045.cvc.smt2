...
(assert (and (and (and (and (and (and (not ((_ is null) (ite ((_ is node) x23) (children x23) null))) ((_ is node) (leaf x9))) (not ((_ is succ) x10))) (= x16 x15)) (not (is-cons x20))) (= x23 x24)) (= x3 (succ x2))))
(check-sat)
(exit)
