...
(assert (and (and (and (and (and (and (and (and (not (= (ite (is-cons x19) (cdr x19) null) x17)) (not (= (ite ((_ is node) (node x15)) (children (node x15)) null) null))) (not ((_ is succ) x10))) (not (= x12 x17))) (not (= x7 x10))) (not (= (ite (is-cons x14) (cdr x14) null) x16))) (not (= x2 x5))) (not (is-cons x13))) (= x19 x18)))
(check-sat)
(exit)
