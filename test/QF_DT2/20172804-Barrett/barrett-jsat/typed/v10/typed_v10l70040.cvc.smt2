...
(assert (and (and (and (and (and (and (= x18 x14) (= x8 x6)) (not (= x15 (ite ((_ is node) (ite (is-cons x13) (car x13) (leaf zero))) (children (ite (is-cons x13) (car x13) (leaf zero))) null)))) (not (= x16 x15))) (= x5 x7)) ((_ is null) (ite ((_ is node) x22) (children x22) null))) (not ((_ is zero) x6))))
(check-sat)
(exit)
