...
(assert (and (and (and (not ((_ is succ) (succ x2))) (not (= x11 (ite (is-cons (ite ((_ is node) x23) (children x23) null)) (cdr (ite ((_ is node) x23) (children x23) null)) null)))) (is-leaf x21)) (= x25 x25)))
(check-sat)
(exit)
