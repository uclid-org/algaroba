...
(assert (and (and (and (and (and (and (not (is-cons x12)) (= x22 (ite (is-cons (cons x22 null)) (car (cons x22 null)) (leaf zero)))) (is-cons x19)) (is-cons null)) (not (= x10 x5))) (not (is-cons (ite (is-cons x18) (cdr x18) null)))) (not ((_ is node) x29))))
(check-sat)
(exit)
