...
(assert (and (and (and (and (and (and (and (and (= x4 (succ x5)) (not ((_ is node) x25))) (not (= x6 x1))) (= (succ x4) zero)) ((_ is node) x26)) ((_ is node) x24)) (not (is-cons x17))) (not (is-cons x16))) (not (= x23 x29))))
(check-sat)
(exit)
