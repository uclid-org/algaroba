...
(assert (and (and (and (and (and (and (not ((_ is zero) x2)) ((_ is null) (ite ((_ is node) x29) (children x29) null))) ((_ is succ) x9)) ((_ is node) x21)) ((_ is succ) x2)) (not ((_ is node) x30))) (not (= x5 (succ x9)))))
(check-sat)
(exit)
