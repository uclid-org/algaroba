...
(assert (and (and (and (and (and (and (and (not (= (cons x26 (ite (is-cons x16) (cdr x16) null)) x19)) (is-leaf (leaf x9))) (not (= (node null) x27))) (not ((_ is null) x12))) (= zero (ite ((_ is succ) zero) (pred zero) zero))) (not ((_ is node) x30))) (not (= (node x14) x28))) (not (is-cons (ite (is-cons x17) (cdr x17) null)))))
(check-sat)
(exit)
