...
(assert (and (and (and (and (and (= x14 x18) (not ((_ is null) (ite ((_ is node) (node x20)) (children (node x20)) null)))) (= x2 x9)) (= x23 x25)) ((_ is zero) zero)) ((_ is null) (ite ((_ is node) x26) (children x26) null))))
(check-sat)
(exit)
