...
(assert (and (and (and (and (and (and (and ((_ is null) x12) (not (= (leaf x1) (ite (is-cons null) (car null) (leaf zero))))) (not (= (ite (is-cons (ite (is-cons x15) (cdr x15) null)) (cdr (ite (is-cons x15) (cdr x15) null)) null) x17))) ((_ is zero) (ite ((_ is succ) (ite (is-leaf x26) (data x26) zero)) (pred (ite (is-leaf x26) (data x26) zero)) zero))) (not (= x18 (ite ((_ is node) x27) (children x27) null)))) ((_ is zero) x3)) (= x25 x28)) (= (ite ((_ is node) x24) (children x24) null) (cons x23 x12))))
(check-sat)
(exit)
