...
(assert (and (and (and (and (and (and (and (not (= x27 (leaf x3))) (not (= x26 x21))) ((_ is succ) x3)) (is-leaf x21)) ((_ is succ) x10)) (not (= x20 x11))) (= zero x7)) ((_ is node) (ite (is-cons (cons x22 null)) (car (cons x22 null)) (leaf zero)))))
(check-sat)
(exit)
