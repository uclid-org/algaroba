...
(assert (and (and (and (and (and (and (and ((_ is node) (ite (is-cons x19) (car x19) (leaf zero))) (not (= x29 x28))) (is-leaf x28)) (not (= x8 x5))) (not (= x20 (ite (is-cons (cons x30 x16)) (cdr (cons x30 x16)) null)))) ((_ is node) x30)) (= (ite (is-cons x20) (cdr x20) null) (cons x21 x20))) ((_ is node) x27)))
(check-sat)
(exit)
