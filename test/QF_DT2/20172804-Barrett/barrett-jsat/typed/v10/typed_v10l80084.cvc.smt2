...
(assert (and (and (and (and (and (and (and ((_ is null) x11) (not ((_ is node) x23))) ((_ is null) (cons x25 x13))) (not (= (cons x22 x11) x11))) (= x25 x27)) (is-cons x14)) (is-cons x12)) (not (= (cons x22 x18) null))))
(check-sat)
(exit)
