...
(assert (and (and (and (and (and (and (and (and (not (= x2 x5)) ((_ is succ) x2)) (not (= x30 (leaf x9)))) (is-cons null)) (is-cons x13)) (not (= x21 x25))) (not (= (ite (is-cons x13) (cdr x13) null) x14))) (is-leaf x22)) ((_ is null) x18)))
(check-sat)
(exit)
