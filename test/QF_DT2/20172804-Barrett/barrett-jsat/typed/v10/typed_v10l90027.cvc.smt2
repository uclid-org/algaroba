...
(assert (and (and (and (and (and (and (and (and (not (is-cons x17)) ((_ is node) x21)) (not (= x2 (succ x8)))) (not (= x12 x13))) (= x13 x18)) (not (= x26 x24))) (= x22 (ite (is-cons null) (car null) (leaf zero)))) (= x7 (ite ((_ is succ) x3) (pred x3) zero))) (not (= x13 x20))))
(check-sat)
(exit)
