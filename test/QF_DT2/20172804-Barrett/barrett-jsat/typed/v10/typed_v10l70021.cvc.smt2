...
(assert (and (and (and (and (and (and (= (node x13) x28) (not ((_ is node) x27))) ((_ is null) (cons x23 x16))) (not (= x1 x9))) (not ((_ is succ) x8))) (= x10 x8)) (not (is-cons (ite ((_ is node) x29) (children x29) null)))))
(check-sat)
(exit)
