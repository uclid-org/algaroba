...
(assert (and (and (and (and (and (not ((_ is node) x23)) (not ((_ is succ) x10))) (not (= x1 (succ (ite (is-leaf (node x11)) (data (node x11)) zero))))) (not (= x28 x30))) (not ((_ is node) x28))) (not ((_ is succ) x4))))
(check-sat)
(exit)
