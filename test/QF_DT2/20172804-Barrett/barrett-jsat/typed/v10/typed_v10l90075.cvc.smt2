...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) x4)) (not ((_ is node) x25))) (not ((_ is zero) x7))) (= (leaf x4) (ite (is-cons (ite (is-cons x12) (cdr x12) null)) (car (ite (is-cons x12) (cdr x12) null)) (leaf zero)))) ((_ is node) x27)) (= x10 zero)) (not (= x29 x26))) (not (is-cons x20))) (is-cons null)))
(check-sat)
(exit)
