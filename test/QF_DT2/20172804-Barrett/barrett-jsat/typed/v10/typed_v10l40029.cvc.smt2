...
(assert (and (and (and (not ((_ is zero) x7)) (not ((_ is node) x26))) (not ((_ is null) (ite (is-cons (cons (leaf x2) (ite ((_ is node) (node x11)) (children (node x11)) null))) (cdr (cons (leaf x2) (ite ((_ is node) (node x11)) (children (node x11)) null))) null)))) (not ((_ is succ) x9))))
(check-sat)
(exit)
