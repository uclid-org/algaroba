...
(assert (and (and (and (and (and (and (not ((_ is zero) x10)) (not (= null x20))) (not (= (succ x5) x4))) (= x24 (leaf x7))) (not ((_ is succ) (ite ((_ is succ) x4) (pred x4) zero)))) (not (is-cons x13))) (is-cons null)))
(check-sat)
(exit)
