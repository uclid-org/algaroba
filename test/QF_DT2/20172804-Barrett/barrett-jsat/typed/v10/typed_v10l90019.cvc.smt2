...
(assert (and (and (and (and (and (and (and (and (= x26 x25) (not (= x4 x7))) (not ((_ is null) x11))) ((_ is null) x19)) (not (= x7 x3))) (not ((_ is succ) x10))) (= x7 (succ x3))) (not ((_ is node) x22))) (not (= (ite ((_ is node) x29) (children x29) null) null))))
(check-sat)
(exit)
