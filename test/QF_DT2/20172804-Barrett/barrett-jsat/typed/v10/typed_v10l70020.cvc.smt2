...
(assert (and (and (and (and (and (and (= x16 x20) ((_ is zero) (ite (is-leaf x25) (data x25) zero))) (is-cons x13)) ((_ is null) (ite ((_ is node) (leaf (succ (ite (is-leaf (node x17)) (data (node x17)) zero)))) (children (leaf (succ (ite (is-leaf (node x17)) (data (node x17)) zero)))) null))) ((_ is succ) x6)) (= x27 x22)) (not (= x8 x9))))
(check-sat)
(exit)
