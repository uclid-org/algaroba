...
(assert (and (and (and (and (= x12 x15) (= x4 x2)) (not (= x25 (node x12)))) (not (= (ite ((_ is node) (ite (is-cons x15) (car x15) (leaf zero))) (children (ite (is-cons x15) (car x15) (leaf zero))) null) x16))) (not ((_ is null) x17))))
(check-sat)
(exit)
