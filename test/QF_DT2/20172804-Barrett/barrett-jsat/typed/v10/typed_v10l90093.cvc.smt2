...
(assert (and (and (and (and (and (and (and (and (not (= x11 x15)) (not (is-cons (ite (is-cons null) (cdr null) null)))) (= x14 null)) ((_ is zero) x3)) (not (= x29 x27))) ((_ is succ) x1)) (= x17 (cons x28 x19))) (not ((_ is null) x19))) (not ((_ is null) x19))))
(check-sat)
(exit)
