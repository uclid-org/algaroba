...
(assert (and (and (and (and (and (and (and (and (= null x19) ((_ is node) x27)) (= (ite ((_ is node) x30) (children x30) null) x17)) (is-leaf x21)) (not ((_ is succ) x9))) (not ((_ is succ) (succ x7)))) (not (= x19 (cons (leaf x5) null)))) (= x29 (node (ite (is-cons x14) (cdr x14) null)))) (not ((_ is null) x15))))
(check-sat)
(exit)
