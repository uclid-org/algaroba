...
(assert (and (and (and (and (and (and (not (is-cons (ite ((_ is node) x26) (children x26) null))) (not (= x14 x19))) (= x14 (cons x22 x12))) ((_ is zero) (ite ((_ is succ) x9) (pred x9) zero))) (not ((_ is succ) x8))) (= x17 x19)) (not ((_ is succ) x4))))
(check-sat)
(exit)
