...
(assert (and (and (and (and (and (and (is-leaf x23) (not ((_ is null) x14))) (not ((_ is zero) (ite ((_ is succ) x5) (pred x5) zero)))) (not (= x30 x27))) ((_ is node) x26)) ((_ is null) x20)) (not ((_ is node) x30))))
(check-sat)
(exit)
