...
(assert (and (and (and (and (and (= (ite (is-cons x13) (cdr x13) null) x13) (not (= x6 x2))) (not (= (cons x24 x12) (ite ((_ is node) x30) (children x30) null)))) (= (ite (is-leaf x24) (data x24) zero) (ite ((_ is succ) (succ x10)) (pred (succ x10)) zero))) (not (= (succ x8) (ite (is-leaf x23) (data x23) zero)))) (not ((_ is node) (ite (is-cons x18) (car x18) (leaf zero))))))
(check-sat)
(exit)
