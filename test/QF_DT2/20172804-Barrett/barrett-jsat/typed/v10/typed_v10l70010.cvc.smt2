...
(assert (and (and (and (and (and (and (not (= x17 (ite (is-cons x11) (cdr x11) null))) ((_ is succ) x8)) (not (= (ite (is-cons x20) (cdr x20) null) x11))) ((_ is zero) x10)) (not ((_ is node) (node x15)))) (is-cons (ite ((_ is node) x23) (children x23) null))) (not (= x18 x19))))
(check-sat)
(exit)
