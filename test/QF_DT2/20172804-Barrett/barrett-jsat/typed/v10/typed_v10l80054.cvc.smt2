...
(assert (and (and (and (and (and (and (and (not (= x14 null)) (not (= (succ x6) x9))) (not ((_ is node) x29))) (not (= x23 (ite (is-cons x15) (car x15) (leaf zero))))) (= x29 x21)) (not (= x4 x5))) (= (ite ((_ is node) (node x18)) (children (node x18)) null) x11)) (not ((_ is zero) x3))))
(check-sat)
(exit)
