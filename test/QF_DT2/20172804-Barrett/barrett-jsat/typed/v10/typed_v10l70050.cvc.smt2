...
(assert (and (and (and (and (and (and ((_ is node) (leaf x4)) ((_ is node) (node x18))) (not ((_ is zero) (ite (is-leaf x25) (data x25) zero)))) (= x3 x7)) (= x23 x25)) (= (succ x7) (ite ((_ is succ) x6) (pred x6) zero))) (not ((_ is node) x25))))
(check-sat)
(exit)
