...
(assert (and (and (and (and (and (and (and (and (= x15 x17) (not (= x25 x30))) ((_ is node) x21)) (= x17 x11)) ((_ is null) x20)) (= x6 x2)) (not (= (ite (is-cons x13) (car x13) (leaf zero)) (ite (is-cons x11) (car x11) (leaf zero))))) (is-leaf (leaf x10))) (not (= null x18))))
(check-sat)
(exit)
