...
(assert (and (and (and (and (and (and (and (not (= (succ zero) x4)) (= x18 (ite (is-cons x19) (cdr x19) null))) (not (= x21 x27))) (not ((_ is zero) x6))) (not (= (succ (ite ((_ is succ) x5) (pred x5) zero)) (ite ((_ is succ) x1) (pred x1) zero)))) (= (succ (ite (is-leaf x21) (data x21) zero)) (ite (is-leaf (leaf (ite ((_ is succ) x3) (pred x3) zero))) (data (leaf (ite ((_ is succ) x3) (pred x3) zero))) zero))) (not ((_ is zero) (succ zero)))) (is-leaf x29)))
(check-sat)
(exit)
