...
(assert (and (and (and (and (and (and (and (and (= x9 zero) ((_ is null) (cons (leaf x10) x18))) ((_ is succ) x7)) (= x21 x28)) ((_ is succ) (succ (ite (is-leaf x29) (data x29) zero)))) (= (leaf zero) x25)) (= x7 x6)) (not (= x14 x17))) (not ((_ is zero) x5))))
(check-sat)
(exit)
