...
(assert (and (and (and (and (and (and (and (not ((_ is zero) x10)) (not (is-leaf x25))) (not (is-leaf x21))) ((_ is zero) (ite ((_ is succ) x8) (pred x8) zero))) (is-leaf x27)) ((_ is succ) x5)) (= x21 x30)) (not ((_ is succ) (succ x9)))))
(check-sat)
(exit)
