...
(assert (and (and (and (and (and (and (and (and (not ((_ is node) (leaf (ite (is-leaf (leaf x7)) (data (leaf x7)) zero)))) (= (leaf x2) x29)) (not ((_ is null) x20))) ((_ is zero) x3)) (is-cons x13)) (not ((_ is null) x19))) (not (is-leaf (node x15)))) (= x26 x30)) (not (= x29 x30))))
(check-sat)
(exit)
