...
(assert (and (and (and (and (and (and (and (and (not ((_ is succ) (ite ((_ is succ) x8) (pred x8) zero))) (not ((_ is node) (node (cons (ite (is-cons x14) (car x14) (leaf zero)) x11))))) (not ((_ is node) x30))) (not ((_ is node) (ite (is-cons x13) (car x13) (leaf zero))))) (= x23 (node x15))) (not (= x9 x1))) (not ((_ is null) x17))) (= (ite (is-cons (ite (is-cons x18) (cdr x18) null)) (car (ite (is-cons x18) (cdr x18) null)) (leaf zero)) x23)) ((_ is null) x15)))
(check-sat)
(exit)
