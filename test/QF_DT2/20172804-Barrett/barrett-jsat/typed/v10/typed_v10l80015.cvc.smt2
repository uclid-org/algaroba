...
(assert (and (and (and (and (and (and (and (not ((_ is node) (node (ite ((_ is node) x25) (children x25) null)))) (is-leaf (ite (is-cons x12) (car x12) (leaf zero)))) (not ((_ is succ) x7))) ((_ is node) x23)) (not ((_ is zero) (ite (is-leaf x23) (data x23) zero)))) (not ((_ is succ) x9))) (not (= x10 x10))) (is-leaf x22)))
(check-sat)
(exit)
