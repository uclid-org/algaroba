...
(assert (and (and (and (and (and (not (= (cons x26 x19) (ite (is-cons (ite ((_ is node) x26) (children x26) null)) (cdr (ite ((_ is node) x26) (children x26) null)) null))) (not ((_ is succ) (succ x7)))) (is-leaf x29)) (not (= zero zero))) (not (is-cons x19))) (not (is-leaf (leaf (succ (ite ((_ is succ) x3) (pred x3) zero)))))))
(check-sat)
(exit)
