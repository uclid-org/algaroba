...
(assert (and (and (and (and (and (and (and (not ((_ is zero) (ite (is-leaf x30) (data x30) zero))) (not (= (ite ((_ is node) x22) (children x22) null) (cons (ite (is-cons null) (car null) (leaf zero)) x11)))) ((_ is null) x12)) (= x14 x15)) (= x19 x17)) ((_ is zero) x7)) (= x28 x30)) ((_ is succ) (succ x2))))
(check-sat)
(exit)
