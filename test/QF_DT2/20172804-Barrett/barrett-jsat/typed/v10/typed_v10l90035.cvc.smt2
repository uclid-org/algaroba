...
(assert (and (and (and (and (and (and (and (and (not (= (ite (is-cons x15) (car x15) (leaf zero)) (ite (is-cons x12) (car x12) (leaf zero)))) ((_ is zero) x10)) (= x24 x23)) (= x10 x2)) ((_ is node) x29)) (not ((_ is null) x14))) ((_ is node) x24)) (= x13 x15)) (not ((_ is null) x19))))
(check-sat)
(exit)
